    ...
    <div id="j-main-container">
        ...
        <?php if (!NRFramework\Functions::getDownloadKey()) { ?>
            <div class="alert alert-danger alert-info">
                <h3><?php echo Text::_("NR_DOWNLOAD_KEY_MISSING") ?></h3>
                <?php echo Text::sprintf("COM_CONVERTFORMS_ADDONS_MISSING_KEY"); ?>

                <a style="position:relative; top:-2px; left:5px;" class="btn btn-small btn-sm btn-success" href="<?php echo Uri::base() ?>index.php?option=com_plugins&view=plugins&filter[search]=tassos+framework">
                    <?php echo Text::_("NR_DOWNLOAD_KEY_UPDATE")?>
                </a>
            </div>
        <?php } ?>
