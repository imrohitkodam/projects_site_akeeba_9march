 ...
 * @since  1.6
 */
class JlikeTableannotation extends Table
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__jlike_annotations', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!Factory::getUser()->authorise('core.admin', 'com_jlike.annotation.' . $array['id']))
		{
			$accessFilePath  = JPATH_ADMINISTRATOR . '/components/com_jlike/access.xml';
			$actions         = Access::getActionsFromFile($accessFilePath, "/access/section[@name='annotation']/");
			$default_actions = Access::getAssetRules('com_jlike.annotation.' . $array['id'])->getData();
	...
	protected function _getAssetName()
	{
		...
		return 'com_jlike.annotation.' . (int) $this->$k;
	}
