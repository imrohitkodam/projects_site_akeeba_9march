...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_jlike&task=recommendations.saveOrderAjax&tmpl=component';
	HTMLHelper::_('sortablelist.sortable', 'todosList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
-->
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'recommendations.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
