 ...
 * @since       2.2
 */
class Quick2cartControllerSalesreport extends AdminController
{
	/**
	...
	public function csvexport()
	{
		...
		$headColumn    = array();
		$headColumn[0] = Text::_('COM_QUICK2CART_SALESREPORT_STORE_ITEMID');
		$headColumn[1] = Text::_('COM_QUICK2CART_SALESREPORT_PROD_NAME');
		$headColumn[2] = Text::_('COM_QUICK2CART_SALESREPORT_STORE_NAME');
		$headColumn[3] = Text::_('COM_QUICK2CART_SALESREPORT_STORE_ID');
		$headColumn[4] = Text::_('COM_QUICK2CART_SALESREPORT_SALES_COUNT');
		$headColumn[5] = Text::_('COM_QUICK2CART_SALESREPORT_AMOUNT');
		$headColumn[6] = Text::_('COM_QUICK2CART_SALESREPORT_CREATED_BY');
		...
		if (!empty($CSVData))
		{
			foreach ($CSVData as $data)
			{
				...
				$prodBasePrice = !is_null($discountPrice) ? $discountPrice : $prodAttDetails['itemdetail']['price'];
