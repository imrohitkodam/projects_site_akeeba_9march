...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> qtc_container qtcattributePopUp" id="qtc_container">
	<form method='POST' name='adminForm' class="form-validate" action='index.php'>
					...
					<tr class="control-group form-inline clonedInput" id="attri_opts<?php echo $k; ?>" >
						...
						<td>
							<input
								...
								id="order"
								class="qtc-attribute-Option-order input-mini required"
						...
						<td>
							...
							if ($k == $lastkey_opt)
							{ ?>
								<button type="button" class="btnAdd btn btn-mini btn-primary"  onclick="addopt();">
							...
							{ ?>
								<button type="button" class="btn btn-mini btn-danger" id="btnRemove<?php echo $k; ?>" onclick="techjoomla.jQuery(this).closest('tr').remove();" >
		...
		<div class="form-actions">
			...
			<input class="btn pull-right af-ml-10 btn-success validate" type="submit" onclick="submitbutton('attributes.save');" value="<?php echo Text::_('QTC_ADDATTRI_SAVE')?>" ><?php echo HTMLHelper::_( 'form.token' ); ?>
			<input class="btn pull-right af-ml-10 btn-default validate" type="button" onclick="qtc_closePopUp();" value="<?php echo Text::_('QTC_ADDATTRI_CANCEL')?>" >		<?php echo HTMLHelper::_( 'form.token' ); ?>
		</div>
	</form>
</div>
