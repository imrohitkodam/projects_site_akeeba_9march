	...
	else
	{
		...
		else
		{
			...
			<div class="form-group row">
				<label for="qtcEnableQtcProd" class="form-label col-md-4">
		...
		<div id='qtcOptionsWraper' style="<?php echo $showQtcFields; ?>">
			<div id='' class=" <?php echo $class_nm;?>" >
				...
				<div class="form-group row">
					<label for="item_name" class="form-label col-md-4">
					...
					<div class="col-md-8">
						<input
							type="text"
							class="input-large inputbox requiredEE form-control required" 
							name="item_name"
							id="item_name"
				...
				<!-- SKU -->
				<div class='form-group row' >
					<label for="sku" class="form-label col-md-4">
				...
				?>
				<div class="form-group row">
					<label for="current_store_id" class="form-label col-md-4">
				...
				if ($showStateBtn)
				{
					?>
					<div class='form-group row' >
						<label for="qtc_item_state" class="form-label col-md-4">
				...
				<div class='form-group row qtc_currencey_textbox' id="qtc_price_currencey_textbox" >
					<label for="jform_price_<?php echo !empty($curr[0]) ? $curr[0] : '' ;?>" class="form-label col-md-4">
							...
							{ ?>
								<div>
									<div class="input-group curr_margin">
										<label for="jform_price_<?php echo trim($value);?>" class="form-label col-md-4">
										...
										<input Onkeyup="checkforalpha(this,'46', '<?php echo addslashes($entered_numerics); ?>')"
											...
											<span class="input-group-text"><?php echo $value; ?></span>
									</div>
								</div>
							<?php
							}
				...
				<!-- DISCOUNT PRICE -->
				<div class='form-group row qtc_currencey_textbox' style="<?php echo (($params->get('usedisc') == '0') ? 'display:none;' :'display:flex;'); ?>" >
					<label for="jform_disc_price_<?php echo !empty($curr[0]) ? $curr[0] : '' ;?>" class="form-label col-md-4">
					...
					<div class="col-md-8">
						...
						foreach ($curr as $key=>$value)
						{
							...
							{ ?>
								<div>
									<div class="input-group curr_margin">
										<label for="jform_disc_price_<?php echo trim($value);?>" class="form-label col-md-4">
				...
				?>
				<div class="form-group row">
					<label for="stock" class="form-label col-md-4">
				...
				?>
				<div class="form-group row">
					<label class="form-label col-md-4" for="item_slab">
				...
				<div class="form-group row">
					<label for="min_item" class="form-label col-md-4">
				...
				<div class="form-group row">
					<label for="max_item" class="form-label col-md-4" title="<?php echo Text::_('COM_QUICK2CART_ITEM_MAX_QTY_DESC'); ?>">
			...
			{ ?>
				...
				// CHECK for view override
					...
					$att_list_path       = $comquick2cartHelper->getViewpath('attributes','attribute_list_bs5', $searchTmpPath, $useViewpath);
					$html_attri          = '';
					ob_start();
				...
				if ($eProdSupport)
				{
					...
					<div class="">
						...
						$comquick2cartHelper = new comquick2cartHelper;
						$att_list_path=$comquick2cartHelper->getViewpath('attributes','media_list_bs5', $searchTmpPath, $useViewpath);
						$html_attri = '';
						ob_start();
							require_once($att_list_path);
							$html_attri = ob_get_contents();
				...
				{?>
					<div class="">
						...
						// CHECK for medialist override
						$comquick2cartHelper = new comquick2cartHelper;
						$att_list_path       = $comquick2cartHelper->getViewpath('attributes','extrafield_list_bs5', $searchTmpPath, $useViewpath);
						$html_attri          = '';
						ob_start();
						require_once($att_list_path);
						$html_attri = ob_get_contents();
