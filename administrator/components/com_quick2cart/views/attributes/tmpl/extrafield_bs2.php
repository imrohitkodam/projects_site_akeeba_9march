	...
	<div class="<?php echo Q2C_WRAPPER_CLASS; ?>" >
		<form method="POST" name="adminForm" class="form-validate" action="index.php">
			...
			<div class="form-actions">
				...
				<a class="btn btn-default pull-right af-ml-10" onclick="cancel();" title="<?php echo Text::_('JCANCEL'); ?>">
					<?php echo Text::_('QTC_ADDATTRI_CANCEL'); ?>
				</a>
				<input class="btn btn-success validate pull-right af-ml-10" type="submit" value="<?php echo Text::_('QTC_ADDATTRI_SAVE')?>" />
			</div>
