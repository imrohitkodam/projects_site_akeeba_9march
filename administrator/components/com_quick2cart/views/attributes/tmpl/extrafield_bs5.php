	...
	<div class="<?php echo Q2C_WRAPPER_CLASS; ?>" >
		<form method="POST" name="adminForm" class="form-validate" action="index.php">
			...
			<div class="form-actions">
				...
				<a class="btn float-end ms-2 btn-default" onclick="cancel();" title="<?php echo Text::_('JCANCEL'); ?>">
					<?php echo Text::_('QTC_ADDATTRI_CANCEL'); ?>
				</a>
				<input class="btn float-end ms-2 btn-success validate" type="submit" value="<?php echo Text::_('QTC_ADDATTRI_SAVE')?>" />
			</div>
