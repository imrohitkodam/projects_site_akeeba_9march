...
$addMediaLink              = $qtc_base_url.'index.php?option=com_quick2cart&view=attributes&layout=extrafield_bs2&tmpl=component&item_id=' . $item_id . "&content_id=" . $item_id;
...
<button class="btn btn-small btn-primary" type="button" data-toggle="modal" data-target="#addExtraFieldModal">
