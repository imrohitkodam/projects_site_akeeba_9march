...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>" >
	<form method="POST" name="adminForm" class="form-validate" action="index.php">
		...
		<div class="form-actions">
			...
			<input class="btn btn-success validate float-end" type="submit"  value="<?php echo Text::_('QTC_ADDATTRI_SAVE')?>" /><?php echo HTMLHelper::_( 'form.token' ); ?>
			<input class="btn btn-default validate float-end" type="button" onclick="qtc_closePopUp();" value="<?php echo Text::_('QTC_ADDATTRI_CANCEL')?>" >
		</div>
	</form>
</div>
