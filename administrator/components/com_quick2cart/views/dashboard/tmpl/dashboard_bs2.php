												...
												<div class="panel-body">
														...
														<div class="col-sm-12 col-lg-12 col-md-12">
															<div class="pull-right">
																<div class="form-group">
																	<label label-default class="col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label"><?php echo Text::_('FROM_DATE');?>
																	</label>
																...
																<div class="form-group">
																	<label label-default class="col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label"><?php echo Text::_('TO_DATE');?></label>
																	<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
																		<div class="input-group">
																...
																<div class="form-group">
																	<div class="pull-right col-lg-4 col-md-4 col-sm-4 col-xs-4">
																		<div class="input-group">
																			<input id="btnRefresh" class="pull-right btn btn-micro btn-primary" type="button" value="<?php echo Text::_('COM_QUICK2CART_GO'); ?>" style="font-weight: bold;" onclick="refreshViews();" title="<?php echo Text::_('COM_QUICK2CART_GO_TOOLTIP');?>"/>
																		</div>
																	</div>
																</div>
															</div>
													...
													<div class="list-group">
														<span class="list-group-item">
															<i class="fa fa-money fa-fw"></i> <?php echo Text::_('PERIODIC_INCOME');?>
										...
										<div class="">
											<div class="clearfix pull-right">
												<div class="alert alert-warning">
													<?php echo Text::sprintf('COM_QUICK2CART_LIVE_UPDATE_DOWNLOAD_ID_MSG', '<a href="https://techjoomla.com/my-account/add-on-download-ids" target="_blank">' . Text::_('COM_QUICK2CART_LIVE_UPDATE_DOWNLOAD_ID_MSG2') . '</a>'); ?>
												</div>
											</div>
										</div>
									<?php endif; ?>
										...
										<div class="panel-body">
											...
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12">
													<p class="pull-right"><span class="label label-info"><?php echo Text::_('COM_QUICK2CART_LINKS'); ?></span></p>
												</div>
											</div>
											<div class="list-group">
												...
												<a href="http://techjoomla.com/support/support-tickets" class="list-group-item" target="_blank">
													<i class="fa fa-support fa-fw i-support"></i> <?php echo Text::_('COM_QUICK2CART_TECHJOOMLA_SUPPORT_CENTER');?>
												</a>
...
<script type="text/javascript">
	...
	<?php else: ?>
			techjoomla.jQuery('#graph-monthly-sales').html("<div class='center'><?php echo Text::_("NO_STORE_PREVIOUS_ORDERS");?></div>");
	<?php endif; ?>
	...
	function drawPeriodicOrdersChart()
	{
		...
		{
			techjoomla.jQuery('#graph-periodic-orders').html("<div class='center'><?php echo Text::_("NO_STORE_PREVIOUS_ORDERS");?></div>");
		}
	}
</script>
