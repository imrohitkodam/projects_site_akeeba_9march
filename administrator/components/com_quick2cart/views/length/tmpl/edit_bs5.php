...
<script type="text/javascript">
	...
	js(document).ready(function() {
		jQuery('#length-form #jform_value').change(function() {
	...
	Joomla.submitbutton = function(task)
	{
		...
		{
			if (task != 'length.cancel' && document.formvalidator.isValid(document.getElementById('length-form')))
			{
				Joomla.submitform(task, document.getElementById('length-form'));
			}
			else
...
<div class="<?php echo Q2C_WRAPPER_CLASS;?> qtc_admin_length">
	<form action="<?php echo Route::_('index.php?option=com_quick2cart&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="length-form" class="form-validate">
