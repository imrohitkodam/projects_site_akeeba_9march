...
if ($saveOrder)
{
	...
	HTMLHelper::_('sortablelist.sortable', 'lengthList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
?>
...
<form action="<?php echo Route::_('index.php?option=com_quick2cart&view=lengths'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="<?php echo Q2C_WRAPPER_CLASS;?> q2c_admin_lengths">
		<div id="j-main-container">
			<div class="alert alert-info">
				<?php echo Text::_('COM_QUICK2CART_LENGTH_SETUP_HELP'); ?>
			</div>
					...
					<table class="table table-striped" id="lengthList">
						<thead>
							<tr>
								...
								<th class='left'>
									<?php echo HTMLHelper::_('grid.sort', 'COM_QUICK2CART_LENGTHS_LENGTH_TITLE', 'a.title', $listDirn, $listOrder); ?>
								</th>
								<th class='left'>
									<?php echo HTMLHelper::_('grid.sort', 'COM_QUICK2CART_LENGTHS_LENGTH_UNIT', 'a.unit', $listDirn, $listOrder); ?>
								</th>
								<th class='left'>
									<?php echo HTMLHelper::_('grid.sort', 'COM_QUICK2CART_LENGTHS_LENGTH_VALUE', 'a.value', $listDirn, $listOrder); ?>
								</th>
								<th width="1%" class="nowrap center hidden-phone">
						...
						<tbody>
							...
							foreach ($this->items as $i => $item)
							{
								...
								<tr class="row<?php echo $i % 2; ?>">
									...
									<td class="center">
										<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'lengths.', $canChange, 'cb'); ?>
									</td>
									<td>
										<?php if (isset($item->checked_out) && $item->checked_out) : ?>
											<?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'lengths.', $canCheckin); ?>
										<?php endif; ?>
										<?php if ($canEdit) : ?>
											<a href="<?php echo Route::_('index.php?option=com_quick2cart&task=length.edit&id='.(int) $item->id); ?>">
