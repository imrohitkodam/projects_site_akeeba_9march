				...
				<table width="100%" class="table table-condensed table-bordered adminlist">
							...
							if (! in_array($order->store_id, $store_array))
							{
								...
								<tr class="<?php echo $qtc_store_row_classes;?>">
									...
									<div class="invoice-pdf qtcHandPointer" style='float: right; text-align: right'>
										...
										<a class="inviceViewIconDisplay" href="<?php echo Route::_('index.php?option=com_quick2cart&view=orders&layout=invoice&orderid=' .  $orderid  . '&tmpl=component&store_id=' . $order->store_id . $streLinkPrarm); ?>"
										target="_blank" >
									...
									<div class="row">
										...
										{ ?>
											<div class="col-md-11">
												...
												<input type="text" name="itemTaxShipDetail[<?php echo $order->order_item_id ?>][tax]" class="float-end input form-control-sm" id="" value="<?php echo $order->item_tax?>">
											</div>
											<div class="col-md-11">
												<b> +</b>
												<?php echo " " . Text::_("COM_QUICK2CART_ITEM_SHIP") . " :"; ?>
												<input type="text" name="itemTaxShipDetail[<?php echo $order->order_item_id ?>][ship]" class="float-end input form-control-sm" id="" value="<?php echo $order->item_shipcharges?>">
											</div>
					...
					<tr>
						...
						<td class="cartitem_tprice" <?php echo $price_col_style;?>>
							...
							<button type="button" class="btn btn-success float-end no-print btn-sm" onClick='updateOrderItemAttribute("<?php echo $this->orderinfo->id ;?>", "<?php echo Text::_('COM_QUICK2CART_ORDER_UPDATED', true); ?>")' title="<?php echo Text::_('COM_QUICK2CART_UPDATE_ORDER_CART_DESC', true); ?>"><?php echo Text::_('COM_QUICK2CART_UPDATE_ORDER_CART', true); ?></button>
						</td>
					</tr>
				</table>
			</form>
