...
if (!$user->id && $this->params->get('guest'))
{
...
elseif(!$user->id && !$this->params->get( 'guest' ))
{
	?>
	<div class="well" >
		<div class="alert alert-error">
...
<div style="padding:20px;">
		...
		<tbody>
			<tr>
				<td style="background-color: #ccc;  padding: 7px;">
					<h4 style="margin:0; padding:0;">
						<?php echo Text::_('COM_QUICK2CART_INVOICE_SOLD_BY_LBL');?>
					</h4>
				</td>
				<td style="background-color: #ccc;  padding: 7px;">
					<h4 style="margin:0; padding:0;">
						<?php echo Text::_('QTC_INVOICE_DETAIL') ?>
					</h4>
				</td>
			</tr>
			...
			<tr>
				<td  style="border:1px solid #dddddd;  padding: 5px 10px;" class="tdaddress">
					...
					<h4 style="margin:0; padding:0;">
						<?php echo htmlspecialchars($storeinfo['title'], ENT_COMPAT, 'UTF-8'); ?>
					</h4>
					<address class="shop-address">
						<?php echo htmlspecialchars($storeinfo['address'], ENT_COMPAT, 'UTF-8'); ?>
					</address>
					<p>
						<strong><?php echo Text::_('COM_QUICK2CART_INVOICE_SHOP_EMAIL_LBL');?></strong>
						<a href="mailto:<?php echo htmlspecialchars($storeinfo['store_email'], ENT_COMPAT, 'UTF-8'); ?>" title="<?php echo htmlspecialchars($storeinfo['title'], ENT_COMPAT, 'UTF-8'); ?>">
				...
				<td  style="border:1px solid #dddddd;  padding: 5px 10px;" class="tdaddress">
					<p>
						<strong>
							<?php echo Text::_('QTC_INVOICE_ID'); ?>
						</strong>
						<span>
					...
					<p>
						<strong>
							<?php echo Text::_('QTC_INVOICE_DATE');?>
						</strong>
						<span>
							<?php echo HTMLHelper::date($this->orderinfo->cdate, Text::_("COM_QUICK2CART_DATE_FORMAT_SHOW_SHORT"));?>
						</span>
					...
					<p>
						<span>
							...
							?>
							<strong>
								<span class=" text-<?php echo $orderStatusColor; ?>">
	...
	<div class="">
		...
		$view = $this->comquick2cartHelper->getViewpath('orders', 'default_billing_bs5');
		ob_start();
			include($view);
	...
	<div class="">
		<div class="" style="width: 100%;">
			<?php
			$view = $this->comquick2cartHelper->getViewpath('orders', 'default_cartdetail_bs5');
			ob_start();
			include($view);
			$html = ob_get_contents();
			ob_end_clean();
