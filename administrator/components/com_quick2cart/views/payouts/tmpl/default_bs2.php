			...
			<table class="table table-striped" id="payoutList">
				<thead>
					<tr>
						...
						<?php
						if (isset($this->items[0]->com_quick2cart)): ?>
					...
					?>
						<tr class="row<?php echo $i % 2;?>">
							...
							<td class=''>
								...
								?>
								<a href="<?php echo 'index.php?option=com_quick2cart&task=payout.edit&id=' . $original_payout_id; ?>" title="<?php echo Text::_('COM_QUICK2CART_PAYOUT_ID_TOOLTIP');?>">
									<?php echo htmlspecialchars($payout->id, ENT_COMPAT, 'UTF-8');?>
								</a>
							</td>
							<td class='q2c_width_10 small'>
								<?php echo htmlspecialchars($payout->payee_name, ENT_COMPAT, 'UTF-8');?>
							</td>
							<td class='q2c_width_10 small hidden-phone'>
								<?php echo htmlspecialchars($payout->email_id, ENT_COMPAT, 'UTF-8');?>
							</td>
							<td class='q2c_width_10 small hidden-phone'>
								<?php echo htmlspecialchars($payout->transaction_id, ENT_COMPAT, 'UTF-8');?>
							</td>
							<td class='q2c_width_10 small hidden-phone'>
