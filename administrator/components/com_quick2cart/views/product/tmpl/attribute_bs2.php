...
<script type="text/javascript">
	...
	*/
	...
	function addopt(attribute_container_id)
	{
		...
		techjoomla.jQuery('#'+current_attribute+' .btnAdd').last().replaceWith('<button type=\"button\" class=\"btn btn-mini btn-danger qtcRemoveOption\" id=\"btnRemove'+num+'\" title=\"Joomla.Text._(\"QTC_REMOVE_MORE_OPTION_TITLE\");\" onclick=\"techjoomla.jQuery(this).closest(\'tr\').remove();\" ><i class=\"' + qtcJsData.Q2C_ICON_TRASH + ' \"></i></button> ');
		...
		<div class="span12">
			...
			$i=0;
				...
				$attribute_container_id = "qtc_container0";
				 ?>
				<div id=<?php echo $attribute_container_id ?> class="qtc_container row-fluid af-mt-5 qtc_att_hide">
					<div class="span11">
						<div class="com_qtc_repeating_block well well-small span10">
							...
							$att_list_path = $comquick2cartHelper->getViewpath('product','attribute2_bs2',"ADMINISTRATOR","ADMINISTRATOR");
							ob_start();
				...
				for($i=1;$i<=$count;$i++) // for each attribute
				{
				 ...
				 ?>
					<div id=<?php echo $attribute_container_id ?> class="qtc_container row-fluid af-mt-5">
						<div class="span11">
							<div class="com_qtc_repeating_block well well-small span10">
								<?php
