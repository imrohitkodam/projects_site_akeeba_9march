		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group row">
					<label class="form-label col-md-4" for="qtcmedianame">
					...
					<div class="col-md-8">
						<input
							...
							class='form-control-sm qtcMediaFileName'
				...
				<div class="form-group row">
					<label class="form-label col-md-4" for="proMediaStatus">
				...
				<!-- upload mode-->
					...
					if ($fileUploadMode == 3)
					{
						...
						<div class="form-group row qtcMedUploadModeWrapper" style="<?php echo $uploadModeDisplay; ?>" >
							<label class="form-label col-md-4" for="qtcMeduaUploadMode_upload">
					...
					?>
					<!-- file upload-->
					<div class="form-group row qtcMedUploadWrapper" style="<?php echo !empty($mediaDetail[$m]['file_id'])?'display:none;':'display:block;'; ?>">
						<?php
						$qtcFieldType = 'd-none';
						if ( $fileUploadMode == 1 || $fileUploadMode == 3 )
						{
							...
							<div class="" style="margin-left:20px;">
								<input
									class="qtcMediaFileUploadEle"
									id="qtcMediaFile<?php echo $m ?>"
									type="file"
									name="qtcMediaFile<?php echo $m ?>" />
								<div class="progress progress-success progress-striped active qtc_progress-barWrapper mt-1" id="qtc_progress-barWrapper<?php echo $m ?>">
									<div class="bar qtcMediaProgressBar progress-bar af-bg-success" id="qtc_progress-bar<?php echo $m ?>" style="width:0%"></div>
								</div>
							</div>
						<?php
						}
						...
						?>
						<label class="form-label col-md-4 <?php echo $qtcFieldType; ?>" for="qtcmediaStatus" >
							<?php echo Text::_( "FILEPATH")?>
						</label>
						<div class="col-md-8 <?php echo $qtcFieldType; ?>">
							<input
								type="text"
								class="qtcMediaUpload form-control-sm <?php echo $qtcFieldType; ?>"
								name="prodMedia[<?php echo $m ?>][mediaFilePath]"
								id="ajax_upload_hidden<?php echo $m ?>"
					...
					{
						?>
						<div class="qtcMediaProdLink row">
			...
			<div class="col-sm-6">
				<div class="form-group row">
					<label class="form-label col-md-4" for="qtcpurchaseRequire">
				...
				if ($eProdUExpiryMode == 'epMaxDownload' || $eProdUExpiryMode == 'epboth')
				{
					...
					<div class="form-group row" style="<?php echo $hideExpirationFields; ?>">
						<label class="form-label col-md-4" for="qtcDownCount" title="<?php echo Text::_('COM_QUICK2CART_PROD_DOWN_COUNT_DES')?>">
				...
				if ($eProdUExpiryMode == 'epDateExpiry' || $eProdUExpiryMode == 'epboth')
				{
					...
					?>
					<div class="form-group row" style="<?php echo $hideExpirationFields; ?>">
						<label class="form-label col-md-4" for=""><?php echo Text::_( "COM_QUICK2CART_PROD_EXPIRARY")?></label>
						<div class="col-md-8">
