	...
	*/
	...
	function addCloneMedia(rId,rClass)
	{
		...
		if (mdiaCount <= (maxAllowedMedia + 1))
		{
			...
			var removeButton="<div class='span1'>";
		...
		<div class="row-fluid">
			...
			<?php
				...
				<div id=<?php echo $attribute_container_id ?> class="qtc_mediaContainer qtc_media_hide " >
					<div class="com_qtc_media_repeat_block well well-small span10">
						...
						// CHECK for view override
							...
							$att_list_path=$comquick2cartHelper->getViewpath('product','media_bs2',"ADMINISTRATOR","ADMINISTRATOR");
							ob_start();
				...
				<div id=<?php echo $attribute_container_id ?> class="qtc_mediaContainer ">
					...
					{?>
					<div class='span1'>
						<button class='btn btn-mini' type='button' id='remove<?php echo $m;?>'
