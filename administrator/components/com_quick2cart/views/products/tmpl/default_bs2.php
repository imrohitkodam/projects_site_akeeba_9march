										...
										<tr class="<?php echo 'row'.$k;?>">
											...
											<td class="nowrap q2c_width_5 center hidden-phone hidden-tablet">
												<a href="#"
												 ...
												 onclick="Joomla.listItemTask('cb<?php echo $i;?>', '<?php echo ($comquick2cartHelper->isFeatured($row->item_id)) ? 'products.unfeatured' : 'products.featured';?>')"
											...
											if ($this->params->get('usestock') == 1 && $this->params->get('usestock') !== null)
											{
												...
												<td class="nowrap q2c_width_15 center hidden-phone">
													...
													{
														?>
														<a href="" onclick="return Joomla.listItemTask('cb<?php echo $i;?>','products.makeItemOutOfStock')"
...
<div class="modal center" id="import_products" role="dialog" style="display:none">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body height-400 overflow-y-auto af-m-10">
				<div class="container">
					<div id="import_products_test">
						<?php $productImportActionUrl = Uri::base()."index.php?option=com_quick2cart&task=products.csvImport&tmpl=component&format=html";?>
						<form action="<?php echo $productImportActionUrl?>" id="uploadForm" class="form-inline center" name="uploadForm" method="post" enctype="multipart/form-data">
							<table>
								<tr>&nbsp;</tr>
								<div id="uploadform">
