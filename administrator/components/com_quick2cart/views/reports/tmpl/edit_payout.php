...
// load report HELPER
require(JPATH_SITE . "/components/com_quick2cart/helpers/reports.php");
$js="
function fill_me(el)
{
	//console.log(el);
...
{                console.log(task);
		...
		else
		{
				...
				{
					   alert(Joomla.Text._('COM_QUICK2CART_ERROR_UNACCEPTABLE','Some values are unacceptable'));
						return false;
				}
	...
	<form method="post" name="adminForm" id="adminForm" enctype="multipart/form-data"
		...
		<div class="control-group">
			<label class="control-label" for="payee_name">
				<?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_PAYEE_NAME_TOOLTIP'), Text::_('COM_QUICK2CART_PAYEE_NAME'), '', Text::_('COM_QUICK2CART_PAYEE_NAME'));?>
			</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="user_id">
				<?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_USER_ID_TOOLTIP'), Text::_('COM_QUICK2CART_USER_ID'), '', Text::_('COM_QUICK2CART_USER_ID'));?>
			</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="paypal_email">
				<?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_PAYPAL_EMAIL_TOOLTIP'), Text::_('COM_QUICK2CART_PAYPAL_EMAIL'), '', Text::_('COM_QUICK2CART_PAYPAL_EMAIL'));?>
			</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="transaction_id">
				<?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_TRANSACTION_ID_TOOLTIP'), Text::_('COM_QUICK2CART_TRANSACTION_ID'), '', Text::_('COM_QUICK2CART_TRANSACTION_ID'));?>
			</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="payout_date">
				<?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_PAYOUT_DATE_TOOLTIP'), Text::_('COM_QUICK2CART_PAYOUT_DATE'), '', Text::_('COM_QUICK2CART_PAYOUT_DATE'));?>
			</label>
			<div class="controls">
				<?php
				// Set date to blank
		...
		<div class="control-group">
			<label class="control-label" for="payment_amount">
				<?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_PAYOUT_AMOUNT_TOOLTIP'), Text::_('COM_QUICK2CART_PAYOUT_AMOUNT'), '', Text::_('COM_QUICK2CART_PAYOUT_AMOUNT'));?>
			</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="payment_comment">
				<?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_PAYOUT_COMMENT_TOOLTIP'), Text::_('COM_QUICK2CART_PAYOUT_COMMENT'), '', Text::_('COM_QUICK2CART_PAYOUT_COMMENT'));?>
			</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="status">
				<?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_STATUS_TOOLTIP'), Text::_('COM_QUICK2CART_STATUS'), '', Text::_('COM_QUICK2CART_STATUS'));?>
			</label>
			<div class="controls">
