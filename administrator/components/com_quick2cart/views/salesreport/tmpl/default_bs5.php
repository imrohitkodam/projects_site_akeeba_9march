...
<form method="post" name="adminForm" id="adminForm" class="form-validate">
	<div class="row <?php echo Q2C_WRAPPER_CLASS;?> q2c-salesreport">
		<div class="col-md-12">
			<div id="j-main-container">
				...
				<div id="filter-bar" class="js-stools">
					<div class="js-stools-container-selector btn-group float-start mt-3">
					...
					<div class="btn-group float-end mt-3 btn-wrapper ms-2">
						<label for="limit" class="element-invisible">
							<?php echo Text::_('JFIELD_PLG_SEARCH_SEARCHLIMIT_DESC'); ?>
						</label>
						<?php echo $this->pagination->getLimitBox(); ?>
					</div>
					<div class="btn-group float-end mt-3 hidden-phone btn-wrapper">
						<?php
							if (!empty($this->store_details))
							{
								...
								if (count($this->store_details)>1)
								{
									...
									echo $this->dropdown = HTMLHelper::_('select.genericlist', $options, 'search_store','class="input-medium hidden-mobile form-select" size="1" onchange="document.adminForm.submit();" ','value','text',$default);
								}
							}
						?>
					</div>
					...
					<div class="btn-group float-end mt-3 hidden-phone btn-wrapper">
						...
						<div class="float-start af-ml-5">
							<input
								id="btnRefresh"
								class="btn btn-primary qtcMarginBothSide af-mr-5"
								type="button"
								value="<?php echo Text::_('COM_QUICK2CART_GO'); ?>"
								style="font-weight: bold;"
								onclick="if(validateDates()){ this.form.submit();}"/>
						</div>
					</div>
