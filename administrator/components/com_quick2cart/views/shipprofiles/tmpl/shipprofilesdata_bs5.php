	...
	<div class="<?php echo Q2C_WRAPPER_CLASS; ?>">
		<div class="row">
			<div class="col-sm-12">
				...
				{
					?>
					<div class="af-ml-10 alert alert-danger">
				...
				?>
				<!-- Help msg -->
				<div class="af-ml-10 alert alert-info">
		...
		<div id="filter-bar" class="js-stools">
			...
			<div class="js-stools-container-selector float-end btn-group hidden-phone af-mr-5">
				<label for="limit" class="element-invisible">
					<?php echo Text::_('COM_QUICK2CART_SEARCH_SEARCHLIMIT_DESC'); ?>
				</label>
				<?php echo $this->pagination->getLimitBox(); ?>
			</div>
			<div class="js-stools-container-selector btn-group float-end af-mr-5">
			...
			<div class="js-stools-container-selector btn-group float-end hidden-phone af-mr-5 mb-2">
				<?php echo HTMLHelper::_('select.genericlist', $this->stores, "filter_store", 'class="input-medium form-select"  size="1" onchange="document.adminForm.submit();" name="filter_store"', "id", "title", $this->state->get('filter.stores'));
				?>
			</div>
		</div>
		<div class="clearfix"></div>
