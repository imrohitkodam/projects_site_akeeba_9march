...
<script type="text/javascript">
	...
	Joomla.submitbutton = function(task)
	{
		...
		{
			var taxPercentage = js('[name="jform[percentage]"]').val();
			// If Entered tax percentage is 0 then display alert
			if(taxPercentage == 0)
			{
				alert(Joomla.JText._('QTC_ENTER_POSITIVE_PERCENTAGE'));
			}
			else if (task != 'taxrate.cancel' && document.formvalidator.isValid(document.getElementById('taxrate-form')))
			{
				Joomla.submitform(task, document.getElementById('taxrate-form'));
			}
			else
			...
			<div class="row-fluid">
				<div class="span10 form-horizontal">
					<fieldset class="adminform">
						...
						<div class="form-group row">
							<div class="form-label col-md-2 col-sm-4"><?php echo $this->form->getLabel('percentage'); ?></div>
						...
						<div class="form-group row">
							<div class="form-label col-md-2 col-sm-4"><?php echo $this->form->getLabel('zone_id'); ?></div>
							<div class="col-md-4 col-sm-8"><?php echo $this->form->getInput('zone_id'); ?></div>
						</div>
						<div class="form-group row">
