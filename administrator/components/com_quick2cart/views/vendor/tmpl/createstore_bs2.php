	...
	<form name="qtcCreateStoreForm" id="qtcCreateStoreForm" class="form-validate form-horizontal" method="post" enctype="multipart/form-data" onSubmit="return myValidate(this);" >
		...
		<div>
			<div class="control-group">
				<label for="title" class="control-label" title="<?php echo Text::_('VENDER_TITLE_TOOLTIP');?>">
			...
			if ($is_sef==1 && !$app->isClient('administrator'))
			{
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						$vanity_url = Uri::root().substr(Route::_('index.php?option=com_quick2cart&view=vendor&layout=store&vanitydisplay=1&Itemid='.$Itemid), strlen(Uri::base(true)) + 1);
						$menu       = $app->getMenu();
						$lang       = Factory::getLanguage();
			...
			<!-- for user selection  -->
			<div class="control-group ">
				<label for="store_creator_name" class="control-label" title="<?php echo Text::_('COM_QUICK2CRT_STORE_OWNER_TITLE')?>">
			...
			<div class="control-group">
				<label for="description" class="control-label" title="<?php echo Text::_('COM_QUICK2CART_VENDER_DESCRIPTION_TOOLTIP')?>">
			...
			<!-- Company name -->
			<div class="control-group">
				<label for="companyname" class="control-label" title="<?php echo Text::_('VENDER_COMPANY_NAME_TOOLTIP')?>">
			...
			<div class="control-group">
				<label for="email" class="control-label" title="<?php echo Text::_('VENDER_EMAIL_TOOLTIP')?>">
			...
			<div class="control-group">
				<label for="phone" class="control-label" title="<?php echo Text::_('VENDER_PHONE_TOOLTIP')?>">
			...
			<!-- ADDRESS -->
			<div class="control-group">
				<label for="address" class="control-label" title="<?php echo Text::_('VENDER_ADDRESS_TOOLTIP')?>">
					<?php echo Text::_('VENDER_ADDRESS'). ' *';?>
				</label>
				<div class="controls">
					<textarea maxlength="200" size="28" rows="3" name="address" id="address" class="inputbox required" ><?php if (!empty($this->storeinfo)){ echo stripslashes($this->storeinfo[0]->address);}?></textarea>
				</div>
			</div>

			<!--Land Mark-->
			<div class="control-group">
				<label for="land_mark" class="control-label" title="<?php echo Text::_('COM_QUICK2CART_VENDER_LAND_MARK_CITY_TOOLTIP')?>">
			...
			<div class="control-group">
				<label for="pincode" class="control-label " title="<?php echo Text::_('QTC_BILLIN_ZIP_DESC')?>">
			...
			<!--Country-->
			<div class="control-group">
				<label for="storecountry" class="control-label" title="<?php echo Text::_('QTC_BILLIN_COUNTRY');?>">
			...
			<!--State-->
			<div class="control-group" >
				<label for="qtcstorestate" class="control-label" title="<?php echo Text::_('QTC_BILLIN_STATE')?>">
			...
			<!--City-->
			<div class="control-group">
				<label for="city" class="control-label" title="<?php echo Text::_('COM_QUICK2CART_VENDER_CITY_TOOLTIP')?>">
			...
			<!--avatar -->
			<div class="control-group">
				<label for="avatar" class="control-label" title="<?php echo Text::_('VENDER_AVTAR_TOOLTIP')?>">
					...
					<div class="checkbox">
						...
						<label for="privacy_terms_condition">
							<input
								...
								id="privacy_terms_condition"
								size="30" <?php echo $checked ?> />
							<?php  echo Text::_('COM_QUICK2CART_ACCEPT_STORE_TERMS_CONDITIONS_FIRST'); ?>
							<a href="javascript:;" class="" data-toggle="modal" data-target="#storeCreationTermConditionModal">
