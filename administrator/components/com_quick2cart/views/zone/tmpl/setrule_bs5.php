				...
				<div class="span10 form-horizontal">
					...
					<div class="control-group">
						<div class="controls">
							...
							echo HTMLHelper::_('select.genericlist',$options,'qtc_ZoneCountry','class="form-select"  required="" aria-invalid="false" size="1"  autocomplete="off" onchange=\'qtc_generateState("jform[qtc_state_id]","jform_qtc_state_id")\' ','value','text',$default,'qtc_ZoneCountry');
							?>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<span id="qtcStateContainer">
								...
								if ($this->getRegionList)
								{
									...
									echo HTMLHelper::_('select.genericlist', $options, 'jform[qtc_state_id]', 'class="form-select" autocomplete="off"', 'value', 'text',$default_region,'jform_qtc_state_id');
								}
								?>
							</span>
							<span >
								<input
									...
									class="btn btn-success qtcMarginTop10px"
