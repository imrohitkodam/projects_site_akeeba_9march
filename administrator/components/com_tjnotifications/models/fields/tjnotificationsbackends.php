...
class JFormFieldTjnotificationsbackends extends JFormFieldList
{
	...
	{
		// Load defines.php to ensure TJNOTIFICATIONS_CONST_BACKENDS_ARRAY is defined.
		// This is needed when this field is loaded via com_config (component configuration page),
		// which does not bootstrap the main tjnotifications.php file.
