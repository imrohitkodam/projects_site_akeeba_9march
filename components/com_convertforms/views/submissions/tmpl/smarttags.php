...
$groups = [
    'Container Layout' => [
        ...
        '{searchbar}' => 'Display a search bar.',
    ...
    'Row & Details Layout' => [
        ...
        '{submission.dateCreated}' => 'The date when the submission created.',
        '{submission.dateModified}' => 'The date when the submission modified.',
...
foreach ($global_tags as $tag => $tag_value)
{
    ...
    $groups['Global'][$tag] = Text::_('NR_TAG_' . strtoupper(str_replace(array("{", "}", "."), "", $tag)));
}
