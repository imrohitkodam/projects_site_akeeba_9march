...
JpagebuilderConfig::addonConfig([
    ...
    'title'      => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT'),
    'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_DESC'),
    'category'   => 'Content',
    ...
    'settings' => [
        'content' => [
            ...
            'fields' => [
                ...
                'from_name' => [
                    'type'  => 'text',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_FORM_NAME'),
                    'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_FORM_NAME_DESC'),
                ],
                ...
                'show_phone' => [
                    'type'   => 'checkbox',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_PHONE_FIELD'),
                    'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_PHONE_FIELD_DESC'),
                    'values' => [
                        '0' => 'No',
                        '1' => 'Yes'
                    ],
        ...
        'style' => [
            ...
            'fields' => [
                ...
                'field_placeholder_color' => [
                    'type'  => 'color',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_PLACEHOLDER_COLOR')
                ],
        ...
        'recaptcha_options' => [
            ...
            'fields' => [
                'formcaptcha' => [
                    'type'   => 'checkbox',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_CAPTCHA'),
                    'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_CAPTCHA_DESC'),
                    'values' => [
                        '0' => 'No',
                        '1' => 'Yes'
                    ],
                ...
                'captcha_input_col' => [
                    'type'   => 'select',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_CAPTCHA_INPUT_COL_SIZE'),
                    'values' => [
                        '3'  => '3',
                        '4'  => '4',
                        '5'  => '5',
        ...
        'layout' => [
            ...
            'fields' => [
                'name_input_col' => [
                    'type'   => 'select',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_NAME_INPUT_COL_SIZE'),
                    'values' => [
                        '3'  => '3',
                        '4'  => '4',
                        '5'  => '5',
                ...
                'email_input_col' => [
                    'type'   => 'select',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_EMAIL_INPUT_COL_SIZE'),
                    'values' => [
                        '3'  => '3',
                        '4'  => '4',
                        '5'  => '5',
                ...
                'subject_input_col' => [
                    'type'   => 'select',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_SUBJECT_INPUT_COL_SIZE'),
                    'values' => [
                        '3'  => '3',
                        '4'  => '4',
                        '5'  => '5',
                ...
                'phone_input_col' => [
                    'type'   => 'select',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_PHONE_INPUT_COL_SIZE'),
                    'values' => [
                        '3'  => '3',
                        '4'  => '4',
                        '5'  => '5',
                ...
                'message_input_col' => [
                    'type'   => 'select',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_MESSAGE_INPUT_COL_SIZE'),
                    'values' => [
                        '3'  => '3',
                        '4'  => '4',
                        '5'  => '5',
                ...
                'show_label' => [
                    'type'  => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_LABEL'),
                    'std'   => 0,
                ],

                'show_checkbox' => [
                    'type'  => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_CHECKBOX'),
                    'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_SHOW_CHECKBOX_DESC'),
                    'std'   => 1,
                    'group' => [
                        'checkbox_title'
                    ]
                ...
                'checkbox_title' => [
                    'type'    => 'textarea',
                    'title'   => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_CHECKBOX_TITLE'),
                    'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_CHECKBOX_TITLE_DESC'),
        ...
        'custom_button_options' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_USE_BUTTON'),
            'fields' => [
                'use_custom_button' => [
                    'type'   => 'checkbox',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_AJAX_CONTACT_USE_BUTTON'),
                ...
                'button_text' => [
                    'type'    => 'text',
                    'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BUTTON_TEXT'),
                    'desc'    => Text::_('COM_JPAGEBUILDER_GLOBAL_BUTTON_TEXT_DESC'),
                    'std'     => 'Send Message',
                ...
                'button_style_state' => [
                    'type'   => 'radio',
                    'values' => [
                        'normal' => Text::_('COM_JPAGEBUILDER_GLOBAL_NORMAL'),
                        'hover' => Text::_('COM_JPAGEBUILDER_GLOBAL_HOVER'),
                    ],
                    'std' => 'normal',
                    'depends' => [
                        ['use_custom_button', '=', 1],
                ...
                'button_icon_margin' => [
                    'type'    => 'margin',
                    'title'   => Text::_('COM_JPAGEBUILDER_TAB_ICON_MARGIN'),
                    'depends' => [['use_custom_button', '=', 1]]
                ],
