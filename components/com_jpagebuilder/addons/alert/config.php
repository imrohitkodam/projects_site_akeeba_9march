...
JpagebuilderConfig::addonConfig(
	[
		'type'       => 'content',
		'addon_name' => 'alert',
		'title'      => Text::_('COM_JPAGEBUILDER_ADDON_ALERT'),
		'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_ALERT_DESC'),
		'category'   => 'Content',
		...
		'settings' => [
			'content' => [
				...
				'fields' => [
					...
					'alrt_type' => [
						'type'   => 'select',
						'title'  => Text::_('COM_JPAGEBUILDER_ADDON_ALERT_TYPE'),
						'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_ALERT_TYPE_DESC'),
						'values' => [
							...
							'light'   => Text::_('COM_JPAGEBUILDER_GLOBAL_LIGHT'),
					...
					'close' => [
						'type'  => 'checkbox',
						'title' => Text::_('COM_JPAGEBUILDER_ADDON_ALERT_CLOSE_BUTTON'),
						'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_ALERT_CLOSE_BUTTON_DESC'),
						'std'   => 1
					],
				],
			],
