...
JpagebuilderConfig::addonConfig ( [ 
		...
		'settings' => [ 
				...
				'separator_alert_options' => [ 
						'title' => Text::_ ( 'Alert Style' ),
						'fields' => [ 
								'style' => [ 
										'type' => 'select',
										'title' => Text::_ ( 'Style' ),
										'desc' => Text::_ ( 'By selecting a style, you can apply different colored for alert add-on.' ),
										'values' => [ 
												'' => Text::_ ( 'Default' ),
				...
				'separator_title_style_options' => [ 
						...
						'fields' => [ 
								...
								'inline_title' => [ 
										'type' => 'checkbox',
										'title' => Text::_ ( 'Inline Title' ),
										'desc' => Text::_ ( 'Display the title in the same line as the content.' ),
										'values' => [ 
												1 => Text::_ ( 'JYES' ),
												0 => Text::_ ( 'JNO' )
										],
