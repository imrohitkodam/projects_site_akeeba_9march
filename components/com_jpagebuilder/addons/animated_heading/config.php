...
JpagebuilderConfig::addonConfig([
	...
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_HEADING'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_HEADING_DESC'),
	'category'   => 'General',
	...
	'settings' => [
		'content' => [
			...
			'fields' => [
				'heading_style' => [
					...
					'values' => [
						'highlighted' => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_STYLE_HIGH'),
						'text-animation' => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_STYLE_ANI_TEXT')
					],
					'std'    => 'text-animation',
				],
				...
				'animated_text' => [
					'type'    => 'textarea',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_ANI_ANIMATED_TEXT'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_ANI_ANIMATED_TEXT_DESC'),
					'std'     => "awesome\nnice\ncool",
				...
				'highlighted_text' => [
					'type'    => 'text',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_TEXT'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_TEXT_DESC'),
					'std'     => 'awesome',
				...
				'shape_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_ANI_ANIMATED_SHAPE_COLOR'),
					'std'     => '#3366FF',
					'depends' => [['heading_style', '=', 'highlighted']]
				],
				...
				'heading_before_part' => [
					'type'  => 'text',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_BEFORE_TEXT'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_BEFORE_TEXT_DESC'),
					'std'   => 'This heading is'
				],

				'heading_after_part' => [
					'type'  => 'text',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_AFTER_TEXT'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_AFTER_TEXT_DESC'),
		...
		'animation' => [
			...
			'fields' => [
				'text_animation_name' => [
					'type'    => 'select',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_TEXT_ANI'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_TEXT_ANI_DESC'),
				...
				'shape_width' => [
					'type'    => 'slider',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_ANI_ANIMATED_SHAP_WIDTH'),
					'std'     => '',
					'max'     => 200,
				...
				'shape_radius' => [
					'type'    => 'checkbox',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_ANI_ANIMATED_SHAP_RADIUS'),
					'std'     => 0,
					'depends' => [['heading_style', '=', 'highlighted'], ['highlighted_shape', '!=', '']]
				],
				...
				'highlighted_shape' => [
					'type'    => 'select',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_SHAPE'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_ANI_HEADING_SHAPE_DESC'),
