...
JpagebuilderConfig::addonConfig([
	...
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_DESC'),
	'category'   => 'Content',
	...
	'settings' => [
		'content' => [
			...
			'fields' => [
				'number' => [
					'type'        => 'slider',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_NUMBER'),
					'std'         => '1000',
				],

				'duration' => [
					'type'        => 'slider',
					'title'       => Text::_('COM_JPAGEBUILDER_GLOBAL_ANIMATION_DURATION'),
					'std'         => '1000',
				],

				'number_before_after_text' => [
					'type'        => 'text',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_PREFIX'),
					'desc'        => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_BEF_AFT_TEXT_DESC'),
					'placeholder' => '+,K,$',
					'inline'	  => true,
				],
				...
				'number_position' => [
					...
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_POSITION_DESC'),
					'values' => [
				...
				'number_before_after_text_position' => [
					'type'   => 'radio',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_PREFIX_POSITION'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_BEF_AFT_TEXT_POS_DESC'),
					'values' => [
						'left'  => Text::_('COM_JPAGEBUILDER_GLOBAL_BEFORE'),
						'right' => Text::_('COM_JPAGEBUILDER_GLOBAL_AFTER'),
					],
					'std'   => 'left',
				],
				...
				'use_number_format' => [
					'type'   => 'checkbox',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_USE_FORMAT'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_ANIMATED_NUMBER_USE_NUMBER_FORMAT'),
					'std'   => 0,
				],
