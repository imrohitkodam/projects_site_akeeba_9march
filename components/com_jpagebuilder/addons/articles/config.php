...
JpagebuilderConfig::addonConfig([
    'type' => 'content',
    'addon_name' => 'articles',
    'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES'),
    ...
    'settings' => [
        ...
        'options' => [
            ...
            'fields' => [
                ...
                'columns' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_COLUMNS'),
                ...
                'gap' => [
                    'type'  => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_GAP'),
                    'std'   => 15,
                    'depends' => [
                        ['layout', '!=', 'default'],
                    ],
        ...
        'item' => [
            'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_CONTAINER_ARTICLE'),
            ...
            'fields' => [
                ...
                'content_radius' => [
                    'type'  => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_CONTENT_RADIUS'),
                    'std'   => 0,
                    'depends' => [
                        ['radius', '!=', 0],
                        ['layout', '!=', 'default'],
                ...
                'image_radius' => [
                    'type'  => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_IMAGE_RADIUS'),
                    'std'   => 0,
                    'depends' => [
                        ['radius', '!=', 0],
                        ['layout', '!=', 'default'],
                ...
                'show_boxshadow' => [
                    'type'    => 'checkbox',
                    'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BOX_SHADOW'),
                    'std'     => 0,
                    ['layout', '!=', 'default'],
                ],
                ...
                'shadow_color' => [
                    'type'    => 'color',
                    'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_SHADOW_COLOR'),
                    'std'     => 'rgba(0, 0, 0, .5)',
                ...
                'shadow_horizontal' => [
                    'type'    => 'slider',
                    'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BOX_SHADOW_HORIZONTAL'),
                    'max'     => 100,
                    'depends' => [['show_boxshadow', '=', 1]],
                ],
                ...
                'shadow_vertical' => [
                    'type'    => 'slider',
                    'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BOX_SHADOW_VERTICAL'),
                    'max'     => 100,
                    'depends' => [['show_boxshadow', '=', 1]],
                ],
                ...
                'shadow_blur' => [
                    'type'    => 'slider',
                    'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BOX_SHADOW_BLUR'),
                    'max'     => 100,
                    'depends' => [['show_boxshadow', '=', 1]],
                ],
                ...
                'shadow_spread' => [
                    'type'    => 'slider',
                    'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BOX_SHADOW_SPREAD'),
                    'max'     => 100,
                    'depends' => [['show_boxshadow', '=', 1]],
                ],
                ...
                'overlay_color' => [
                    'type' => 'color',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_OVERLAY_COLOR'),
                    'std'     => '',
                    'depends' => [
                        ['layout', '=', 'magazine'],
                    ],
        ...
        'content' => [
            'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_CONTENT_ARTICLE'),
            'fields' => [
                'content_padding' => [
                    'type' => 'padding',
        ...
        'media' => [
            'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_MEDIA_ARTICLE'),
            'fields' => [
                'image_at' => [
                    'type'  => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_IMAGE_AT'),
                    'std'   => Text::_('COM_JPAGEBUILDER_GLOBAL_LEFT'),
                    'values' => [
        ...
        'article_title' => [
            'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_TITLE_ARTICLE'),
            'fields' => [
        ...
        'show_custom_field' => [
            'type'  => 'checkbox',
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_CUSTOM_FIELD'),
            'fields' => [
                'show_custom_field' => [
                    'type'  => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_CUSTOM_FIELD'),
                    'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_CUSTOM_FIELD_DESC'),
                    'values' => [
                        1 => Text::_('COM_JPAGEBUILDER_YES'),
                        0 => Text::_('COM_JPAGEBUILDER_NO'),
                    ],
        ...
        'show_author' => [
            ...
            'fields' => [
                ...
                'author_margin_left' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_MARGIN_LEFT'),
                    'responsive' => true,
                    'depends' => [
                        ['show_author', '=', '1'],
                    ],
                ...
                'author_margin_right' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_MARGIN_RIGHT'),
                    'responsive' => true,
                    'depends' => [
                        ['show_author', '=', '1'],
                    ],
        ...
        'show_tags' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_TAGS'),
            'desc' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_TAGS_DESC'),
            'fields' => [
                'show_tags' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_TAGS'),
        ...
        'show_date' => [
            ...
            'fields' => [
                ...
                'show_date_text' => [
                    'type' => 'text',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_DATE_TEXT'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_DATE_TEXT_DESC'),
                    'std' => '',
                    'inline' => true,
                    'depends' => [['show_date', '=', '1']],
                ],
        ...
        'show_last_modified_date' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_LAST_MODIFIED_DATE'),
            'desc' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_LAST_MODIFIED_DATE_DESC'),
            'fields' => [
                'show_last_modified_date' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_LAST_MODIFIED_DATE'),
                ...
                'show_last_modified_date_text' => [
                    'type' => 'text',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_LAST_MODIFIED_DATE_TEXT'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_ARTICLES_SHOW_LAST_MODIFIED_DATE_TEXT_DESC'),
                    'std' => '',
                    'inline' => true,
