...
JpagebuilderConfig::addonConfig([
	...
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_BLOCKNUMBER'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_BLOCKNUMBER_DESC'),
	'category'   => 'Content',
	...
	'settings' => [
		'heading' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_BLOCKNUMBER_HEADING'),
			'fields' => [
				'heading' => [
					'type'    => 'textarea',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_BLOCKNUMBER_HEADING'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_BLOCKNUMBER_HEADING_DESC'),
					'std'     => 'Block Number',
				],
			...
			'fields' => [
				...
				'number_border_style' => [
					...
					'values' => [
						...
						'groove' => Text::_('COM_JPAGEBUILDER_GLOBAL_BORDER_STYLE_GROOVE'),
						'ridge'  => Text::_('COM_JPAGEBUILDER_GLOBAL_BORDER_STYLE_RIDGE'),
						'inset'  => Text::_('COM_JPAGEBUILDER_GLOBAL_BORDER_STYLE_INSET'),
						'outset' => Text::_('COM_JPAGEBUILDER_GLOBAL_BORDER_STYLE_OUTSET'),
					],
					'std'     => 'solid',
					'inline' => true,
				],
		...
		'content' => [
			...
			'fields' => [
				'text' => [
					'type'    => 'editor',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_BLOCKNUMBER_TEXT'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_BLOCKNUMBER_TEXT_DESC'),
