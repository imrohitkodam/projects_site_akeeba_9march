...
JpagebuilderConfig::addonConfig ( array (
		...
		'addon_name' => 'card',
		'title' => Text::_ ( 'Card' ),
		'desc' => Text::_ ( 'Create layout boxes with different styles.' ),
		'icon' => Uri::root () . 'components/com_jpagebuilder/addons/card/assets/images/icon.png',
		'category' => 'Interface',
		'attr' => array (
				'general' => array (
						'admin_label' => array (
						...
						'label_text' => array (
								'type' => 'text',
								'title' => Text::_ ( 'Label' ),
								'desc' => Text::_ ( 'To position a badge inside a card.' ),
								'std' => ''
						),
						'label_styles' => array (
								'type' => 'select',
