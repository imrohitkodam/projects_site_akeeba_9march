...
JpagebuilderConfig::addonConfig([
	...
	'category'   => 'Slider',
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ADVANCED'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ADVANCED_DESC'),
	...
	'settings' => [
				...
				'jp_carouselpro_item' => [
					...
					'attr'  => [
						'title' => [
							...
							'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ITEM_TITLE_DESC'),
						...
						'bg' => [
							...
							'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ADVANCED_ITEM_BACKGROUND_IMAGE_DESC'),
						],

						'image' => [
							'type'  => 'media',
							'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_IMAGE'),
							'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ITEM_IMAGE_DESC'),
						],

						'video' => [
							'type'  => 'text',
							'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_VIDEO'),
							'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ADVANCED_ITEM_VIDEO_DESC'),
						],
		...
		'content_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_CONTENT_OPTIONS'),
			'fields' => [
				'full_container' => [
					'type'  => 'checkbox',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_NO_CONTAINER'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_NO_CONTAINER_DESC'),
					'std'   => 0,
				],
				...
				'content_column' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_CONTENT_COLUMN'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_CONTENT_COLUMN_DESC'),
					'values' => [
						1  => 1,
						2  => 2,
						3  => 3,
				...
				'item_padding' => [
					'type'       => 'padding',
					'title'      => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ADVANCED_ITEM_PADDING'),
					'std'        => ['xl' => '', 'lg' => '', 'md' => '', 'sm' => '', 'xs' => ''],
					'responsive' => true
				],
			],
		...
		'slider_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_SLIDER_OPTIONS'),
			'fields' => [
				'carousel_height' => [
					'type'       => 'slider',
				...
				'autoplay' => [
					'type'   => 'checkbox',
					'title'  => Text::_('COM_JPAGEBUILDER_GLOBAL_AUTOPLAY'),
					'values' => [
						1 => Text::_('JYES'),
						0 => Text::_('JNO'),
					],
				...
				'interval' => [
					'type'    => 'slider',
					'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_INTERVAL'),
					'std'     => 5,
					'depends' => [['autoplay', '=', 1]]
				],
				...
				'speed' => [
					'type'  => 'slider',
					'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_SPEED'),
					'std'   => 600,
				],
				...
				'controllers' => [
					'type'   => 'checkbox',
					'title'  => Text::_('COM_JPAGEBUILDER_GLOBAL_CONTROLLERS'),
					'values' => [
						1 => Text::_('JYES'),
						0 => Text::_('JNO'),
					],
				...
				'arrow_position' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_PRO_ARROWS_POSITION'),
					'values' => [
						'default'       => 'Default',
