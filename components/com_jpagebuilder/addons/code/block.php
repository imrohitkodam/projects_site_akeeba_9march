...
class JpagebuilderAddoncode extends JpagebuilderAddons {
	public function render() {
		...
		// Options.
		$code = (isset ( $settings->code ) && $settings->code) ? $settings->code : '';
		...
		// Output.
		if ($code) {
			$output = '<div class="ui-code' . $zindex_cls . $general . '"' . $animation . '>';
			if ($title_addon) {
			...
			$output .= '<pre>';
			$output .= '<code class="ui-code-wrapper">';
			$output .= str_replace ( "\n", '', nl2br ( htmlspecialchars ( $code ) ) );
			$output .= '</code>';
			$output .= '</pre>';
			$output .= '</div>';
			return $output;
	...
	public function scripts() {
		return [ 
				...
				'components/com_jpagebuilder/addons/code/assets/highlight.min.js'
		];
	}
	public function stylesheets() {
		return [ 
				'components/com_jpagebuilder/assets/css/uitheme.css',
				'components/com_jpagebuilder/addons/code/assets/monokai.css'
		];
	}
	public static function getFrontendEditor() {
		...
		<# if ( code ) { #>
			<div class="ui-code{{ zindex_cls }}{{ general }}"{{{ animation }}}>

			<# if( !_.isEmpty( title_addon ) ){ #>
			...
			<pre>
			<code class="ui-code-wrapper hljs javascript">
				{{{_.escape(code)}}}
			</code>
			</pre>
			</div>
