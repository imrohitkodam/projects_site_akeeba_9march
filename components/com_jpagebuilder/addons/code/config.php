...
JpagebuilderConfig::addonConfig ( [ 
		...
		'addon_name' => 'code',
		'title' => Text::_ ( 'Code' ),
		'desc' => Text::_ ( 'Syntax highlighting for the Web' ),
		'icon' => '<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.01" points="13,4 19,10 13,16"></polyline><polyline fill="none" stroke="#000" stroke-width="1.01" points="7,4 1,10 7,16"></polyline></svg>',
		'category' => 'Interface',
		'settings' => [ 
				'addon_title_options' => [ 
				...
				'content' => [ 
						...
						'fields' => [ 
								'code' => [ 
										'type' => 'textarea',
										'title' => Text::_ ( 'Code' ),
										'std' => '<div id="myid" class="myclass" hidden>Lorem ipsum <strong>dolor</strong> sit amet, consectetur adipiscing elit.</div>'
								]
						]
				],
