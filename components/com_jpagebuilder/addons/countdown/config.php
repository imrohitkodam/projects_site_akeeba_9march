...
JpagebuilderConfig::addonConfig([
	...
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_DESC'),
	'category'   => 'Content',
	...
	'settings' => [
		'content' => [
			...
			'fields' => [
				'date' => [
					'type'        => 'text',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_DATE'),
					'desc'        => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_DATE_DESC'),
				...
				'time' => [
					'type'        => 'text',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_TIME'),
					'desc'        => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_TIME_DESC'),
					'placeholder' => '20:23',
					'std'         => '20:23',
				],
				...
				'finish_text' => [
					'type'        => 'text',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_FINISHED_TEXT'),
					'desc'        => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_FINISHED_TEXT_DESC'),
					'std'         => 'Finally we are here',
				],

				'counter_text_typography' => [
					'type'     => 'typography',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_NUMBERS'),
					'fallbacks'   => [
				...
				'label_typography' => [
					'type'     => 'typography',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_LABELS'),
					'fallbacks'   => [
				...
				'label_margin' => [
					'type'       => 'margin',
					'title'      => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_COUNTER_LABEL_MARGIN'),
					'responsive' => true,
				],
			],
		],
		...
		'counter' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_COUNTER'),
			'fields' => [
				'counter_width' => [
					'type'       => 'slider',
				...
				'counter_text_color' => [
					'type'   => 'color',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_NUMBER_COLOR'),
					'std'    => '#FFFFFF',
				],
				...
				'label_color' => [
					'type'   => 'color',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_COUTNDOWN_LABEL_COLOR'),
				],
