...
class JpagebuilderAddonDiv extends JpagebuilderAddons {

	/**
	 * The render method of the DIV addon.
	 * The HTML of the DIV addon is managed from
	 * the `addonparser.php` file. Nothing is needed to return from here.
	 *
	 * @return string
	 * @since 4.0.0
	 */
	...
	public function css() {
		...
		if (isset ( $settings->display ) && \in_array ( $settings->display, [ 
				'flex',
				'inline-flex'
		] )) {
