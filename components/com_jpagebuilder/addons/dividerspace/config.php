...
JpagebuilderConfig::addonConfig ( [ 
		'type' => 'content',
		'addon_name' => 'dividerspace',
		'title' => Text::_ ( 'Divider' ),
		'desc' => Text::_ ( 'Create dividers to separate content and apply different styles to them.' ),
		'icon' => '<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><rect height="1" width="18" y="9" x="1"></rect></svg>',
		'category' => 'Interface',
		'settings' => [ 
				'divider_options' => [ 
						'title' => Text::_ ( 'Divider' ),
						'fields' => [ 
								'divider_type' => [ 
										'type' => 'select',
										'title' => Text::_ ( 'Style' ),
										'desc' => Text::_ ( 'Choose a divider style.' ),
										'values' => [ 
												'uk-hr' => Text::_ ( 'Default' ),
												'uk-divider-icon' => Text::_ ( 'Icon' ),
												'uk-divider-small' => Text::_ ( 'Small' ),
												'uk-divider-vertical' => Text::_ ( 'Vertical' )
										],
										'std' => 'uk-hr',
										'inline' => true
								],
								...
								'html_selector' => [ 
										...
										'desc' => Text::_ ( 'Choose the divider element to fit your semantic structure. Use the hr element for a thematic break and the div element for decorative reasons.' ),
										'values' => [ 
												'hr' => 'Hr',
												'div' => 'Div'
										],
