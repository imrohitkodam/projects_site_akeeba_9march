...
JpagebuilderConfig::addonConfig([
	'type'       => 'content',
	'addon_name' => 'feature',
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_DESC'),
	'category'   => 'Content',
	...
	'settings' => [
		...
		'media' => [
			'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_MEDIA'),
			'fields' => [
				'title_position' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_GLOBAL_POSITION'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_ICON_IMAGE_POSITION_DESC'),
					'values' => [
						'after'  => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_TITLE_POSITION_BEFORE_TITLE'),
						'before' => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_TITLE_POSITION_AFTER_TITLE'),
				...
				'feature_type' => [
					...
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_LAYOUT_TYPE_DESC'),
					'values' => [
						'icon'  => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_LAYOUT_TYPE_ICON'),
						'image' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE'),
						'both'  => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_LAYOUT_TYPE_BOTH'),
					],
					'std' => 'icon'
				],
			]
		...
		'icon' => [
			...
			'fields' => [
				...
				'icon_hover_bg' => [
					'type'  => 'color',
					'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_BACKGROUND_HOVER_COLOR'),
				],
		...
		'image' => [
			...
			'fields' => [
				...
				'feature_image_alt' => [
					'type' 	  => 'text',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_IMAGE_ALT'),
					'desc'	  => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_IMAGE_ALT_DESC'),
					'std' 	  => '',
				],
		...
		'link' => [
			...
			'fields' => [
				'title_url' => [
					'type'      => 'link',
					'title'     => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_TITLE_IMAGE_URL'),
					'desc'      => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_TITLE_IMAGE_URL_DESC'),
					'hideTitle' => true,
				],

				'url_appear' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_URL_APEAR'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_URL_APEAR_DESC'),
					'values' => [
						'title' => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_URL_APEAR_TITLE'),
						'icon'  => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_URL_APEAR_ICON'),
		...
		'style' => [
			...
			'fields' => [
				...
				'title_text_color' => [
					'type'   => 'color',
					'title'  => Text::_('COM_JPAGEBUILDER_GLOBAL_TITLE_COLOR'),
				...
				'icon_color' => [
					'type'    => 'color',
					'std'     => '#3366FF',
					'title'  => Text::_('COM_JPAGEBUILDER_GLOBAL_ICON_COLOR'),
					'depends' => [
				...
				'addon_hover_boxshadow' => [
					'type'  => 'boxshadow',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_HOVER_BOXSHADOW'),
					'std'   => '0 0 0 0 #ffffff',
					'depends' => [['feature_style_state', '=', 'hover']]
				],
			],
