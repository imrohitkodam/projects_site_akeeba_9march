...
JpagebuilderConfig::addonConfig ( array (
		'type' => 'repeatable',
		'addon_name' => 'filtergallery',
		'title' => Text::_ ( 'Filter Gallery' ),
		...
		'icon' => Uri::root () . 'components/com_jpagebuilder/addons/filtergallery/assets/images/icon.png',
		'category' => 'Interface',
		'attr' => array (
				'general' => array (
						'admin_label' => array (
						...
						'switcher_font_family' => array (
								...
								'selector' => array (
										'type' => 'font',
										'font' => '{{ VALUE }}',
										'css' => '.tm-filter>*>a { font-family: {{ VALUE }}; }'
								)
						),
