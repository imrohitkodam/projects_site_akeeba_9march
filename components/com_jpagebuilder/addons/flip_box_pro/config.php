...
JpagebuilderConfig::addonConfig([
    ...
    'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_PRO'),
    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_PRO_DESC'),
    'category' => 'Content',
    ...
    'settings' => [
        'flip_box_basic_options' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_PRO_GENERAL'),
            'fields' => [
                'flip_behavior' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_FLIP_BHAVE'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_FLIP_BHAVE_DESC'),
                    'values' => [
                        'hover' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_FLIP_BHAVE_HOVER'),
                        'click' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_FLIP_BHAVE_CLICK'),
                    ],
                    'std' => 'hover',
                    'inline' => true,
                ],
                ...
                'flip_style' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_STYLE'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_STYLE_DESC'),
                    'values' => [
                        'rotate_style' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_ROTATE_STYLE'),
                        'slide_style' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_SLIDE_STYLE'),
                        'fade_style' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_FADE_STYLE'),
                        'threeD_style' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_3D_STYLE'),
                    ],
                    'std' => 'flat_style',
                    'inline' => true,
                ],
                ...
                'rotate' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_ROTATE'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_ROTATE_DESC'),
                    'values' => [
                        'flip_top' => Text::_('COM_JPAGEBUILDER_ADDON_GLOBAL_FROM_TOP'),
                        'flip_bottom' => Text::_('COM_JPAGEBUILDER_GLOBAL_BOTTOM'),
                        'flip_left' => Text::_('COM_JPAGEBUILDER_ADDON_GLOBAL_FROM_LEFT'),
                        'flip_right' => Text::_('COM_JPAGEBUILDER_GLOBAL_RIGHT'),
                    ],
                    'std' => 'flip_right',
                    'inline' => true,
                ...
                'height' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_HEIGHT'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_FLIPBOX_HEIGHT_DESC'),
                    'std' => '',
                    'responsive' => true,
                    'max' => 1000,
                ],
        ...
        'flip_box_front_content' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_FRONT'),
            'fields' => [
                // title
                'front_add_title' => [
                    'type' => 'checkbox',
                ...
                'front_add_paragraph' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_PRO_PARAGRAPH'),
                    'std' => 0,
                ],
                ...
                'front_icon' => [
                    'type'      => 'icon',
                    'title'     => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_PRO_ICON_NAME'),
                    'std'       => 'fas fa-cogs',
                    'depends' => [
                        ['front_add_icon', '=', 1],
                    ],
                ...
                'front_global_background_type' => [
                    ...
                    'values' => [
                        ['label' => Text::_('COM_JPAGEBUILDER_GLOBAL_NONE'), 'value' => 'none'],
        ...
        'flip_box_back_content' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_BACK'),
            'fields' => [
                // title
                'back_add_title' => [
                    'type' => 'checkbox',
        ...
        'flip_box_options' => [
            ...
            'fields' => [
                'flip_box_options_tabs' => [
                    ...
                    'title'  => Text::_('COM_JPAGEBUILDER_GLOBAL_STYLE'),
                    'values' => [
                        ['label' => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_FRONT'), 'value' => 'front'],
                        ['label' => Text::_('COM_JPAGEBUILDER_ADDON_FLIP_BOX_BACK'), 'value' => 'back'],
                    ],
                    'tabs' => true,
                ],
                ...
                'front_bg_type' => [
                    ...
                    'std' => 'image',
                    'values' => [
                        'color' => Text::_('COM_JPAGEBUILDER_GLOBAL_COLOR'),
                        'image' => Text::_('COM_JPAGEBUILDER_GLOBAL_IMAGE'),
                    ],
                    'depends' => [
                ...
                'front_bg_inner_type' => [
                    ...
                    'std' => 'none',
                    'values' => [
                        'none' => Text::_('COM_JPAGEBUILDER_GLOBAL_NONE'),
                        'color' => Text::_('COM_JPAGEBUILDER_GLOBAL_COLOR'),
                        'gradient' => Text::_('COM_JPAGEBUILDER_GLOBAL_GRADIENT'),
                    ],
                    'depends' => [
                        ['front_bg_type', '=', 'color'],
                    ],
                ...
                'front_bgimg' => [
                    ...
                    'std' => ['src' => 'https://storejextensions.org/cdn/addons/flipbox-bg-1.jpg'],
                    'depends' => [
                        ['flip_box_options_tabs', '=', 'front'],
                    ],
                ],
