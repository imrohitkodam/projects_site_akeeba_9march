...
JpagebuilderConfig::addonConfig ( array (
		...
		'icon' => Uri::root () . 'components/com_jpagebuilder/addons/grid/assets/images/icon.png',
		'category' => 'Interface',
		'attr' => array (
				'general' => array (
						'admin_label' => array (
						...
						'filter_control' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Show filter control for all items' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'all_control' => array (
								'type' => 'text',
								'std' => '',
								'title' => Text::_ ( 'All Items' ),
								'desc' => Text::_ ( 'Show filter control for all items' ),
								'placeholder' => 'All',
								'depends' => array (
										'enable_filter' => 1
								)
						...
						'show_lightbox_title' => array (
								...
								'desc' => Text::_ ( 'Display the title inside the panel, as the lightbox caption or both.' ),
								'values' => array (
						...
						'show_lightbox_content' => array (
								...
								'desc' => Text::_ ( 'Display the content inside the panel, as the lightbox caption or both.' ),
								'values' => array (
										'' => Text::_ ( 'Overlay + Lightbox' ),
