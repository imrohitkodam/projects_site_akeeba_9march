...
JpagebuilderConfig::addonConfig([
    ...
    'title'      => Text::_('COM_JPAGEBUILDER_ADDON_ICONS_GROUP'),
    'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_ICONS_GROUP_DESC'),
    'category'   => 'Media',
    ...
    'settings' => [
        'content' => [
            ...
            'fields' => [
                'jp_icons_group_item' => [
                    'type'  => 'repeatable',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_ICONS_GROUP_ITEM'),
                    'attr'  => [
                        'title' => [
                            'type'  => 'text',
                        ...
                        'border_style' => [
                            ...
                            'desc'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BORDER_STYLE_DESC'),
                            'values' => [
                        ...
                        'padding' => [
                            ...
                            'placeholder' => '10px',
                            'responsive'  => true,
                            'std'         => ['xl' => '20px 20px 20px 20px', 'lg' => '', 'md' => '', 'sm' => '', 'xs' => ''],
                        ],

                        'label_separator' => [
                            'type'  => 'separator',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_ICON_SHOW_LABEL_OPTIONS')
                        ],

                        'show_label' => [
                            'type'  => 'checkbox',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_ICON_SHOW_LABEL'),
                            'std'   => 0,
                        ],

                        'label_position' => [
                            'type'   => 'select',
                            'title'  => Text::_('COM_JPAGEBUILDER_ADDON_ICON_LABEL_POSITION'),
                            'values' => [
                        ...
                        'label_text' => [
                            'type'        => 'text',
                            'title'       => Text::_('COM_JPAGEBUILDER_ADDON_ICON_LABEL_TEXT'),
                        ...
                        // 'label_size' => [
                        //     'type'       => 'slider',
                        //     'title'      => Text::_('COM_JPAGEBUILDER_GLOBAL_LABEL_FONT_SIZE'),
                        //     'max'        => 400,
                        //     'std'        => ['md' => 16],
                        //     'responsive' => true,
                        //     'depends'    => [['show_label', '=', 1]]
                        ...
                        // 'label_lineheight' => [
                        //     'type'       => 'slider',
                        //     'title'      => Text::_('COM_JPAGEBUILDER_GLOBAL_LINE_HEIGHT'),
                        //     'max'        => 400,
                        //     'responsive' => true,
                        //     'std'        => '',
                        //     'depends'    => [['show_label', '=', 1]]
                        ...
                        // 'label_font_style' => [
                        //     'type'    => 'fontstyle',
                        //     'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_FONT_STYLE'),
                        //     'depends' => [['show_label', '=', 1]]
                        // ],

                        'label_margin' => [
                            'type'        => 'margin',
                            'title'       => Text::_('COM_JPAGEBUILDER_ADDON_ICONS_GROUP_MARGIN'),
                            'placeholder' => '10',
                            'responsive'  => true,
                            'depends'     => [['show_label', '=', 1]]
                        ],
                        ...
                        'separator' => [
                            'type'  => 'separator',
                            'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_MOUSE_HOVER_OPTIONS')
                        ],

                        'use_hover' => [
                            'type'  => 'checkbox',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_ICON_USE_HOVER'),
                            'std'   => 0,
                        ],
        ...
        'options' => [
            ...
            'fields' => [
                ...
                'item_display' => [
                    'type'   => 'select',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_ICON_DISPLAY'),
                    'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_ICON_DISPLAY_DESC'),
                    'values' => [
                        'inline-block' => Text::_('COM_JPAGEBUILDER_ADDON_ICON_DISPLAY_INLINE'),
                        'block'        => Text::_('COM_JPAGEBUILDER_ADDON_ICON_DISPLAY_BLOCK'),
                    ],
                    'std' => 'inline-block',
                ],
            ],
        ...
        'title' => [
            ...
            'fields' => [
                ...
                'title_icon' => [
                    'type'  => 'icon',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_TITLE_ICON'),
                ],

                'title_icon_position' => [
                    'type'   => 'radio',
                    'title'  => Text::_('COM_JPAGEBUILDER_ADDON_TITLE_ICON_POSITION'),
                    'values' => [
                        'before' => Text::_('COM_JPAGEBUILDER_ADDON_TITLE_ICON_POSITION_BEFORE'),
                        'after'  => Text::_('COM_JPAGEBUILDER_ADDON_TITLE_ICON_POSITION_AFTER'),
                    ],
                    'std' => 'before'
                ],
