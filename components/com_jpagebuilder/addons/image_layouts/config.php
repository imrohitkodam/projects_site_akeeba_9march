...
JpagebuilderConfig::addonConfig([
    ...
    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT'),
    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_DESC'),
    'category' => 'Media',
    ...
    'settings' => [
        'general' => [
            ...
            'fields' => [
                'image_preset_thumb' => [
                    'type' => 'thumbnail',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_LAYOUT'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_STYLE_DESC'),
                    'columns' => 3,
                    'values' => [
                ...
                'image' => [
                    'type' => 'media',
                    'hide_alt_text' => true,
                    'std' => ['src' => 'https://storejextensions.org/cdn/addons/image_layouts_default.jpg'],
                ],
                ...
                'image_container_column' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_IMG_CONTAINER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_IMG_CONTAINER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'image_strech' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_STREACH'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_STREACH_DESC'),
                    'std' => 1,
                    'depends' => [
                ...
                'image_order_option' => [
                    'type' => 'buttons',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_ORDER_OPTIONS'),
                    'values' => [
                ...
                'image_desktop_order' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_DESK_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_DESK_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'image_tab_order_land' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_TAB_LAND_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_TAB_LAND_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'image_tab_order' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_TAB_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_TAB_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'image_mob_order_land' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_MOB_LAND_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_MOB_LAND_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'image_mob_order' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_MOB_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_IMG_MOB_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'click_url' => [
                    ...
                    'std' => 'https://storejextensions.org/extensions/jpagebuilder-joomla-page-builder.html',
                ],

                'link_apear_in_title' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_TITLE_URL'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_TITLE_URL_DESC'),
                    'std' => 1,
        ...
        'content' => [
            ...
            'fields' => [
                ...
                'content_desktop_order' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_DESK_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_DESK_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'content_tab_order_land' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_TAB_LAND_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_TAB_LAND_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'content_tab_order' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_TAB_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_TAB_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'content_mob_order_land' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_MOB_LAND_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_MOB_LAND_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'content_mob_order' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_MOB_ORDER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_MOB_ORDER_DESC'),
                    'values' => [
                        1 => 1,
                        2 => 2,
                        3 => 3,
                ...
                'content_text_align' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_TEXT_ALIGN'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_TEXT_ALIGN_DESC'),
                    'values' => [
                ...
                'content_vertical_align' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_VERT_ALIGN'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CONT_VERT_ALIGN_DESC'),
                    'values' => [
        ...
        'lightbox' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OPEN_LIGHTBOX'),
            'depends' => [['image_preset_thumb', '=', 'inline']],
            'fields' => [
                'open_in_lightbox' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OPEN_LIGHTBOX'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OPEN_LIGHTBOX_DESC'),
                    'std' => 0,
                    'is_header' => 1,
                ],
                ...
                'image_overlay_color' => [
                    'type' => 'color',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_DESC'),
                ...
                'lightbox_icon_bg' => [
                    'type' => 'color',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_LIGHTBOX_BG'),
                    'std' => '',
                    'depends' => [['open_in_lightbox', '!=', 0]],
                ],
            ],
        ...
        'video' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_POPUP_VIDEO'),
            'depends' => [['image_preset_thumb', '=', 'card']],
            'fields' => [
                'popup_video_on_image' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_VIDEO_POPUP'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_VIDEO_POPUP_DESC'),
                    'std' => 0,
                    'is_header' => 1,
                ],
                ...
                'popup_video_src' => [
                    'type' => 'text',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_VIDEO_POPUP_SRC'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_VIDEO_POPUP_SRC_DESC'),
        ...
        'caption' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_CAPTION'),
            'depends' => [['image_preset_thumb', '=', 'inline']],
            'fields' => [
                'caption' => [
                    'type' => 'textarea',
                    'std' => 'Hidden beyond the vast horizon of structured sentences, far from the nations of coherence, live the Mysterious Texts.'
                ],
                ...
                'caption_postion' => [
                    ...
                    'values' => [
                        'no-caption' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CAPTION_NO'),
                        'caption-below' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CAPTION_BELOW'),
                        'caption-overlay' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CAPTION_OVERLAY'),
                        'caption-overlay-on-over' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUT_CAPTION_OVERLAY_HOVER'),
                    ],
                    'std' => 'caption-below',
                ],
            ],
        ...
        'wrapper' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER'),
            'depends' => [['image_preset_thumb', '!=', 'inline']],
            'fields' => [
                'wrapper_border' => [
                    'type' => 'margin',
                ...
                'wrapper_color_type' => [
                    'type' => 'buttons',
                    'values' => [
                        ['label' => Text::_('COM_JPAGEBUILDER_GLOBAL_COLOR'), 'value' => 'color'],
                        ['label' => Text::_('COM_JPAGEBUILDER_GLOBAL_GRADIENT'), 'value' => 'gradient'],
                    ],
                    'std' => 'color',
                ],
                ...
                'wrapper_backdrop_filter' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_DESC'),
                    'values' => [
                        'blur' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_BLUR'),
                        'brightness' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_BRIGHTNESS'),
                        'contrast' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_CONTRAST'),
                        'grayscale' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_GRAYSCALE'),
                        'invert' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_INVERT'),
                        'opacity' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_OPACITY'),
                        'sepia' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_SEPIA'),
                        'saturate' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_SATURATE'),
                    ],
                    'std' => '',
                ],
                ...
                'wrapper_backdrop_filter_value' => [
                    'type'  => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_VALUE'),
                    'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_LAYOUTS_WRAPPER_BACKDROP_FILTER_VALUE_DESC'),
                    'max'   => 100,
