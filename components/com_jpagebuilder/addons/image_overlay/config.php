	...
	'settings' => [
		'content' => [
			...
			'fields' => [
				'image' => [
					'type'       => 'media',
					'hide_alt_text' => true,
					'std'        => ['src' => 'https://storejextensions.org/cdn/addons/image1.jpg',]
				],
				...
				'background_image_animation' => [
					...
					'values' => [
						'slide-top'    => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_BG_ANIMATION_SLIDE_TOP'),
						'slide-right'  => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_BG_ANIMATION_SLIDE_RIGHT'),
						'slide-bottom' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_BG_ANIMATION_SLIDE_BOTTOM'),
						'slide-left'   => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_BG_ANIMATION_SLIDE_LEFT'),
						'zoom-in'      => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_BG_ANIMATION_SLIDE_ZOOMIN'),
						'zoom-out'     => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_BG_ANIMATION_SLIDE_ZOOMOUT'),
					],
					'std'     => 'slide-left',
					'inline'  => true,
				],
				...
				'image_in_lightbox' => [
					'type'    => 'checkbox',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_IMG_IN_LIGHTBOX'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_IMG_IN_LIGHTBOX_DESC'),
					'std'     => 0,
				],
				...
				'title_subtitle_position' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_CONTENT_POSITION'),
					'values' => [
						'top-left'      => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_TOP_LEFT'),
						'top-center'    => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_TOP_CENTER'),
						'top-right'     => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_TOP_RIGHT'),
						'center-left'   => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_CENTER_LEFT'),
						'center-center' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_CENTER_CENTER'),
						'center-right'  => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_CENTER_RIGHT'),
						'bottom-left'   => Text::_('COM_JPAGEBUILDER_ADDON_BOTTOM_LEFT'),
						'bottom-center' => Text::_('COM_JPAGEBUILDER_ADDON_BOTTOM_CENTER'),
						'bottom-right'  => Text::_('COM_JPAGEBUILDER_ADDON_BOTTOM_RIGHT'),
					],
					'std'     => 'bottom-left',
				],
				...
				'show_content_on_hover' => [
					'type'  => 'checkbox',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_SHOW_CONTENT'),
					'std'   => 0
				],
		...
		'sub_title' => [
			...
			'fields' => [
				'sub_title' => [
					'type'  => 'text',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_SUBTITLE'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_SUBTITLE_DESC'),
		...
		'overlay_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_OVERLAY_OPTIONS'),
			'fields' => [
				'overlay_style_tab' => [
					'type'   => 'buttons',
					'values' => [
