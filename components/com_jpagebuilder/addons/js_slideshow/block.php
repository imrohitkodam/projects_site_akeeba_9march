...
class JpagebuilderAddonJs_slideshow extends JpagebuilderAddons {
	/**
	...
	public function render() {
		...
		if (isset ( $settings->slideshow_items ) && is_array ( $settings->slideshow_items )) {
			...
			foreach ( $settings->slideshow_items as $item_key => $item_value ) {
				...
				$uniqid = 'jp-slider-item-' . $this->addon->id . '-num-' . $item_key . '-key';

				$output .= '<div id="' . $uniqid . '" class="jp-item ' . (($item_key == 0) ? ' active' : '') . ' ' . ($content_vertical_alignment ? 'slider-content-vercally-center' : '') . '">';

				if ($content_container_option === 'bootstrap') {
					$output .= '<div class="jpb-container">';
					$output .= '<div class="jpb-row">';
					$output .= '<div class="jpb-col-sm-12">';
				} else {
					$output .= '<div class="jp-slider-content-wrap">';
				}
				...
				if (! $image_in_column) {
					$output .= '<div class="jp-slider-content-align-' . $content_alignment . '">';
					...
					if (isset ( $item_value->slideshow_inner_items ) && is_array ( $item_value->slideshow_inner_items )) {
						foreach ( $item_value->slideshow_inner_items as $inner_item_key => $inner_value ) {
							$inner_uniqid = 'jp-slider-inner-item-' . $increasing_addon_id . '-num-' . $inner_item_key . '-key';
							...
							list ( $button_url, $button_target ) = JpagebuilderAddonHelper::parseLink ( $inner_value, 'button_url', [ 
									'url' => 'button_url',
							...
							if ($button_icon_position == 'left') {
								$btn_content = ($button_icon) ? '<span class="jp-slider-btn-text"> <span class="jp-slider-btn-icon"><i class="' . $button_icon . '"></i></span> ' . $btn_content . '</span>' : '<span class="jp-slider-btn-text">' . $btn_content . '</span>';
							} else {
								$btn_content = ($button_icon) ? '<span class="jp-slider-btn-text">' . $btn_content . ' <span class="jp-slider-btn-icon"><i class="' . $button_icon . '" aria-hidden="true"></i></span></span>' : '<span class="jp-slider-btn-text">' . $btn_content . '</span>';
							}
							...
							if ($content_type == 'text_content') {
								$output .= '<div id="' . $inner_uniqid . '" class="jpb-jp-slider-text' . $content_class . '" data-layer="true" data-animation=\'{' . $animation_settings . '}\'>';
								$output .= $content_text;
								$output .= '</div>';
							} elseif ($content_type == 'image_content') {
								$output .= '<div id="' . $inner_uniqid . '" class="jpb-jp-slider-image' . $content_class . '" data-layer="true" data-animation=\'{' . $animation_settings . '}\'>';
								$output .= '<img src="' . $image_content_src . '" alt="' . $alt_text . '"/>';
								$output .= '</div>';
							} elseif ($content_type == 'btn_content') {
								$output .= '<a id="' . $inner_uniqid . '" ' . (stripos ( $button_target, '_blank' ) !== false ? $button_target : '') . ' class="jpb-jp-slider-button' . $content_class . '" href="' . $button_url . '" data-layer="true" data-animation=\'{' . $animation_settings . '}\'>';
								$output .= $btn_content;
								$output .= '</a>';
							} elseif ($content_type == 'icon_content') {
								$output .= '<span id="' . $inner_uniqid . '" class="jpb-jp-slider-icon' . $content_class . ' ' . ($icon_display_block ? 'jp-slider-icon-block' : '') . '" data-layer="true" data-animation=\'{' . $animation_settings . '}\'>';
								$output .= '<span class="' . $icon_content . '" aria-hidden="true"></span>';
								$output .= '</span>';
							} elseif ($content_type == 'title_content') {
								$output .= '<' . $title_heading_selector . ' id="' . $inner_uniqid . '" class="jpb-jp-slider-title' . $content_class . '" data-layer="true" data-animation=\'{' . $animation_settings . '}\'>';
					...
					$output .= '</div>'; // .jp-slider-content-align
				} else {
					$output .= '<div class="jpb-row">';

					if (! $image_column_reverse) {
						$output .= '<div class="jpb-col-xs-' . ($image_column_width_xs === 12 ? 12 : (12 - $image_column_width_xs)) . ' jpb-col-sm-' . ($image_column_width_sm === 12 ? 12 : (12 - $image_column_width_sm)) . ' jpb-col-md-' . ($image_column_width_md === 12 ? 12 : (12 - $image_column_width_md)) . ' jpb-col-lg-' . ($image_column_width_lg === 12 ? 12 : (12 - $image_column_width_lg)) . ' jpb-col-' . ($image_column_width === 12 ? 12 : (12 - $image_column_width)) . '">';
						...
						if (isset ( $item_value->slideshow_inner_items ) && is_array ( $item_value->slideshow_inner_items )) {
							foreach ( $item_value->slideshow_inner_items as $inner_item_key => $inner_value ) {
								...
								if ($button_icon_position == 'left') {
									$btn_content = ($button_icon) ? '<span class="jp-slider-btn-text"> <span class="jp-slider-btn-icon"><i class="' . $button_icon . '" aria-hidden="true"></i></span> ' . $btn_content . '</span>' : '<span class="jp-slider-btn-text">' . $btn_content . '</span>';
								} else {
									$btn_content = ($button_icon) ? '<span class="jp-slider-btn-text">' . $btn_content . ' <span class="jp-slider-btn-icon"><i class="' . $button_icon . '" aria-hidden="true"></i></span></span>' : '<span class="jp-slider-btn-text">' . $btn_content . '</span>';
								}
						...
						$output .= '</div>'; // .jp-slider-content-align
						$output .= '</div>'; // jpb-column

						$output .= '<div class="jpb-col-xs-' . $image_column_width_xs . ' jpb-col-sm-' . $image_column_width_sm . ' jpb-col-md-' . $image_column_width_md . ' jpb-col-lg-' . $image_column_width_lg . ' jpb-col-' . $image_column_width . '">';

						$output .= '<div class="jp-slider-image-align-' . $image_content_alignment . '">';
						...
						if (isset ( $item_value->slideshow_inner_items ) && is_array ( $item_value->slideshow_inner_items )) {
							foreach ( $item_value->slideshow_inner_items as $inner_item_key => $inner_value ) {
								...
								if ($content_type == 'image_content') {
									...
									$output .= '</div>'; // .jpb-jp-slider-image
								}
							}
						}
						$output .= '</div>'; // .jp-slider-content-align
				...
				if ($content_container_option === 'bootstrap') {
					$output .= '</div>'; // .jpb-col-sm-12
					$output .= '</div>'; // .jpb-row
					$output .= '</div>'; // .jpb-container
				} else {
					$output .= '</div>'; // .jp-slider-content-wrap
				}
				...
				if ($slider_img_src) {
					if (strpos ( $slider_img_src, "http://" ) !== false || strpos ( $slider_img_src, "https://" ) !== false) {
						$output .= '<div class="jp-background" style="background-image: url(' . $slider_img_src . ');"></div>';
					} else {
						$output .= '<div class="jp-background" style="background-image: url(' . Uri::base () . $slider_img_src . ');"></div>';
					}
				}
				...
				if ($slider_animation != '3D') {
					...
					if (($slider_video_src) && (! isset ( $item_value->enable_youtube_vimeo ) || (isset ( $item_value->enable_youtube_vimeo ) && ! $item_value->enable_youtube_vimeo))) {
						if (strpos ( $slider_video_src, "http://" ) !== false || strpos ( $slider_video_src, "https://" ) !== false) {
							$output .= '<div class="jp-video-background" data-video_src="' . $slider_video_src . '"></div>';
						} else {
							$output .= '<div class="jp-video-background" data-video_src="' . Uri::base () . $slider_video_src . '"></div>';
						}
						...
						if (strpos ( $item_value->youtube_vimeo_url, "http://" ) !== false || strpos ( $item_value->youtube_vimeo_url, "https://" ) !== false) {
							$output .= '<div class="jp-video-background" data-video_src="' . $item_value->youtube_vimeo_url . '"></div>';
						} else {
							$output .= '<div class="jp-video-background" data-video_src="' . Uri::base () . $item_value->youtube_vimeo_url . '"></div>';
						}
					}
				}
				...
				if ($dot_controllers_style == 'with_text') {
					...
					$dots .= '<li class="' . ($item_key == 0 ? 'active jp-text-thumbnail-list' : 'jp-text-thumbnail-list') . '">';
					$dots .= '<div class="jp-slider-text-thumb-number">' . ($item_key > 8 ? ($item_key + 1) : '0' . ($item_key + 1) . '') . '</div>'; // .jp-slider-text-thumb-number
					$dots .= '<div class="jp-dot-indicator-wrap">';
					$dots .= '<span class="dot-indicator"></span>';
					$dots .= '</div>'; // .jp-dot-indicator-wrap
					$dots .= '<div class="jp-slider-text-thumb-caption">';

					if (count ( $captionItem ) > 0) {
						foreach ( $captionItem as $dot_key => $inner_value ) {
							// Content type
							$title_content_title = (isset ( $inner_value->title_content_title ) && $inner_value->title_content_title) ? $inner_value->title_content_title : '';
							$dots .= '<div class="jp-slider-dot-indecator-text jp-dot-text-key-' . ($dot_key + 1) . '">';
							$dots .= $title_content_title;
							$dots .= '</div>'; // .jp-slider-dot-indecator-text
						}
					}
					$dots .= '</div>'; // .jp-slider-text-thumb-caption
					$dots .= '</li>';
				}
		...
		if ($dot_controllers_style == 'with_text' && $dot_controllers) {
			$output .= '<div class="jp-slider-custom-dot-indecators">
						<ul>
							' . $dots . '
						</ul>';
			$output .= '</div>'; // .jp-slider-custom-dot-indecators
		}

		$output .= '</div>'; // .jpb-addon-jp-slider
	...
	public function scripts() {
		return array (
				'components/com_jpagebuilder/assets/js/js_slider.js'
		);
	}
	/**
	...
	public function stylesheets() {
		return array (
				'components/com_jpagebuilder/assets/css/js_slider.css'
		);
	}
	/**
	...
	public function css() {
		...
		// Timer style
		$css .= $cssHelper->generateStyle ( '.jp-dot-indicator-wrap .dot-indicator, .jp-indicator.line-indicator', $settings, [ 
				'timer_color' => 'background'
		], false );
		$css .= $cssHelper->generateStyle ( '.jp-dot-indicator-wrap', $settings, [ 
				'timer_bg_color' => 'background'
		], false );
		$css .= $cssHelper->generateStyle ( '.jp-indicator-container', $settings, [ 
				'timer_bg_color' => 'background',
				'timer_width' => 'width',
				'timer_top_gap' => 'top',
				'timer_left_gap' => 'left'
		], [ 
				'timer_bg_color' => false,
				'timer_width' => '%'
		] );
		...
		if ($dot_controllers_position == 'vertical_left' || $dot_controllers_position == 'vertical_right') {
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-dots', $settings, [ 
					'dot_ctlr_width' => 'height:100%;max-width'
			] );
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-dots ul', $settings, [ 
		...
		$css .= $cssHelper->generateStyle ( '.jp-slider .jp-dots ul li', $settings, $dotsPros, $dotsUnits, [ 
				'dot_ctlr_margin' => 'spacing'
		] );
		// Active style options
		$css .= $cssHelper->generateStyle ( '.jp-slider.dot-controller-line .jp-dots ul li.active span', $settings, [ 
		...
		$css .= $cssHelper->generateStyle ( '.jp-slider.dot-controller-line .jp-dots ul li.active', $settings, [ 
				'dot_ctlr_border_radius' => 'border-radius',
				'dot_ctlr_hover_width' => 'width',
				'dot_ctlr_hover_border_color' => 'border-color'
		], [ 
				'dot_ctlr_hover_border_color' => false
		] );
		...
		if ($dot_controllers_style !== 'line') {
			...
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-dots ul li span, .jp-slider .jp-dots ul li:hover span, .jp-slider .jp-dots ul li:hover:after, .jp-slider .jp-dots ul li:after', $settings, $dosSpanProps, [ 
					'dot_controllers_style' => ($dot_controllers_style !== 'with_image') ? false : null
			] );

			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-dots ul li.active', $settings, [ 
					'dot_ctlr_hover_border_color' => 'border-color'
			], false );
		}
		...
		if ($dot_controllers_position === 'bottom_center') {
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-dots', $settings, [ 
					'dot_controllers_bottom_gap' => 'bottom'
			] );
		}
		...
		if ($dot_controllers_position === 'bottom_left') {
			...
			$css .= $cssHelper->generateStyle ( '.dot-controller-position-bottom_left.jp-slider .jp-dots', $settings, [ 
					'dot_controllers_left_gap' => 'left'
			] );
		}
		...
		if ($dot_controllers_position === 'bottom_right') {
			...
			$css .= $cssHelper->generateStyle ( '.dot-controller-position-bottom_right.jp-slider .jp-dots', $settings, [ 
					'dot_controllers_right_gap' => 'right'
			] );
		}

		if ($dot_controllers_position === 'vertical_left') {
			$css .= $cssHelper->generateStyle ( '.dot-controller-position-vertical_left.jp-slider .jp-dots', $settings, [ 
					'dot_controllers_left_gap' => 'left'
			] );
		}

		if ($dot_controllers_position === 'vertical_right') {
			$css .= $cssHelper->generateStyle ( '.dot-controller-position-vertical_right.jp-slider .jp-dots', $settings, [ 
					'dot_controllers_right_gap' => 'right'
			] );
		}

		// Text thumbnail style
		$css .= $cssHelper->generateStyle ( '.jp-slider-custom-dot-indecators', $settings, [ 
				'text_thumb_ctlr_wrap_bg' => 'background',
				'text_thumb_ctlr_wrap_padding' => 'padding',
				'text_thumb_ctlr_wrap_width' => 'width'
		], [ 
				'text_thumb_ctlr_wrap_bg' => false,
		...
		$css .= $cssHelper->generateStyle ( '.jp-slider-custom-dot-indecators ul li', $settings, [ 
				'text_thumb_ctlr_individual_width' => 'width'
		] );

		// thumb number style
		$css .= $cssHelper->generateStyle ( '.jp-slider-text-thumb-number', $settings, [ 
				'text_thumb_number_color' => 'color',
		...
		// thumb title style
		$css .= $cssHelper->generateStyle ( '.jp-slider-dot-indecator-text.jp-dot-text-key-1', $settings, [ 
				'text_thumb_title_color' => 'color',
		...
		$css .= $cssHelper->generateStyle ( '.jp-slider-dot-indecator-text.jp-dot-text-key-2', $settings, [ 
				'text_thumb_subtitle_color' => 'color',
		...
		if ($arrow_controllers_style !== 'spread') {
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-nav-control', $settings, [ 
		...
		$css .= $cssHelper->generateStyle ( '.jp-slider .jp-nav-control .nav-control', $settings, $controlProps, $controlPropsUnits );
		$transformCss = $cssHelper->generateTransformStyle ( '.jpb-addon-jp-slider', $settings, 'transform' );
		...
		if (! empty ( $settings->arrow_ctlr_width_original )) {
			if (\is_object ( $settings->arrow_ctlr_width_original )) {
				$settings->dummy_arrow_ctlr_width = JpagebuilderAddonHelper::initDeviceObject ();
		...
		$css .= $cssHelper->generateStyle ( 'div[class*="arrow-position-bottom"].jp-slider .jp-nav-control', $settings, [ 
				'dummy_arrow_ctlr_width' => 'width'
		] );

		if ($arrow_controllers_style === 'spread') {
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-nav-control', $settings, [ 
					'arrow_ctlr_height' => 'top: -%s'
			] );
		}
		...
		if (! empty ( $settings->arrow_ctlr_height_original )) {
			if (\is_object ( $settings->arrow_ctlr_height_original )) {
				$settings->dummy_arrow_ctlr_height = JpagebuilderAddonHelper::initDeviceObject ();
		...
		$css .= $cssHelper->generateStyle ( '.jp-slider .jp-nav-control .nav-control', $settings, [ 
				'dummy_arrow_ctlr_height' => 'line-height'
		] );
		$css .= $cssHelper->generateStyle ( '.jp-slider .jp-nav-control .nav-control i', $settings, [ 
				'dummy_arrow_ctlr_height' => 'line-height'
		] );

		// Arrow gap
		if ($arrow_controllers_position === 'bottom_center') {
			$css .= $cssHelper->generateStyle ( '.jp-slider.arrow-position-bottom_center .jp-nav-control', $settings, [ 
					'arrow_controllers_bottom_gap' => 'bottom',
					'arrow_controllers_left_gap' => 'left',
					'arrow_controllers_right_gap' => 'right'
			] );
		}

		if ($arrow_controllers_position === 'bottom_left') {
			$css .= $cssHelper->generateStyle ( '.jp-slider.arrow-position-bottom_left .jp-nav-control', $settings, [ 
					'arrow_controllers_bottom_gap' => 'bottom',
					'arrow_controllers_left_gap' => 'left'
			] );
		}
		...
		if ($arrow_controllers_position === 'bottom_right') {
			$css .= $cssHelper->generateStyle ( '.jp-slider.arrow-position-bottom_right .jp-nav-control', $settings, [ 
					'arrow_controllers_bottom_gap' => 'bottom',
					'arrow_controllers_right_gap' => 'right'
			] );
		}
		// Spread arrow gap
		if ($arrow_controllers_style === 'spread') {
			$css .= $cssHelper->generateStyle ( 'div.jp-slider .jp-nav-control', $settings, [ 
		...
		// Arrow hover
		$css .= $cssHelper->generateStyle ( '.jp-slider .jp-nav-control .nav-control:hover', $settings, [ 
				'arrow_ctlr_hover_background' => 'background',
				'arrow_ctlr_hover_border_color' => 'border-color',
				'arrow_ctlr_hover_color' => 'color'
		], false );
		// Slide Counter Style
		...
		if ($slide_counter) {
			...
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-slider_number', $settings, $sliderNumberProps, $sliderNumberUnits, [ 
					'slide_counter_padding' => 'spacing'
			] );
		}

		// Background slideshow
		$background_center = (isset ( $settings->background_center ) && $settings->background_center != '') ? $settings->background_center : 1;
		if ($background_center == 0) {
			$settings->background_center = 'center top';
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-item .jp-background', $settings, [
		...
		if (isset ( $settings->slideshow_items ) && is_array ( $settings->slideshow_items )) {
			...
			foreach ( $settings->slideshow_items as $item_key => $item_value ) {
				...
				$css .= $cssHelper->generateStyle ( ".jp-slider-content-align-{$content_alignment}", $item_value, [ 
						'slideshow_item_margin' => 'margin',
				...
				$slider_img = (isset ( $item_value->slider_img ) && $item_value->slider_img) ? $item_value->slider_img : '';
				$slider_img_src = isset ( $slider_img->src ) ? $slider_img->src : $slider_img;
				$css .= $addon_id . ' .dot-controller-with_image.jp-slider .jp-dots ul li.jp-dot-' . $item_key . ' {';
				...
				if (isset ( $item_value->video_volume_btn ) && $item_value->video_volume_btn) {
					$css .= $addon_id . ' ' . $uniqid . '.jp-item .jp-video-control {';
					$css .= 'display:block;';
					$css .= '}';
				} else {
					$css .= $addon_id . ' ' . $uniqid . '.jp-item .jp-video-control {';
				...
				if (isset ( $item_value->slider_overlay_options ) && $item_value->slider_overlay_options == 'color_overlay') {
					if (isset ( $item_value->slider_bg_overlay ) && $item_value->slider_bg_overlay) {
						$css .= $cssHelper->generateStyle ( $uniqid . '.jp-item .jp-background:after,' . $uniqid . '.jp-item .jp-video-background-mask', $item_value, [ 
								'slider_bg_overlay' => 'background'
						], false );
					}
				}
				...
				if (isset ( $item_value->slideshow_inner_items ) && is_array ( $item_value->slideshow_inner_items )) {
					foreach ( $item_value->slideshow_inner_items as $inner_item_key => $inner_value ) {
						...
						$css .= $cssHelper->generateStyle ( ".jp-slider {$uniqid} {$inner_uniqid}", $inner_value, $contentStyleProps, [ 
								'btn_box_shadow' => false,
								'content_color' => false,
								"content_text_shadow" => false,
								'content_margin' => false
						] );

						$contentStyleProps = array_merge ( $contentStyleProps, [ 
								"content_padding" => "padding",
								"content_border" => "border-style: solid;border-width",
						...
						if ($content_type !== 'btn_content') {
							...
							$css .= $cssHelper->typography ( ".jp-slider {$uniqid} {$inner_uniqid}", $inner_value, 'content_typography', $contentTypographyFallbacks );
						}

						// Image content style
						$css .= $cssHelper->generateStyle ( '.jp-slider ' . $uniqid . ' ' . $inner_uniqid . ' img', $inner_value, [ 
						...
						$css .= $cssHelper->generateStyle ( ".jp-slider {$uniqid} {$inner_uniqid}.jpb-jp-slider-button", $inner_value, [ 
								"content_margin" => "margin"
						], false, [ 
						...
						$css .= $cssHelper->generateStyle ( ".jp-slider {$uniqid} {$inner_uniqid}.jpb-jp-slider-button .jp-slider-btn-text", $inner_value, array_merge ( $buttonNormalProps, [ 
								"content_margin" => "margin",
								"content_color" => "color"
						], [ 
								"content_padding" => "padding",
						...
						$css .= $cssHelper->typography ( ".jp-slider {$uniqid} {$inner_uniqid}.jpb-jp-slider-button .jp-slider-btn-text", $inner_value, 'content_typography', $contentTypographyFallbacks );

						// Button Icon style
						$css .= $cssHelper->generateStyle ( ".jp-slider {$uniqid} {$inner_uniqid}.jpb-jp-slider-button .jp-slider-btn-icon", $inner_value, [ 
								"button_icon_margin" => "margin"
						], false, [ 
								"button_icon_margin" => "spacing"
						] );

						// Button hover style
						$css .= $cssHelper->generateStyle ( ".jp-slider {$uniqid} {$inner_uniqid}.jpb-jp-slider-button .jp-slider-btn-text:hover, .jp-slider {$uniqid} {$inner_uniqid}.jpb-jp-slider-button .jp-slider-btn-text:focus", $inner_value, array_merge ( $buttonHoverProps, [ 
								"button_hover_color" => "color",
								"button_hover_border_color" => "border-color"
						] ), false );
					}
				}
			}
		...
		if ($content_container_option !== 'bootstrap') {
			$css .= $cssHelper->generateStyle ( '.jp-slider .jp-slider-content-wrap', $settings, [ 
					'content_container_width' => 'margin: 0 auto;width'
			], [ 
	...
	public static function getFrontendEditor() {
		...
		<style type="text/css">
			<# _.each (data.slideshow_items, function(item_value, item_key) { 
				...
				if(slider_img.src){
			#>
					#jpb-addon-{{ data.id }} #jp-slider-item-{{ data.id }}-num-{{ item_key }}-key .jp-background {
		...
		$output .= $lodash->unit ( 'background', '.jp-dot-indicator-wrap .dot-indicator,.jp-indicator.line-indicator', 'data.timer_color' );
		$output .= $lodash->unit ( 'background', '.jp-dot-indicator-wrap', 'data.timer_bg_color' );
		$output .= $lodash->unit ( 'background', '.jp-indicator-container', 'data.timer_bg_color' );
		$output .= $lodash->unit ( 'width', '.jp-indicator-container', 'data.timer_width', '%' );
		$output .= $lodash->unit ( 'top', '.jp-indicator-container', 'data.timer_top_gap', 'px' );
		$output .= $lodash->unit ( 'left', '.jp-indicator-container', 'data.timer_left_gap', 'px' );

		$output .= ' <# if (data.dot_controllers_position == "vertical_left" || data.dot_controllers_position == "vertical_right") { #> ';
		$output .= $lodash->unit ( 'max-width', '.jp-slider .jp-dots', 'data.dot_ctlr_width', 'px', true, '', 'height:100%;' );
		$output .= $lodash->unit ( 'width', '.jp-slider .jp-dots ul', 'data.dot_ctlr_width' );
		$output .= '<# } #>';

		// Dots style
		$output .= $lodash->color ( 'background-color', '.jp-slider .jp-dots ul li', 'data.dot_ctlr_bg' );
		$output .= $lodash->border ( 'border-color', '.jp-slider .jp-dots ul li', 'data.dot_ctlr_border_color' );
		$output .= '<# if (!_.isEmpty(data.dot_ctlr_border_width)) { #>';
		$output .= $lodash->unit ( 'border-width', '.jp-slider .jp-dots ul li', 'data.dot_ctlr_border_width', 'px', false, '', 'border-style:solid;' );
		$output .= '<# } #>';
		$output .= $lodash->unit ( 'border-radius', '.jp-slider .jp-dots ul li', 'data.dot_ctlr_border_radius', 'px', false );
		$output .= $lodash->unit ( 'height', '.jp-slider .jp-dots ul li', 'data.dot_ctlr_height', 'px', false );
		$output .= $lodash->unit ( 'width', '.jp-slider .jp-dots ul li', 'data.dot_ctlr_width', 'px', false );
		$output .= $lodash->spacing ( 'margin', '.jp-slider .jp-dots ul li', 'data.dot_ctlr_margin' );

		// Dots Active Style
		$output .= $lodash->unit ( 'height', '.jp-slider.dot-controller-line .jp-dots ul li.active span', 'data.dot_ctlr_hover_height', 'px', false );
		$output .= $lodash->unit ( 'border-radius', '.jp-slider.dot-controller-line .jp-dots ul li.active span', 'data.dot_ctlr_border_radius', 'px', false );
		$output .= $lodash->color ( 'background-color', '.jp-slider.dot-controller-line .jp-dots ul li.active span', 'data.dot_ctlr_center_bg' );

		$output .= $lodash->unit ( 'width', '.jp-slider.dot-controller-line .jp-dots ul li.active', 'data.dot_ctlr_hover_width', 'px', false );
		$output .= $lodash->unit ( 'border-radius', '.jp-slider.dot-controller-line .jp-dots ul li.active', 'data.dot_ctlr_border_radius', 'px', false );
		$output .= $lodash->border ( 'border-color', '.jp-slider.dot-controller-line .jp-dots ul li.active', 'data.dot_ctlr_hover_border_color' );

		$output .= '<# if (data.dot_controllers_style !== "line") { #>';
		$output .= '<# if (data.dot_controllers_style !== "with_image") { #>';
		$output .= $lodash->color ( 'background-color', '.jp-slider .jp-dots ul li span,.jp-slider .jp-dots ul li:hover span,.jp-slider .jp-dots ul li:hover:after,.jp-slider .jp-dots ul li:after', 'data.dot_ctlr_center_bg' );
		$output .= '<# } #>';
		$output .= $lodash->unit ( 'height', '.jp-slider .jp-dots ul li span,.jp-slider .jp-dots ul li:hover span,.jp-slider .jp-dots ul li:hover:after,.jp-slider .jp-dots ul li:after', 'data.dot_ctlr_hover_height', 'px', false );
		$output .= $lodash->unit ( 'width', '.jp-slider .jp-dots ul li span,.jp-slider .jp-dots ul li:hover span,.jp-slider .jp-dots ul li:hover:after,.jp-slider .jp-dots ul li:after', 'data.dot_ctlr_hover_width', 'px', false );
		$output .= $lodash->unit ( 'border-radius', '.jp-slider .jp-dots ul li span,.jp-slider .jp-dots ul li:hover span,.jp-slider .jp-dots ul li:hover:after,.jp-slider .jp-dots ul li:after', 'data.dot_ctlr_border_radius', 'px', false );
		$output .= $lodash->border ( 'border-color', '.jp-slider .jp-dots ul li.active', 'data.dot_ctlr_hover_border_color' );
		$output .= '<# } #>';

		$output .= '<# if (data.dot_controllers_position === "bottom_center") { #>';
		$output .= $lodash->unit ( 'bottom', '.jp-slider .jp-dots', 'data.dot_controllers_bottom_gap', 'px' );
		$output .= '<# } #>';

		$output .= '<# if (data.dot_controllers_position === "bottom_left") { #>';
		$output .= $lodash->unit ( 'bottom', '.jp-slider .jp-dots', 'data.dot_controllers_bottom_gap', 'px' );
		$output .= $lodash->unit ( 'left', '.jp-slider .jp-dots', 'data.dot_controllers_left_gap', 'px' );
		$output .= '<# } #>';

		$output .= '<# if (data.dot_controllers_position === "bottom_right") { #>';
		$output .= $lodash->unit ( 'bottom', '.jp-slider .jp-dots', 'data.dot_controllers_bottom_gap', 'px' );
		$output .= $lodash->unit ( 'left', '.jp-slider .jp-dots', 'data.dot_controllers_right_gap', 'px' );
		$output .= '<# } #>';

		$output .= '<# if (data.dot_controllers_position === "vertical_left") { #>';
		$output .= $lodash->unit ( 'left', '.dot-controller-position-vertical_left.jp-slider .jp-dots', 'data.dot_controllers_left_gap', 'px' );
		$output .= '<# } #>';

		$output .= '<# if (data.dot_controllers_position === "vertical_right") { #>';
		$output .= $lodash->unit ( 'right', '.dot-controller-position-vertical_right.jp-slider .jp-dots', 'data.dot_controllers_right_gap', 'px' );
		$output .= '<# } #>';

		$output .= '<# if (data.dot_controllers_position === "spread") { #>';
		$output .= $lodash->unit ( 'height', '.jp-slider .jp-nav-control', 'data.arrow_ctlr_height', 'px' );
		$output .= '<# } #>';

		$output .= '<# _.isEmpty(data.arrow_ctlr_border_width) ? data.arrow_ctlr_border_width  = 1 : data.arrow_ctlr_border_width; #>';

		$output .= $lodash->color ( 'background', '.jp-slider .jp-nav-control .nav-control', 'data.arrow_ctlr_background' );
		$output .= $lodash->color ( 'color', '.jp-slider .jp-nav-control .nav-control', 'data.arrow_ctlr_color' );
		$output .= $lodash->border ( 'border-color', '.jp-slider .jp-nav-control .nav-control', 'data.arrow_ctlr_border_color' );
		$output .= $lodash->unit ( 'border-radius', '.jp-slider .jp-nav-control .nav-control', 'data.arrow_ctlr_border_radius', 'px', false );
		$output .= $lodash->unit ( 'border-width', '.jp-slider .jp-nav-control .nav-control', 'data.arrow_ctlr_border_width', 'px', false );
		$output .= $lodash->unit ( 'width', '.jp-slider .jp-nav-control .nav-control', 'data.arrow_ctlr_width', 'px' );
		$output .= $lodash->unit ( 'height', '.jp-slider .jp-nav-control, .jp-slider .jp-nav-control .nav-control', 'data.arrow_ctlr_height', 'px' );
		$output .= $lodash->unit ( 'font-size', '.jp-slider .jp-nav-control .nav-control', 'data.arrow_ctlr_font_size', 'px' );
		$output .= '<# 
		...
		$output .= $lodash->unit ( 'width', 'div[class*="arrow-position-bottom"].jp-slider .jp-nav-control', 'data.arrow_ctlr_width.xl', 'px' );
		$output .= '<# if (data.arrow_controllers_style == "spread") { #>';
		$output .= $lodash->unit ( 'top', '.jp-slider .jp-nav-control', 'data.arrow_ctlr_height', 'px', true, '-' );
		$output .= '<# } #>';
		...
		$output .= $lodash->unit ( 'line-height', '.jp-slider .jp-nav-control .nav-control', 'dummy_arrow_ctlr', 'px' );
		$output .= $lodash->unit ( 'line-height', '.jp-slider .jp-nav-control .nav-control i', 'dummy_arrow_ctlr', 'px' );

		$output .= '<# if (data.arrow_controllers_position=="bottom_center") { #>';
		$output .= $lodash->unit ( 'bottom', '.jp-slider.arrow-position-bottom_center .jp-nav-control', 'data.arrow_controllers_bottom_gap', 'px' );
		$output .= '<# } #>';

		$output .= '<# if (data.arrow_controllers_position=="bottom_left") { #>';
		$output .= $lodash->unit ( 'bottom', '.jp-slider.arrow-position-bottom_left .jp-nav-control', 'data.arrow_controllers_bottom_gap', 'px' );
		$output .= $lodash->unit ( 'left', '.jp-slider.arrow-position-bottom_left .jp-nav-control', 'data.arrow_controllers_left_gap', 'px' );
		$output .= '<# } #>';

		$output .= '<# if (data.arrow_controllers_position=="bottom_right") { #>';
		$output .= $lodash->unit ( 'bottom', '.jp-slider.arrow-position-bottom_right .jp-nav-control', 'data.arrow_controllers_bottom_gap', 'px' );
		$output .= $lodash->unit ( 'right', '.jp-slider.arrow-position-bottom_right .jp-nav-control', 'data.arrow_controllers_right_gap', 'px' );
		$output .= '<# } #>';

		$output .= '<# if (data.arrow_controllers_style==="spread") { #>';
		$output .= $lodash->unit ( 'left', 'div.jp-slider .jp-nav-control', 'data.arrow_spread_controllers_left_gap', 'px' );
		$output .= $lodash->unit ( 'right', 'div.jp-slider .jp-nav-control', 'data.arrow_spread_controllers_right_gap', 'px' );
		$output .= '<# } #>';

		$output .= $lodash->color ( 'background', '.jp-slider .jp-nav-control .nav-control:hover', 'data.arrow_ctlr_hover_background' );
		$output .= $lodash->color ( 'color', '.jp-slider .jp-nav-control .nav-control:hover', 'data.arrow_ctlr_hover_color' );
		$output .= $lodash->border ( 'border-color', '.jp-slider .jp-nav-control .nav-control:hover', 'data.arrow_ctlr_hover_border_color' );

		$output .= $lodash->color ( 'color', '.jp-slider .jp-slider_number', 'data.slide_counter_color' );
		$output .= $lodash->color ( 'background', '.jp-slider .jp-slider_number', 'data.slide_counter_bg_color' );
		$output .= $lodash->unit ( 'font-size', '.jp-slider .jp-slider_number', 'data.slide_counter_fontsize', 'px' );
		$output .= $lodash->unit ( 'font-family', '.jp-slider .jp-slider_number', 'data.slide_counter_fontfamily', '', false );
		$output .= $lodash->unit ( 'bottom', '.jp-slider .jp-slider_number', 'data.slide_counter_gap_bottom', 'px' );
		$output .= $lodash->unit ( 'left', '.jp-slider .jp-slider_number', 'data.slide_counter_gap_left', 'px' );
		$output .= $lodash->spacing ( 'padding', '.jp-slider .jp-slider_number', 'data.slide_counter_padding' );

		$output .= ' <# if (!_.isEmpty(data.slideshow_items) && data.slideshow_items) {
			_.each (data.slideshow_items, function(item_value, item_key) {
			let uniqid = `#jp-slider-item-${data.id}-num-${item_key}-key`; 
			let content_alignment = (!_.isEmpty(item_value.content_alignment) && item_value.content_alignment) ? item_value.content_alignment : "";
		#>';

		$output .= '
				#jpb-addon-{{ data.id }} .dot-controller-with_image.jp-slider .jp-dots ul li.jp-dot-{{item_key}}{
					<#
					var slider_img = {}
					if (typeof item_value.slider_img !== "undefined" && typeof item_value.slider_img.src !== "undefined") {
						slider_img = item_value.slider_img
		...
		$output .= $lodash->spacing ( 'margin', '.jp-slider-content-align-{{content_alignment}}', 'item_value.slideshow_item_margin' );
		$output .= $lodash->spacing ( 'padding', '.jp-slider-content-align-{{content_alignment}}', 'item_value.slideshow_item_padding' );
		$output .= '<# if (item_value.slider_overlay_options !== "undefined" && item_value.slider_overlay_options === "color_overlay"){ #>';
		$output .= $lodash->color ( 'background', '{{uniqid}}.jp-item .jp-background:after, {{uniqid}}.jp-item .jp-video-background-mask', 'item_value.slider_bg_overlay' );
		$output .= '<# } else if(item_value.slider_overlay_options !== "undefined" && item_value.slider_overlay_options === "gradient_overlay") { #>';
		$output .= $lodash->color ( 'background-color', '{{uniqid}}.jp-item .jp-background:after,{{uniqid}}.jp-item .jp-video-background-mask', 'item_value.slider_bg_gradient_overlay' );
		$output .= '<# } #>';
		$output .= '	
				<# if(item_value.video_volume_btn !== "undefined" && item_value.video_volume_btn){ #>
					#jpb-addon-{{ data.id }} {{uniqid}}.jp-item .jp-video-control {
						display:block;
					}
				<# } else { #>
					#jpb-addon-{{ data.id }} {{uniqid}}.jp-item .jp-video-control {
				...
				<# if (!_.isEmpty(item_value.slideshow_inner_items)) {
					_.each (item_value.slideshow_inner_items, function(inner_value, inner_item_key) {
						let inner_uniqid = `#jp-slider-inner-item-${data.id}-num-${inner_item_key}-key`;
				#>';
		$output .= '<# if (inner_value.content_type !== "image_content") { #>';
		$output .= $lodash->color ( 'color', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_color' );
		// $output .= $lodash->unit('font-size', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_fontsize', 'px');
		// $output .= $lodash->unit('line-height', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_lineheight', 'px');
		$output .= $lodash->textShadow ( '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_text_shadow' );
		$output .= $lodash->typography ( '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_typography', [ 
		...
		// $output .= $lodash->unit('letter-spacing', '.jp-slider {{uniqid}} {{inner_uniqid}}', ('inner_value.content_letterspacing' !== "custom") ? 'inner_value.content_letterspacing' : 'inner_value.custom_letterspacing');
		$output .= '<# } #>';

		$output .= '<# if (inner_value.content_type !== "btn_content") { #>';
		$output .= $lodash->color ( 'background', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_background' );
		$output .= $lodash->spacing ( 'margin', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_margin' );
		$output .= $lodash->spacing ( 'padding', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_padding' );
		$output .= '<# if (!_.isEmpty(inner_value.content_border) && _.trim(inner_value.content_border)) { #>';
		$output .= '<# inner_value.border_style = "solid"#>';
		$output .= $lodash->border ( 'border-style', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.border_style' );
		$output .= '<# } #>';
		$output .= $lodash->border ( 'border-width', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_border' );
		$output .= $lodash->border ( 'border-color', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_border_color' );
		$output .= $lodash->unit ( 'border-radius', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_border_radius', 'px', false );
		$output .= '<# } #>';
		$output .= '<# if (inner_value.content_type == "btn_content" || inner_value.content_type == "image_content") { #>';
		$output .= $lodash->boxShadow ( '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.btn_box_shadow' );
		$output .= '<# } #>';

		$output .= '<# if (!["icon_content", "btn_content"].includes(inner_value.content_type)) { #>';
		$output .= $lodash->unit ( 'font-family', '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_font_family' );
		$output .= $lodash->typography ( '.jp-slider {{uniqid}} {{inner_uniqid}}', 'inner_value.content_typography', [ 
				'font' => 'inner_value.content_font_family',
				'size' => 'inner_value.content_fontsize',
				'line_height' => 'inner_value.content_lineheight',
		...
		$output .= $lodash->typography ( '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.content_typography', [ 
				'font' => 'inner_value.content_font_family',
				'size' => 'inner_value.content_fontsize',
				'line_height' => 'inner_value.content_lineheight',
				'letter_spacing' => 'inner_value.content_letterspacing',
		...
		$output .= '<#
						...
						.jp-slider {{uniqid}} {{inner_uniqid}} .jp-slider-caption-image {
							{{image_content_style}}
						} #>';
		...
		$output .= $lodash->unit ( 'min-height', '.jp-slider {{uniqid}} {{inner_uniqid}} .jp-slider-caption-image', 'inner_value.inner_content_min_height', 'px' );
		$output .= $lodash->unit ( 'height', '.jp-slider {{uniqid}} {{inner_uniqid}} .jp-slider-caption-image', 'inner_value.image_content_height', 'px' );
		$output .= $lodash->unit ( 'width', '.jp-slider {{uniqid}} {{inner_uniqid}} .jp-slider-caption-image', 'inner_value.image_content_width', 'px' );

		$output .= '<# if (inner_value.button_background_options === "color_bg") { #>';
		$output .= $lodash->color ( 'background', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.button_background_color' );
		$output .= $lodash->color ( 'color', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.content_color' );

		$output .= '<# } else { #>';
		$output .= $lodash->color ( 'background', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.button_background_gradient' );
		$output .= $lodash->color ( 'background', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.button_background_gradient_hover' );
		$output .= '<# } #>';

		// Border Style
		$output .= '<# if (!_.isEmpty(inner_value.content_border) && _.trim(inner_value.content_border)) { #>';
		$output .= '<# inner_value.border_style = "solid"#>';
		$output .= $lodash->border ( 'border-style', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.border_style' );
		$output .= $lodash->border ( 'border-width', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.content_border' );
		$output .= '<# } #>';
		$output .= $lodash->border ( 'border-color', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.content_border_color' );
		$output .= $lodash->unit ( 'border-radius', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.content_border_radius', 'px' );
		$output .= $lodash->color ( 'background', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text:hover', 'inner_value.button_background_color_hover' );
		$output .= $lodash->color ( 'color', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text:hover, .jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text:focus', 'inner_value.button_hover_color' );
		$output .= $lodash->border ( 'border-color', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text:hover, .jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text:focus', 'inner_value.button_hover_border_color' );
		$output .= $lodash->spacing ( 'margin', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button', 'inner_value.content_margin' );
		$output .= $lodash->spacing ( 'padding', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-text', 'inner_value.content_padding' );
		$output .= $lodash->spacing ( 'margin', '.jp-slider {{uniqid}} {{inner_uniqid}}.jpb-jp-slider-button .jp-slider-btn-icon', 'inner_value.button_icon_margin' );
		...
		$output .= $lodash->spacing ( 'padding', '.jp-slider-custom-dot-indecators', 'data.text_thumb_ctlr_wrap_padding' );
		$output .= $lodash->color ( 'background', '.jp-slider-custom-dot-indecators', 'data.text_thumb_ctlr_wrap_bg' );
		$output .= $lodash->unit ( 'width', '.jp-slider-custom-dot-indecators', 'data.text_thumb_ctlr_wrap_width', '%' );

		$output .= $lodash->unit ( 'width', '.jp-slider-custom-dot-indecators ul li', 'data.text_thumb_ctlr_individual_width', 'px' );

		$output .= $lodash->color ( 'color', '.jp-slider-text-thumb-number', 'data.text_thumb_number_color' );
		$output .= $lodash->unit ( 'font-weight', '.jp-slider-text-thumb-number', 'data.text_thumb_number_font_weight', '', false );
		$output .= $lodash->unit ( 'font-size', '.jp-slider-text-thumb-number', 'data.text_thumb_number_font_size', 'px' );

		$output .= $lodash->color ( 'color', '.jp-slider-dot-indecator-text.jp-dot-text-key-1', 'data.text_thumb_title_color' );
		$output .= $lodash->unit ( 'font-weight', '.jp-slider-dot-indecator-text.jp-dot-text-key-1', 'data.text_thumb_title_font_weight', '', false );
		$output .= $lodash->unit ( 'font-size', '.jp-slider-dot-indecator-text.jp-dot-text-key-1', 'data.text_thumb_title_font_size', 'px' );
		$output .= $lodash->unit ( 'line-height', '.jp-slider-dot-indecator-text.jp-dot-text-key-1', 'data.text_thumb_title_lineheight', 'px' );

		$output .= $lodash->color ( 'color', '.jp-slider-dot-indecator-text.jp-dot-text-key-2', 'data.text_thumb_subtitle_color' );
		$output .= $lodash->unit ( 'font-weight', '.jp-slider-dot-indecator-text.jp-dot-text-key-2', 'data.text_thumb_subtitle_font_weight', '', false );
		$output .= $lodash->unit ( 'font-size', '.jp-slider-dot-indecator-text.jp-dot-text-key-2', 'data.text_thumb_subtitle_font_size', 'px' );

		$output .= $lodash->unit ( 'width', '.jp-slider .jp-slider-content-wrap', 'data.content_container_width', '%', true, '', 'margin: 0 auto;' );
		$output .= $lodash->generateTransformCss ( '.jpb-addon-jp-slider', 'data.transform' );
		$output .= '
		</style>
			...
			#>
					...
					<div id="{{uniqid}}" class="jp-item {{activeClass}} {{content_vertical_alignment}}">
					<# if(data.content_container_option==="bootstrap"){ #>
						<div class="jpb-container">
						<div class="jpb-row">
						<div class="jpb-col-sm-12">
					<# } else { #>
						<div class="jp-slider-content-wrap">
					<# }
						...
						var icon_display_block = (typeof item_value.icon_display_block!=="undefined" && item_value.icon_display_block) ? "jp-slider-icon-block" : "";
						...
						var image_content_alignment = (!_.isEmpty(item_value.image_content_alignment) && item_value.image_content_alignment) ? item_value.image_content_alignment : "";
							...
							if(!image_in_column){
					#>
								<div class="jp-slider-content-align-{{content_alignment}}">
								<#
								_.each(item_value.slideshow_inner_items, function(inner_value, inner_item_key){
									...
									if (inner_value.button_icon_position == "left") {
										if(inner_value.button_icon) {
											btn_content = \'<span class="jp-slider-btn-text"> <span class="jp-slider-btn-icon"> <i class="\' + btn_icon_name + \'"></i></span> \' + inner_value?.btn_content + \'</span>\';
										} else {
											btn_content = \'<span class="jp-slider-btn-text">\' + inner_value?.btn_content + \'</span>\';
										} 
									} else {
										if(inner_value.button_icon){
											btn_content = \'<span class="jp-slider-btn-text">\' + inner_value?.btn_content + \' <span class="jp-slider-btn-icon"><i class="\' + btn_icon_name + \'"></i></span></span>\';
										} else {
											btn_content = \'<span class="jp-slider-btn-text">\'+ inner_value?.btn_content + \'</span>\';
										}
									}
								...
								#>
										<div id="{{inner_uniqid}}" class="jpb-jp-slider-text jp-editable-content {{content_class}}" data-id={{data.id}} data-fieldName="{{last_field_key}}-{{last_field_inner_key}}-content_text" data-layer="true" data-animation={{animationJson}}>
											{{{inner_value.content_text}}}
										</div>
									<# } else if(inner_value.content_type == "image_content"){ #>
										<div id="{{inner_uniqid}}" class="jpb-jp-slider-image {{content_class}}" data-layer="true" data-animation={{animationJson}}>
											<div class="jp-slider-caption-image"></div>
										</div>
									<# } else if(inner_value.content_type == "btn_content"){ #>
										...
										<a id="{{inner_uniqid}}" target="{{ target }}" rel="{{ rel }}" class="jpb-jp-slider-button {{content_class}}" href="{{newUrl}}" data-layer="true" data-animation={{animationJson}}>
										{{{btn_content}}}
										</a>
									...
									#>
										<span id="{{inner_uniqid}}" class="jpb-jp-slider-icon {{content_class}} {{icon_display_block}}" data-layer="true" data-animation={{animationJson}}>
									...
									#>
										<{{inner_value.title_heading_selector}} id="{{inner_uniqid}}" class="jpb-jp-slider-title jp-inline-editable-element {{content_class}}" data-id={{data.id}} data-fieldName="title_content_title" data-itemPosition={{inner_item_key}} data-slideNumber={{last_field_key}} contenteditable="true" data-layer="true" data-animation={{animationJson}}>
							...
							<# } else { #>
								<div class="jpb-row">
									<# if(!image_column_reverse){ #>
										<div class="jpb-col-xs-{{image_column_width_xs === 12 ? 12 : 12-image_column_width_xs}} jpb-col-sm-{{image_column_width_sm === 12 ? image_column_width_sm : 12-image_column_width_sm}} jpb-col-md-{{image_column_width_md === 12 ? image_column_width_md : 12-image_column_width_md}} jpb-col-lg-{{image_column_width_lg === 12 ? image_column_width_lg : 12-image_column_width_lg}} jpb-col-{{image_column_width === 12 ? image_column_width : 12-image_column_width}}">
											<div class="jp-slider-content-align-{{content_alignment}}">
												<#
												_.each(item_value.slideshow_inner_items, function(inner_value, inner_item_key){
													let last_field_inner_key = `slideshow_inner_items-${inner_item_key}`;
													...
													if(inner_value.content_type == "text_content"){
												#>
														<div id="{{inner_uniqid}}" class="jpb-jp-slider-text jp-editable-content {{content_class}}" data-id={{data.id}} data-fieldName="{{last_field_key}}-{{last_field_inner_key}}-content_text" data-layer="true" data-layer="true" data-animation={{animationJson}}>
															{{{inner_value.content_text}}}
														</div>
													<# } else if(inner_value.content_type == "btn_content"){ #>
														<# 
													...
													#>
														<{{inner_value.title_heading_selector}} id="{{inner_uniqid}}" class="jpb-jp-slider-title jp-inline-editable-element {{content_class}}" data-id={{data.id}} data-fieldName="title_content_title" contenteditable="true" data-itemPosition={{inner_item_key}} data-slideNumber={{last_field_key}} data-layer="true" data-animation={{animationJson}}>
															{{{inner_value.title_content_title}}}
														</{{inner_value.title_heading_selector}}>
													<# }
										...
										<div class="jpb-col-xs-{{image_column_width_xs}} jpb-col-sm-{{image_column_width_sm}} jpb-col-md-{{image_column_width_md}} jpb-col-lg-{{image_column_width_lg}} jpb-col-{{image_column_width}}">
											<div class="jp-slider-image-align-{{image_content_alignment}}">
												<#
												_.each(item_value.slideshow_inner_items, function(inner_value, inner_item_key){
													let last_field_inner_key = `slideshow_inner_items-${inner_item_key}`;
													let inner_uniqid = `jp-slider-inner-item-${data.id}-num-${inner_item_key}-key`;
						...
						#>
									<div class="jp-video-background" data-video_src="{{slider_video.src}}"></div>
								<# } else { #>
									<div class="jp-video-background" data-video_src="{{pagebuilder_base +  slider_video.src }}"></div>
								<# }
								...
								#>
									<div class="jp-video-background" data-video_src="{{item_value.youtube_vimeo_url}}"></div>
								<# } else { #>
									<div class="jp-video-background" data-video_src="{{ pagebuilder_base + item_value.youtube_vimeo_url }}"></div>
								<# }
							}
						} #>
						...
						if(data.dot_controllers_style == "with_text"){
							...
							dots += `<li class="${item_key == 0 ? "active jp-text-thumbnail-list" : "jp-text-thumbnail-list"}">`;
								dots += `<div class="jp-slider-text-thumb-number">${(item_key > 8 ? (item_key + 1) : "0"+(item_key + 1))}</div>`;
								dots += `<div class="jp-dot-indicator-wrap">`;
									dots += `<span class="dot-indicator"></span>`;
								dots += `</div>`;
								dots += `<div class="jp-slider-text-thumb-caption">`;
			...
			<# if(data.dot_controllers_style == "with_text" && data.dot_controllers){ #>
				<div class="jp-slider-custom-dot-indecators">
					<ul>
						{{{dots}}}
					</ul>
				</div>
