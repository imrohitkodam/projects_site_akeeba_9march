...
JpagebuilderConfig::addonConfig ( array (
		'type' => 'repeatable',
		'addon_name' => 'lightgallery',
		'title' => Text::_ ( 'Light Gallery' ),
		'desc' => Text::_ ( 'A customizable, modular, responsive, lightbox gallery addon for JPagebuilder.' ),
		'icon' => Uri::root () . 'components/com_jpagebuilder/addons/lightgallery/assets/images/icon.png',
		'category' => 'Interface',
		'attr' => array (
				'general' => array (
						'admin_label' => array (
						...
						'ui_simple_gallery_item' => array (
								...
								'attr' => array (
										...
										'media_thumb' => array (
												...
												'desc' => Text::_ ( 'Add your thumbnail image for item, if thumbnail image are empty, the main image will be added as thumbnail image. ' ),
												'placeholder' => 'http://www.example.com/my-photo.jpg'
										)
								)
						),
						...
						'gallery_style' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Gallery Style' ),
								'desc' => Text::_ ( 'Present your gallery with different styles.' ),
								'values' => array (
										'' => Text::_ ( 'Default' ),
										'comment' => Text::_ ( 'Facebook Comment Box' ),
										'fixed-size' => Text::_ ( 'Fixed Size' )
								),
								'std' => ''
						),
						'size_width' => array (
								'type' => 'slider',
								'title' => Text::_ ( 'Fixed Width' ),
								'min' => 400,
								'max' => 1200,
								'desc' => Text::_ ( 'Define the fixed width for light gallery' ),
								'std' => 700,
								'depends' => array (
										array (
												'gallery_style',
						...
						'size_height' => array (
								'type' => 'slider',
								'title' => Text::_ ( 'Fixed Height' ),
								'min' => 400,
								'max' => 1200,
								'desc' => Text::_ ( 'Define the fixed height for light gallery' ),
								'std' => 700,
								'depends' => array (
										array (
												'gallery_style',
						...
						'transition_mode' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Transition Mode' ),
								'desc' => Text::_ ( 'Lightgallery comes with a numerous number of beautiful built in animations. You can change the type of transitions image below' ),
								'values' => array (
										'lg-fade' => Text::_ ( 'Fade' ),
										'lg-zoom-in' => Text::_ ( 'Zoom In' ),
										'lg-zoom-in-big' => Text::_ ( 'Zoom In Big' ),
										'lg-zoom-out' => Text::_ ( 'Zoom Out' ),
										'lg-zoom-out-big' => Text::_ ( 'Zoom Out Big' ),
										'lg-zoom-out-in' => Text::_ ( 'Zoom Out In' ),
										'lg-zoom-in-out' => Text::_ ( 'Zoom In Out' ),
										'lg-soft-zoom' => Text::_ ( 'Soft Zoom' ),
										'lg-scale-up' => Text::_ ( 'Scale Up' ),
										'lg-slide-circular' => Text::_ ( 'Slide Circular' ),
										'lg-slide-circular-vertical' => Text::_ ( 'Slide Circular Vertical' ),
										'lg-slide-vertical' => Text::_ ( 'Slide Vertical' ),
										'lg-slide-vertical-growth' => Text::_ ( 'Slide Vertical Growth' ),
										'lg-slide-skew-only' => Text::_ ( 'Slide Skew Only' ),
										'lg-slide-skew-only-rev' => Text::_ ( 'Slide Skew Only Rev' ),
										'lg-slide-skew-only-y' => Text::_ ( 'Slide Skew Only Y' ),
										'lg-slide-skew-only-y-rev' => Text::_ ( 'Slide Skew Only Rev' ),
										'lg-slide-skew' => Text::_ ( 'Slide Skew' ),
										'lg-slide-skew-rev' => Text::_ ( 'Slide Skew Rev' ),
										'lg-slide-skew-cross' => Text::_ ( 'Slide Skew Cross' ),
										'lg-slide-skew-cross-rev' => Text::_ ( 'Slide Skew Cross Rev' ),
										'lg-slide-skew-ver' => Text::_ ( 'Slide Skew Ver' ),
										'lg-slide-skew-ver-rev' => Text::_ ( 'Slide Skew Ver Rev' ),
										'lg-slide-skew-ver-cross' => Text::_ ( 'Slide Skew Ver Cross' ),
										'lg-slide-skew-ver-cross-rev' => Text::_ ( 'Slide Skew Ver Cross Rev' ),
										'lg-lollipop' => Text::_ ( 'Lollipop' ),
										'lg-lollipop-rev' => Text::_ ( 'Lollipop Rev' ),
										'lg-rotate' => Text::_ ( 'Rotate' ),
										'lg-rotate-rev' => Text::_ ( 'Rotate Rev' ),
										'lg-tube' => Text::_ ( 'Tube' )
								),
								'std' => 'lg-fade'
						),
						...
						'show_caption' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Show Image Captions' ),
								'desc' => Text::_ ( 'Show title and image content as caption for images when opening light gallery' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'show_thumbnail' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Show Thumbnails' ),
								'desc' => Text::_ ( 'Show or hide thumbnail below gallerry' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'show_toogle_thumbnail' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Show Toogle Thumbnails' ),
								'desc' => Text::_ ( 'Whether to display thumbnail toggle button.' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'show_hash' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Hash Feature' ),
								'desc' => Text::_ ( 'Hash plugin lets you to provide unique url for each gallery images. ' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'show_autoplay_button' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Show Autoplay Icon' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'show_fullscreen_button' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Show Fullscreen Icon' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'overlay_positions' => array (
								...
								'desc' => Text::_ ( 'Select the overlay or content position.' ),
								'values' => array (
										'top' => Text::_ ( 'Top' ),
						...
						'meta_transition' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Transition' ),
								'desc' => Text::_ ( 'Select a transition for the meta when the overlay appears on hover.' ),
								'values' => array (
										'' => Text::_ ( 'None' ),
										'fade' => Text::_ ( 'Fade' ),
										'scale-up' => Text::_ ( 'Scale Up' ),
