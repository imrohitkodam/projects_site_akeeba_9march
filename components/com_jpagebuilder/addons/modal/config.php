...
JpagebuilderConfig::addonConfig([
	'type'       => 'content',
	'addon_name' => 'modal',
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_MODAL'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_DESC'),
	'category'   => 'General',
	...
	'settings' => [
		'modal' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR'),
			'fields' => [
				'button_text' => [
					'type'    => 'text',
				...
				'modal_selector' => [
					'type'   => 'buttons',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_DESC'),
					'values' => [
						['label' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_BUTTON'), 'value' => 'button'],
						['label' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE'), 'value' => 'image'],
						['label' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_TYPE_ICON'), 'value' => 'icon'],
					],
					'std'    => 'button',
					'tabs'    => true,
				],
				...
				'button_icon_position' => [
					...
					'desc'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BUTTON_ICON_POSITION_DESC'),
					'values' => [
				...
				'selector_icon_size' => [
					...
					'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_SIZE_DESC'),
					'std'        => ['xl' => 36],
					'max'        => 400,
					'responsive' => true,
					'depends' 	 => [['modal_selector', '=', 'icon']],
				...
				'selector_text' => [
					'type' => 'text',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT'),
					'desc' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_DESC'),
					'std' => '',
					'depends' => [['modal_selector', '!=' , 'button']],
				...
				'selector_text_size' => [
					'type' => 'slider',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_SIZE'),
					'desc' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_SIZE_DESC'),
					'placeholder' => 36,
					'max' => 300,
					'responsive' => true,
					'depends' => [['modal_selector', '!=' , 'button']],
				...
				'selector_text_weight' => [
					'type'=>'text',
					'title'=>Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_WEIGHT'),
					'desc'=>Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_WEIGHT_DESC'),
					'placeholder'=>700,
					'std'=>'',
					'depends'=>[['modal_selector', '!=' , 'button']],
				],
				...
				'selector_text_color' => [
					'type'=>'color',
					'title'=>Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_COLOR'),
					'desc'=>Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_COLOR_DESC'),
					'std'=>'',
					'depends'=>[['modal_selector', '!=' , 'button']],
				],
				...
				'selector_text_margin' => [
					'type'=>'margin',
					'title'=>Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_MARGIN'),
					'desc'=>Text::_('COM_JPAGEBUILDER_ADDON_MODAL_SELECTOR_ICON_TEXT_MARGIN_DESC'),
					'placeholder'=>10,
					'depends'=>[['modal_selector', '!=' , 'button']],
				],
				...
				'show_ripple_effect' => [
					'type'    => 'checkbox',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_RIPPLE_EFFECT'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_RIPPLE_EFFECT_DESC'),
					'std'     => 0,
					'depends' => [['modal_selector', '=', 'icon']],
				],
		...
		'popup' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_POPUP'),
			'fields' => [
				'modal_content_type' => [
					'type'   => 'radio',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_CONTENT_TYPE'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_CONTENT_TYPE_DESC'),
					'values' => [
						'video' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_CONTENT_TYPE_VIDEO'),
						'image' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_CONTENT_TYPE_IMAGE'),
						'text'  => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_CONTENT_TYPE_TEXT'),
					],
					'std' => 'text',
				],
				...
				'modal_content_text' => [
					'type'    => 'editor',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_TEXT'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_TEXT_DESC'),
				...
				'modal_content_image' => [
					'type'    => 'media',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_IMAGE'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_IMAGE_DESC'),
				...
				'modal_content_video_url' => [
					'type'    => 'text',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_VIDEO'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_VIDEO_DESC'),
				...
				'modal_popup_overflow' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_OVERFLOW'),
					'desc' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_OVERFLOW_DESCRIPTION'),
					'values' => [
						'auto' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_OVERFLOW_AUTO'),
						'hidden' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_OVERFLOW_HIDDEN'),
						'visible' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_OVERFLOW_VISIBLE'),
						'scroll' => Text::_('COM_JPAGEBUILDER_ADDON_MODAL_OVERFLOW_SCROLL'),
					],
					'depends' => [
