...
class JpagebuilderAddonModule extends JpagebuilderAddons {
	public function render() {
		...
		if (count ( ( array ) $modules )) {
			$output = '<div class="jpb-addon jpb-addon-module ' . $class . '">';
			...
			foreach ( $modules as $module ) {
				...
				if ($module_type == 'position') {
					$output .= ModuleHelper::renderModule ( $module, array (
							'style' => 'superBasicMod'
					) );
				} else {
					$output .= ModuleHelper::renderModule ( $module, array (
