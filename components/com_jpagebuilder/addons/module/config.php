...
JpagebuilderConfig::addonConfig(
	[
		'type'       => 'content',
		'addon_name' => 'module',
		'title'      => Text::_('COM_JPAGEBUILDER_ADDON_MODULE'),
		'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_DESC'),
		'category'   => 'General',
		...
		'settings' => [
			'content' => [
				...
				'fields' => [
					'module_type' => [
						'type'   => 'select',
						'title'  => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_TYPE'),
						'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_TYPE_DESC'),
						'values' => [
							'module'   => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_TYPE_MODULE'),
							'position' => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_POSITION')
						],
						'std' => 'module',
					],
					...
					'id' => [
						'type'    => 'module',
						'module'  => 'module',
						'title'   => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_SELECT'),
						'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_SELECT_DESC'),
					...
					'position' => [
						'type'    => 'module',
						'module'  => 'position',
						'title'   => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_POSITION'),
						'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_MODULE_POSITION_DESC'),
