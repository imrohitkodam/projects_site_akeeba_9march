...
JpagebuilderConfig::addonConfig([
	...
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_DESC'),
	'category'   => 'General',
	...
	'settings'     => [
		'map' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_MAP_TITLE'),
			'fields' => [
				'height' => [
					'type'        => 'slider',
					'title'       => Text::_('COM_JPAGEBUILDER_GLOBAL_HEIGHT'),
					'desc'        => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_HEIGHT_DESC'),
					'placeholder' => '400',
					'std'         => ['xl' => 400],
					'max'         => 2000,
					'responsive'  => true,
				...
				'map_style' => [
					...
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_DESC'),
					'values' => [
						'CartoDB.Positron'               => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_LIGHT_ALL'),
						'CartoDB.Positron'             => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_DARK_ALL'),
						'CartoDB.Voyager'                => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_VOYAGER'),
						'Esri.NatGeoWorldMap'            => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_NATGEO'),
						'OpenStreetMap.Mapnik'           => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_MAPNIK'),
						'OpenStreetMap.HOT'              => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_HOT'),
						'Esri.WorldStreetMap'            => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_WORLDSTREET'),
						'Esri.WorldTopoMap'              => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_WORLD_TOPO'),
						'Esri.WorldGrayCanvas'           => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_STYLE_WORLD_GRAY_CANVAS'),
					],
				...
				'multi_location_items' => [
					'type' => 'repeatable',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_MULTI_LOCATION_ITEMS'),
					'attr'  => [
						'title' => [
							'type'  => 'text',
							'title' => Text::_('COM_JPAGEBUILDER_ADDON_LOCATION_ITEM_TITLE'),
							'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_LOCATION_ITEM_TITLE_DESC'),
							'std'   => 'Location Item Title',
						],

						'location_item' => [
							'type'  => 'gmap',
							'title' => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_LOCATION'),
							'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_LOCATION_DESC'),
							'std'   => '40.7970,-73.9491',
						],

						'location_popup_text' => [
							'type'  => 'textarea',
							'title' => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_INFOWINDOW'),
							'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_INFOWINDOW_DESC'),
						...
						'custom_icon' => [
							...
							'hide_alt_text'=> true,
							'format' => 'image',
							'title'  => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ICON'),
							'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ICON_DESC'),
						],
					],
				],
			],
		...
		'options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_MAP_OPTIONS'),
			'fields' => [
				'zoom' => [
					'type'        => 'slider',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ZOOM'),
					'desc'        => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ZOOM_DESC'),
					'std'         => 13,
					'max'         => 50,
				],
				...
				'mousescroll' => [
					'type'  => 'checkbox',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ENABLE_MOUSE_SCROLL'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ENABLE_MOUSE_SCROLL_DESC'),
					'std'   => 0,
				],
				...
				'dragging' => [
					...
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ENABLE_DRAGGING_DESC'),
					'std'   => 0,
				],

				'zoomcontrol' => [
					'type'  => 'checkbox',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ENABLE_ZOOMCONTROL'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ENABLE_ZOOMCONTROL_DESC'),
					'std'   => 0,
				],

				'attribution' => [
					'type'  => 'checkbox',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ENABLE_ATTRIBUTION'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_OPENSTREETMAP_ENABLE_ATTRIBUTION_DESC'),
					'std'   => 1,
				],
			],
		],
