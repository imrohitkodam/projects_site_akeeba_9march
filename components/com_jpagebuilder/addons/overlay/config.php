...
JpagebuilderConfig::addonConfig ( array (
		...
		'desc' => Text::_ ( 'Create an image overlay, which comes in different styles.' ),
		'icon' => Uri::root () . 'components/com_jpagebuilder/addons/overlay/assets/images/icon.png',
		'category' => 'Interface',
		'attr' => array (
				'general' => array (
						'admin_label' => array (
						...
						'label_text' => array (
								'type' => 'text',
								'title' => Text::_ ( 'Label' ),
								'desc' => Text::_ ( 'To position a badge inside Overlay.' ),
								'std' => ''
						),
						'label_styles' => array (
								'type' => 'select',
						...
						'link_text' => array (
								...
								'placeholder' => Text::_ ( 'Read more' ),
								'desc' => Text::_ ( 'Enter the text for the link.' ),
								'std' => 'Read more',
								'depends' => array (
										array (
												'title_link',
						...
						'image_transition' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Transition' ),
								'desc' => Text::_ ( 'Select an image transition. If the hover image is set, the transition takes place between the two images. If None is selected, the hover image fades in.' ),
								'values' => array (
						...
						'button_style' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Style' ),
								'desc' => Text::_ ( 'Set the link style.' ),
								'values' => array (
