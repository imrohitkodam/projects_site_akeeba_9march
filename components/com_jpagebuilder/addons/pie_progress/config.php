...
JpagebuilderConfig::addonConfig([
    ...
    'title'      => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS'),
    'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_DESC'),
    'category'   => 'Content',
    ...
    'settings' => [
        'progress' => [
            ...
            'fields' => [
                'percentage' => [
                    'type'  => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_PERCENTAGE'),
                    'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_PERCENTAGE_DESC'),
                    'min'   => 1,
                    'max'   => 100,
                    'std'   => 75,
                    'info'  => '%',
                ...
                'size' => [
                    'type'  => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_SIZE'),
                    'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_SIZE_DESC'),
                    'min'   => 50,
                    'max'   => 1000,
                    'std'   => 110,
                    'info'  => 'px',
                ...
                'border_width' => [
                    'type'  => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_BORDER_WIDTH'),
                    'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_BAR_WIDTH_DESC'),
                    'min'   => 1,
                    'max'   => 40,
                    'std'   => 10,
                    'info'  => 'px',
                ...
                'border_color' => [
                    'type'   => 'color',
                    'title'   => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_BAR'),
                ...
                'border_active_color' => [
                    'type'   => 'color',
                    'std'    => '#3366FF',
                    'title'   => Text::_('COM_JPAGEBUILDER_ADDON_PIE_PROGRESS_PROGRESS'),
                ],
        ...
        'icon' => [
            ...
            'fields' => [
                ...
                'icon_size' => [
                    ...
                    'values' => [
                        'fa-fw'       => Text::_('COM_JPAGEBUILDER_GLOBAL_ICON_SIZE_STANDARD'),
                        'fa-lg fa-fw' => Text::_('COM_JPAGEBUILDER_GLOBAL_ICON_SIZE_TINY'),
                        'fa-2x fa-fw' => Text::_('COM_JPAGEBUILDER_GLOBAL_ICON_SIZE_SMALL'),
                        'fa-3x fa-fw' => Text::_('COM_JPAGEBUILDER_GLOBAL_ICON_SIZE_MEDIUM'),
                        'fa-4x fa-fw' => Text::_('COM_JPAGEBUILDER_GLOBAL_ICON_SIZE_LARGE'),
                        'fa-5x fa-fw' => Text::_('COM_JPAGEBUILDER_GLOBAL_ICON_SIZE_EXTRA_LARGE'),
                    ],
                    'std'   => 'fa-3x fa-fw'
                ],
            ]
