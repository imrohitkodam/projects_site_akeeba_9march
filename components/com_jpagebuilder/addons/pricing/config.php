...
JpagebuilderConfig::addonConfig([
	'type'       => 'content',
	'addon_name' => 'pricing',
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_PRICING'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_DESC'),
	'category'   => 'Content',
	...
	'settings' => [
		'title' => [
			...
			'fields' => [
				'title' => [
					'type'  => 'text',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_TITLE'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_TITLE_DESC'),
					'std'   => 'Professional',
				],
		...
		'content' => [
			...
			'fields' => [
				'pricing_content' => [
					'type'  => 'textarea',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_FEATURES'),
					'std'   => "10 GB Storage\n100 GB Bandwidth\nSpeed 500 Mbps\nDNS Automation\nSupport Time 24 hrs"
				],
				...
				'pricing_content_gap' => [
					'type'       => 'slider',
					'title'      => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_FEATURES_GAP'),
					'std'        => ['xl' => 20],
					'max'        => 500,
					'responsive' => true,
				],
		...
		'price' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE'),
			'fields' => [
				'price' => [
					'type'  => 'text',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_DESC'),
					'std'   => '$19.99',
					'inline' => true,
				],
				...
				'price_symbol' => [
					'type'        => 'text',
					'title'       => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_SYMBOL'),
					'placeholder' => '$',
					'inline' 	  => true,
				],
				...
				'price_symbol_alignment' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_SYMBOL_ALIGNMENT'),
					'values' => [
						'middle' => Text::_('COM_JPAGEBUILDER_GLOBAL_MIDDLE'),
						'super'  => Text::_('COM_JPAGEBUILDER_GLOBAL_TOP'),
						'sub'    => Text::_('COM_JPAGEBUILDER_GLOBAL_BOTTOM'),
					],
				],
				...
				'duration' => [
					'type'  => 'text',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_DURATION'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_DURATION_DESC'),
				],
				...
				'price_position' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_POSITION'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_POSITION_DESC'),
					'values' => [
						'after'  => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_POSITION_AFTER_TITLE'),
						'before' => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_POSITION_BEFORE_BUTTON'),
					],
					'std' => 'after',
				],
				...
				'price_border_bottom' => [
					'type'    => 'slider',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_BORDER_BOTTOM'),
					'max'     => 15,
				],

				'price_border_bottom_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_PRICE_BORDER_BOTTOM_COLOR'),
				],
		...
		'button_options' => [
			...
			'fields' => [
				...
				'button_aria_label' => [
                    'type' => 'text',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_ARIA_LABEL'),
                    'desc' => Text::_('COM_JPAGEBUILDER_GLOBAL_ARIA_LABEL_DESC'),
                    'std'  => ''
                ],
				...
				'button_position' => [
					...
					'values' => [
						...
						'both'     => Text::_('COM_JPAGEBUILDER_ADDON_FEATURE_BOX_URL_APEAR_BOTH'),
					],
					'std'   => 'bottom',
				],
		...
		'hover_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_HOVER_OPTIONS'),
			'fields' => [
				'pricing_hover_scale' => [
					'type'  => 'slider',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_SCALE'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PRICING_SCALE_DESC'),
					'min'   => 1,
					'max'   => 3,
					'step'  => .01,
					'std'   => 1,
				...
				'pricing_hover_boxshadow' => [
					'type'  => 'boxshadow',
					'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_BOX_SHADOW_HOVER'),
					'desc'  => Text::_('COM_JPAGEBUILDER_GLOBAL_BOX_SHADOW_HOVER_DESC'),
					'std'   => '0 0 0 0 #ffffff'
				],
			],
		],
