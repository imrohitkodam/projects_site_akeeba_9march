...
JpagebuilderConfig::addonConfig([
	'type'       => 'content',
	'addon_name' => 'raw_html',
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_RAW_HTML'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_RAW_HTML_DESC'),
	'category'   => 'General',
		...
		'content' => [
			...
			'fields' => [
				'html' => [
					'type'   => 'codeeditor',
					'syntax' => 'htmlmixed',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_RAW_HTML_HTML'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_RAW_HTML_HTML_DESC'),
					'std'    => '<p>Insert raw html here.<br/>Here is an example of hyper link <a href="https://storejextensions.org">JExtensions Store</a></p>',
				],
			],
		],
