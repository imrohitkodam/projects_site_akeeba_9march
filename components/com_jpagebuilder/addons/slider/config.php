...
JpagebuilderConfig::addonConfig ( array (
		...
		'category' => 'Interface',
		'title' => Text::_ ( 'Slider' ),
		'desc' => Text::_ ( 'Create a responsive carousel slider.' ),
		'icon' => Uri::root () . 'components/com_jpagebuilder/addons/slider/assets/images/icon.png',
		'attr' => array (
				'general' => array (
						'admin_label' => array (
								'type' => 'text',
						...
						'slidesets' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Sets' ),
								'desc' => Text::_ ( 'Slide all visible items at once. Group items into sets. The number of items within a set depends on the defined item width, e.g. 33% means that eaach set contains 3 items.' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'image_transition' => array (
								...
								'desc' => Text::_ ( 'Select a hover transition for the Image.' ),
								'values' => array (
										'' => Text::_ ( 'None' ),
										'scale-up' => Text::_ ( 'Scale Up' ),
										'scale-down' => Text::_ ( 'Scale Down' )
						...
						'content_transition' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Content Transition' ),
