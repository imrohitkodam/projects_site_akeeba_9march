...
class JpagebuilderAddonSoundcloud extends JpagebuilderAddons {
	/**
	...
	public function render() {
		...
		// Output
		if ($embed) {
			$output = '<div class="jpb-addon jpb-addon-soundcloud ' . $class . '">';
	...
	public static function getFrontendEditor() {
		...
		$output .= '
				...
				<div class="jpb-addon jpb-addon-soundcloud {{ data.class }}">
