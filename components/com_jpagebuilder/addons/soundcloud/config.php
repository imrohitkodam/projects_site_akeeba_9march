...
JpagebuilderConfig::addonConfig([
    ...
    'title'      => Text::_('COM_JPAGEBUILDER_ADDON_SOUNDCLOUD'),
    'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_SOUNDCLOUD_DESC'),
    'category'   => 'Media',
    ...
    'settings' => [
        'content' => [
            ...
            'fields' => [
                'embed' => [
                    'type'  => 'textarea',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_SOUNDCLOUD_EMBED'),
                    'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_SOUNDCLOUD_EMBED_DESC'),
