...
JpagebuilderConfig::addonConfig ( array (
		'type' => 'repeatable',
		'addon_name' => 'switcher',
		'title' => Text::_ ( 'Switcher' ),
		'desc' => Text::_ ( 'Dynamically transition through different content panes.' ),
		'icon' => Uri::root () . 'components/com_jpagebuilder/addons/switcher/assets/images/icon.png',
		'category' => 'Interface',
		'attr' => array (
				'general' => array (
						'admin_label' => array (
						...
						'ui_switcher_item' => array (
								...
								'attr' => array (
										...
										'navigation_image_alt' => array (
												'type' => 'text',
												'title' => Text::_ ( 'Navigation Label' )
										),
										'navigation_image' => array (
												'type' => 'media',
												'title' => Text::_ ( 'Navigation Thumbnail' ),
												'desc' => Text::_ ( 'This image is only used if the Thumbnav navigation style is set.' ),
												'placeholder' => 'http://www.example.com/my-photo.jpg',
												'show_input' => true
										)
								)
						...
						'navigation' => array (
								...
								'desc' => Text::_ ( 'Select the navigation style. The pill and divider styles are only available for horizontal subnavs' ),
								'values' => array (
										'tab' => Text::_ ( 'Tabs' ),
						...
						'thumbnav_wrap' => array (
								...
								'desc' => Text::_ ( 'Define whether thumbnails wrap into multiple lines or not if the container is too small.' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'title_show' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Display Title Inside Content' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'title_navigation' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Show the navigation label instead of title' ),
								'desc' => Text::_ ( 'The title by default is added inside the switcher content, You can use this option to show/hide the title.' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'thumbnail_svg_inline' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Thumbnail Inline SVG' ),
						...
						'thumbnail_svg_color' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Thumbnail SVG Color' ),
						...
						'switcher_animation' => array (
								...
								'desc' => Text::_ ( 'Select an animation that will be applied to the content items when toggling between theme.' ),
								'values' => array (
										'' => Text::_ ( 'None' ),
										'fade' => Text::_ ( 'Fade' ),
						...
						'match_height' => array (
								'type' => 'checkbox',
								'title' => Text::_ ( 'Match content height' ),
								'desc' => Text::_ ( 'Extend all content items to the same height' ),
								'values' => array (
										1 => Text::_ ( 'JYES' ),
										0 => Text::_ ( 'JNO' )
								),
						...
						'switcher_font_family' => array (
								...
								'selector' => array (
										'type' => 'font',
										'font' => '{{ VALUE }}',
										'css' => '.tm-switcher>*>a { font-family: {{ VALUE }}; }'
								)
						),
						...
						'title_breakpoint' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Grid Breakpoint' ),
								'desc' => Text::_ ( 'Set the breakpoint from which grid items will stack.' ),
								'values' => array (
										'' => Text::_ ( 'Always' ),
										's' => Text::_ ( 'Small (Phone Landscape)' ),
										'm' => Text::_ ( 'Medium (Tablet Landscape)' ),
						...
						'meta_alignment' => array (
								'type' => 'select',
								'title' => Text::_ ( 'Alignment' ),
								'desc' => Text::_ ( 'Align the meta text.' ),
								'values' => array (
