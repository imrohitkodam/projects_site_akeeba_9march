...
JpagebuilderConfig::addonConfig([
	...
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_TEAM_CAROUSEL'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_TEAM_CAROUSEL_DESC'),
	'category'   => 'Slider',
	...
	'settings' => [
		'carousel_layout_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_LAYOUTS'),
			'fields' => [
		...
		'items' => [
			...
			'fields' => [
				'jp_team_carousel_item' => [
					'type' => 'repeatable',
					'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_ITEMS'),
					'std' => [
						[
							'team_carousel_img' => [
								'src' => 'https://storejextensions.org/cdn/addons/team1.jpg',
							],
						...
						[
							'team_carousel_img' => [
								'src' => 'https://storejextensions.org/cdn/addons/team2.jpg',
							],
							'person_name'        => 'John Doe',
							'person_designation' => 'Software Engineer',
							'team_carousel_item' => [
						...
						[
							'team_carousel_img' => [
								'src' => 'https://storejextensions.org/cdn/addons/team3.jpg',
							],
							'person_name'        => 'John Doe',
							'person_designation' => 'Software Engineer',
							'team_carousel_item' => [
						...
						'person' => [
							...
							'fields' => [
								...
								'person_name' => [
									...
									'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PERSON_NAME_DESC'),
								],
								...
								'person_designation' => [
									...
									'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_PERSON_DESIGNATION_DESC'),
								],
		...
		'name_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_PERSON_NAME_OPTIONS'),
			'fields' => [
				'name_typography' => [
					'type'     => 'typography',
		...
		'designation_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_PERSON_DESIGNATION_OPTIONS'),
			'fields' => [
		...
		'social_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_PERSON_SOCIAL_OPTIONS'),
			'fields' => [
				'social_fontsize' => [
					'type' => 'slider',
		...
		'carousel' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_OPTIONS'),
			'fields' => [
		...
		'arrows_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_PERSON_ARROWS_OPTIONS'),
			'fields' => [
		...
		'bullets_options' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_PERSON_CONTROLS_OPTIONS'),
			'fields' => [
