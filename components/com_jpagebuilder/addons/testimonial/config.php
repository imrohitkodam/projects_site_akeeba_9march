...
JpagebuilderConfig::addonConfig([
	...
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL'),
	'desc'       => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_DESC'),
	'category'   => 'Content',
	...
	'settings' => [
		...
		'content' => [
			...
			'fields' => [
				...
				'url' => [
					...
					'std'	=> ['url' => 'https://storejextensions.org/extensions/jpagebuilder-joomla-page-builder.html'],
				],
				...
				'avatar_dis_block' => [
					'type'  => 'checkbox',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_AVATAR_BLOCK'),
					'std'   => 0,
				],
		...
		'options' => [
			...
			'fields' => [
				'show_quote' => [
					'type'   => 'checkbox',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_SHOW_ICON'),
					'values' => [
						1 => Text::_('JYES'),
						0 => Text::_('JNO'),
					],
				...
				'client_rating_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_RATING_COLOR'),
					'depends' => [['client_rating_enable', '=', 1]],
				],

				'client_unrated_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_UNRATED_COLOR'),
					'depends' => [['client_rating_enable', '=', 1]],
				],
