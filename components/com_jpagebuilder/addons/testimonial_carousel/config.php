...
JpagebuilderConfig::addonConfig([
    ...
    'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CAROUSEL'),
    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CAROUSEL_DESC'),
    'category' => 'Slider',
    ...
    'settings' => [
        'general' => [
            ...
            'fields' => [
                ...
                'jp_testimonial_carousel_item' => [
                    'type' => 'repeatable',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ITEMS'),
                    'std' => array_fill(0, 6, [
                        'client_name' => 'John Doe',
                        'client_desgination' => 'Full Stack Developer', // @todo: fix the spelling
                        'client_message' => 'Testimonial carousel is modern and stylish addon for JPageBuilder. Instantly raise your website appearance with this stylish new addon.',
                        'show_rating' => 1,
                        'client_rating' => 4.5,
                    ...
                    'attr' => [
                        ...
                        'client_name' => [
                            'type' => 'text',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_NAME'),
                            'desc' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_NAME_DESC'),
                            'std' => 'John Doe',
                        ],

                        'client_desgination' => [
                            'type' => 'text',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_CLIENT_DESIGNATION'),
                            'desc' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_CLIENT_DESIGNATION_DESC'),
                            'std' => 'Full Stack Developer',
                        ],

                        'client_message' => [
                            'type' => 'textarea',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CAROUSEL_MESSAGE'),
                            'desc' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CAROUSEL_MESSAGE_DESC'),
                            'std' => 'Testimonial carousel is modern and stylish addon for JPageBuilder . Instantly raise your website appearance with this stylish new addon.',
                        ],

                        'show_rating' => [
                            'type' => 'checkbox',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_RATING_ENABLE'),
                            'desc' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_RATING_ENABLE_DESC'),
                            'std' => 1,
                        ],

                        'client_rating' => [
                            'type' => 'slider',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_RATING'),
                            'desc' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_RATING_DESC'),
                        ...
                        'testimonial_carousel_img' => [
                            'type' => 'media',
                            'title' => Text::_('COM_JPAGEBUILDER_ADDON_CLIENT_IMAGE'),
                            'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CLIENT_IMAGE_DESC'),
                            'std' => ['src' => 'https://storejextensions.org/cdn/addons/image-carousel-default.jpg'],
                        ],
                    ],
                ],
        ...
        'name' => [
            'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_NAME'),
            'fields' => [
                'name_typography' => [
                    'type' => 'typography',
        ...
        'designation' => [
            'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_DESIGNATION'),
            'fields' => [
                'title_typography' => [
                    'type' => 'typography',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_TYPOGRAPHY'),
        ...
        'message' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_MESSAGE'),
            'fields' => [
                'message_typography' => [
                    'type' => 'typography',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_TYPOGRAPHY'),
        ...
        'avatar' => [
            'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_AVATAR'),
            'fields' => [
                'avatar_layout' => [
                    'type' => 'thumbnail',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_LAYOUT'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_AVATAR_STYLE_DESC'),
                    'columns' => 2,
                    'values' => [
        ...
        'quote' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_QUOTE'),
            'fields' => [
                'show_quote_icon' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_QUOTE'),
                ...
                'quote_icon_size' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_SIZE'),
                    'std' => ['xl' => 50],
                    'min' => 10,
                    'max' => 200,
                    'responsive' => true,
        ...
        'ratings' => [
            'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_RATINGS'),
            'fields' => [
                'rating_color' => [
                    'type' => 'color',
                    'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_COLOR'),
        ...
        'options' => [
            ...
            'fields' => [
                'carousel_item_number' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ITEM_NUMBER'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ITEM_NUMBER_DESC'),
                    'min' => 1,
                    'max' => 15,
                    'responsive' => true,
                ],
                ...
                'carousel_margin' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ITEM_MARGIN'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_ITEM_MARGIN_DESC'),
                    'responsive' => true,
                    'std' => ['xl' => 15],
                ],
                ...
                'carousel_autoplay' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_AUTOPLAY'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_AUTOPLAY_DESC'),
                    'std' => 0,
                ],

                'carousel_interval' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_INTERVAL'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_IMAGE_CAROUSEL_INTERVAL_DESC'),
                    'std' => 4500,
                ...
                'carousel_speed' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_SPEED'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_SPEED_DESC'),
                    'std' => 1500,
                ],
                ...
                'carousel_bullet' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_SHOW_CONTROLLERS'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_SHOW_CONTROLLERS_DESC'),
                    'std' => 1,
                ],

                'bullet_position_verti' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_CONTROLLER_VERTICAL_POSITION'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_CONTROLLER_VERTICAL_POSITION_DESC'),
                    'min' => -100,
                    'max' => 100,
                    'responsive' => true,
                ...
                'bullet_position_hori' => [
                    'type' => 'slider',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_CONTROLLER_HORI_POSITION'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_CONTROLLER_HORI_POSITION_DESC'),
                    'min' => -2000,
                    'max' => 2000,
                    'responsive' => true,
                    'depends' => [['carousel_bullet', '=', 1]],
                ...
                'bullet_style' => [
                    ...
                    'values' => [
                        ...
                        ['label' => Text::_('COM_JPAGEBUILDER_GLOBAL_ACTIVE'), 'value' => 'active'],
                    ],
                    'std' => 'normal',
                    'depends' => [['carousel_bullet', '=', 1]],
                ],
                ...
                'carousel_arrow' => [
                    'type' => 'checkbox',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_SHOW_ARROWS'),
                    'desc' => Text::_('COM_JPAGEBUILDER_ADDON_CAROUSEL_SHOW_ARROWS_DESC'),
                    'std' => 1,
                ],
                ...
                'arrow_icon' => [
                    'type' => 'select',
                    'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_ARROWS_ICON'),
                    'values' => [
                        'angle' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_ARROWS_ICON_ANGLE'),
                        'long_arrow' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_ARROWS_ICON_LONG_ARROW'),
                    ],
                    'std' => 'long_arrow',
                    'depends' => [['carousel_arrow', '=', 1]],
                ],
                ...
                'arrow_style' => [
                    'type' => 'buttons',
                    'values' => [
                        ['label' => Text::_('COM_JPAGEBUILDER_GLOBAL_NORMAL'), 'value' => 'normal_arrow'],
                        ['label' => Text::_('COM_JPAGEBUILDER_GLOBAL_HOVER'), 'value' => 'hover_arrow'],
                    ],
                    'std' => 'normal_arrow',
                    'depends' => [['carousel_arrow', '=', 1]],
                ],
