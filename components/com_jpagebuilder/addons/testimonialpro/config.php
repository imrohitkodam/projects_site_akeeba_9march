...
JpagebuilderConfig::addonConfig([
	...
	'title'      => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO'),
	...
	'settings' => [
		'content' => [
			...
			'fields' => [
				'jp_testimonialpro_item' => [
					'type' => 'repeatable',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_TESTIMONIALS'),
					'attr' => [
						'title' => [
							'type' => 'text',
						...
						'message' => [
							'type' => 'editor',
							'title' => Text::_('COM_JPAGEBUILDER_GLOBAL_MESSAGE'),
		...
		'avatar' => [
			...
			'fields' => [
				...
				'avatar_shape' => [
					'type'   => 'select',
					'title'  => Text::_('COM_JPAGEBUILDER_GLOBAL_SHAPE'),
					'values' => [
						'jpb-avatar-sqaure' => Text::_('COM_JPAGEBUILDER_GLOBAL_SQUARE'),
						'jpb-avatar-round'  => Text::_('COM_JPAGEBUILDER_GLOBAL_ROUNDED'),
						'jpb-avatar-circle' => Text::_('COM_JPAGEBUILDER_GLOBAL_CIRCLE'),
					],
					'std' => 'jpb-avatar-circle'
				],

				'avatar_on_top' => [
					'type'   => 'checkbox',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_AVATAR_ON_TOP'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_AVATAR_ON_TOP_DESC'),
					'values' => [
						1 => Text::_('JYES'),
						0 => Text::_('JNO'),
					],
		...
		'quote' => [
			'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_QUOTE_ICON'),
			'fields' => [
				'show_quote' => [
					'type'   => 'checkbox',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_QUOTE_ICON'),
		...
		'carousel_options' => [
			...
			'fields' => [
				'autoplay' => [
					'type'   => 'checkbox',
					'title'  => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_AUTOPLAY'),
					'desc'   => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_AUTOPLAY_DESC'),
					'values' => [
						1 => Text::_('JYES'),
						0 => Text::_('JNO'),
					],
				...
				'interval' => [
					'type'    => 'slider',
					'title'   => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_INTERVAL'),
					'desc'    => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_INTERVAL_DESC'),
					'std'     => 5,
					'depends' => [['autoplay', '=', 1]]
				],
				...
				'speed' => [
					'type'  => 'slider',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_SPEED'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_SPEED_DESC'),
					'std'   => 600,
				],
				...
				'bullet_active_bg_color' => [
					'type'    => 'color',
					'title'   => Text::_('COM_JPAGEBUILDER_GLOBAL_BACKGROUND_COLOR_ACTIVE'),
					'depends' => [['controls', '=', 1]],
				],
				...
				'arrow_controls' => [
					'type'  => 'checkbox',
					'title' => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_SHOW_ARROWS'),
					'desc'  => Text::_('COM_JPAGEBUILDER_ADDON_TESTIMONIAL_PRO_SHOW_ARROWS_DESC'),
					'std'   => 0,
				],
