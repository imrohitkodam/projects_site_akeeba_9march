...
JpagebuilderConfig::addonConfig ( [ 
		...
		'addon_name' => 'totop',
		'title' => Text::_ ( 'To Top' ),
		'desc' => Text::_ ( 'Create a simple Smooth to-top scroller.' ),
		'icon' => '<svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg"> <polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9 " /> </svg>',
		'category' => 'Interface',
		'settings' => [ 
				'content' => [ 
				...
				'separator_title_options' => [ 
						...
						'fields' => [ 
								...
								'text_color' => [ 
										...
										'desc' => Text::_ ( 'Add predefined text color to totop icon.' ),
										'values' => [ 
												'' => Text::_ ( 'None' ),
												'muted' => Text::_ ( 'Muted' ),
