...
if (! class_exists ( 'JpagebuilderCssParser' )) {
	/**
	 * Class Parse CSS code for JPageBuilder
	 *
	 * @since 4.0.0
	 */
	class JpagebuilderCssParser {
		/**
		 * Class instance
		 *
		 * @var JpagebuilderCssParser
		 * @since 1.0.0
		 */
		...
		public static function getCss($addonName, $css, $id, $addonWrapperId = null) {
			...
			if (self::$instance === null) {
				self::$instance = new JpagebuilderCssParser ();
			}
