	...
	private function encode($new_filename, $newwidth, $newheight)
	{
		...
		foreach ($this->parsedfiles as $imagepart)
		{
			...
			if ($this->index == 1)
			{
				...
				if ($this->orgvars["hasgx_type_0"])
					$mystring .= $this->globaldata["graphicsextension_0"];
				if ($this->orgvars["hasgx_type_1"])
