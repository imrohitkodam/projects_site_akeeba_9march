...
class JFormFieldForeignKey extends FormField
{
	...
	protected function getInput()
	{
		...
		$query->select(array($this->key_field, $this->value_field))->from($this->table);
		$db->setQuery($query);
		...
		switch ($this->input_type)
		{
			...
			default:
				...
				$html = HTMLHelper::_('select.genericlist', $options, $this->name, $input_options, 'value', 'text', $value);
				break;
		}
