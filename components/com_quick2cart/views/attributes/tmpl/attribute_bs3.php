		...
		<div class=" ">
			...
			<tbody>
				<td data-title="<?php echo Text::_('QTC_ADDATTRI_NAME');?>">
					<input id="atrri_name_id" class="input-small bill required" type="text" value="<?php echo (isset($this->itemattribute_name))? htmlentities($this->itemattribute_name):''; ?>" maxlength="250"  name="att_detail[attri_name]" title="<?php echo Text::_('QTC_ADDATTRI_NAME_DESC')?>">
				...
				<td data-title="<?php echo Text::_('QTC_ADDATTRI_FIELD_TYPE_TO_USE');?>">
					...
					echo HTMLHelper::_('select.genericlist', $fields, "att_detail[fieldType]", 'class="no_chzn  qtcfieldType" onChange="qtc_fieldTypeChange('.$fnparam.')"', "value", "text",$default);
				?>
				</td>
...
<table class="table table-condensed item_attris_opt qtc_attributeOpTable" style="<?php echo $tableDisplay; ?>"><!-- the table width is fixed to 450px -->
	...
	?>
		<tr class="form-group form-inline clonedInput" id="attri_opts<?php echo $k; ?>" >
			<td data-title="<?php echo Text::_('QTC_ADDATTRI_OPTNAME');?>">
				...
				<input type="text" class="input-medium" name="att_detail[attri_opt][<?php echo $k; ?>][name]" placeholder="<?php echo Text::_('QTC_ADDATTRI_OPTNAME')?>" value="<?php echo (isset($this->attribute_opt[$k]->itemattributeoption_name)) ? htmlentities($this->attribute_opt[$k]->itemattributeoption_name) : ''; ?>">
			</td>
			<td data-title="<?php echo Text::_('QTC_ADDATTRI_OPTPREFIX');?>">
				...
				echo HTMLHelper::_('select.genericlist', $addpre_select, "att_detail[attri_opt][$k][prefix]", 'class=""   ', "value", "text", $addpre_val);
				?>
			</td>
	...
	<div class="">
		...
		<input class="btn btn-success validate" type="submit" onclick="submitbutton('attributes.save');" value="<?php echo Text::_('QTC_ADDATTRI_SAVE')?>" >		<?php echo HTMLHelper::_( 'form.token' ); ?>

		<input class="btn btn btn-default validate" type="button" onclick="qtc_closePopUp();" value="<?php echo Text::_('QTC_ADDATTRI_CANCEL')?>" >		<?php echo HTMLHelper::_( 'form.token' ); ?>
	</div>
