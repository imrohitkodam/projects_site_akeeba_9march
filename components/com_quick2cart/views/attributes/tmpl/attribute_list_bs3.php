...
$add_link        = $qtc_base_url.'index.php?option=com_quick2cart&view=attributes&layout=attribute_bs3&tmpl=component&pid='.$pid.'&client='.$client;
...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>" >
	...
	?>
	<button class="btn btn-sm btn-primary qtcAddAttributeLink" type="button" data-toggle="modal" data-target="#addAttributeListModal">
