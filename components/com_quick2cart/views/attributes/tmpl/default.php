					...
					<div class='form-group' >
						...
						<div class="col-sm-8 col-xs-12">
							<?php
								...
								echo HTMLHelper::_('select.genericlist', $options, $stateFieldName,'class="qtc_itemstate " autocomplete="off"','value','text', $default,"qtc_item_state");
							?>
						</div>
					</div>
				<?php
