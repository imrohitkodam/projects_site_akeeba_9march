	...
	else
	{
		...
		<div id='qtcOptionsWraper' style="<?php echo $showQtcFields; ?>">
			<div id='' class=" <?php echo $class_nm;?>" >
				...
				<div class="form-group">
					<label for="item_name" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
					...
					<div class="col-sm-8 col-xs-12">
						<input
							type="text"
							class="required requiredEE form-control"
							name="item_name"
							id="item_name"
				...
				<!-- SKU -->
				<div class='form-group' >
					<label for="sku" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
				...
				<div class="form-group" style="<?php echo $StoreIds_style;?>">
					<label for="current_store_id" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
					...
					<div class="col-sm-8 col-xs-12">
						...
						echo $this->dropdown = HTMLHelper::_('select.genericlist',$options_store,'store_id','class=" qtc_putmargintop10px qtc_requiredoption form-select"   onchange="getTaxprofile();"','value','text',$default_store_id,'current_store_id');
						?>
					</div>
				</div>
				...
				if ($showStateBtn)
				{
					?>
					<div class='form-group' >
						<label for="qtc_item_state" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
									...
									<div class=" curr_margin">
										...
										<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 input-group">
											<input Onkeyup="checkforalpha(this,'46', '<?php echo addslashes($entered_numerics); ?>')"
												...
												value="<?php echo $storevalue;?>"
												placeholder="<?php echo trim($value);?>" />
											<div class="input-group-addon"><?php echo trim($value);?></div>
										</div>
										<div class="qtcClearBoth"></div>
									</div>
								</div>
				...
				<div class="form-group" style="<?php echo $qtc_min_max_style;?>">
					<label for="max_item" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_ITEM_MAX_QTY_DESC'); ?>">
				...
				if ($isTaxationEnabled  || $qtc_shipping_opt_status)
				{
					...
					$taxshipPath = $comquick2cartHelper->getViewpath('product', 'taxship_bs3', $searchTmpPath, $useViewpath);
					ob_start();
					include($taxshipPath);
			...
			{ ?>
				<div class="q2c_padding">
					...
					<?php
					$attlistPath = $comquick2cartHelper->getViewpath('attributes', 'attribute_list_bs3', $searchTmpPath, $useViewpath);
					ob_start();
					include($attlistPath);
				...
				if ($eProdSupport)
				{
					...
					<div class="q2c_padding">
						...
						<?php
						$attlistPath = $comquick2cartHelper->getViewpath('attributes', 'media_list_bs3', $searchTmpPath, $useViewpath);
						ob_start();
						include($attlistPath);
						$attDetail = ob_get_contents();
						ob_end_clean();
				...
				if($extra_field == '1')
				{
					...
					<div class="">
						...
						<?php
						$attlistPath = $comquick2cartHelper->getViewpath('attributes', 'extrafield_list_bs3', $searchTmpPath, $useViewpath);
						ob_start();
						include($attlistPath);
						$attDetail = ob_get_contents();
						ob_end_clean();
