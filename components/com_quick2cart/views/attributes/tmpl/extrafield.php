	...
	<div class="<?php echo Q2C_WRAPPER_CLASS; ?>" >
		<form method="POST" name="adminForm" class="form-validate" action="index.php">
			...
			<div class="form-actions">
				...
				<input class="btn btn-success validate" type="submit" value="<?php echo Text::_('QTC_ADDATTRI_SAVE')?>" />
				<a class="btn btn-default" onclick="cancel();" title="<?php echo Text::_('JCANCEL'); ?>">
