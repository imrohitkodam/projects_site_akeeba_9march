...
$addMediaLink              = $qtc_base_url.'index.php?option=com_quick2cart&view=attributes&layout=extrafield_bs5&tmpl=component&item_id=' . $item_id . "&content_id=" . $item_id;
...
<button class="btn btn-sm btn-primary" type="button" onclick="toggleAddExtraFieldModal();" data-target="#addExtraFieldModal">
