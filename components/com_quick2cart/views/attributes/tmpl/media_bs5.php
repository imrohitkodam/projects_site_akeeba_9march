...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>" >
	<form method="POST" name="adminForm" class="form-validate" action="index.php">
		...
		<div class="">
			...
			<a class="btn btn-default float-end ms-2 mt-2" onclick="cancel();" title="<?php echo Text::_('JCANCEL'); ?>">
				<?php echo Text::_('QTC_ADDATTRI_CANCEL'); ?>
			</a>
			<input class="btn btn-success validate float-end ms-2 mt-2" type="submit"  value="<?php echo Text::_('QTC_ADDATTRI_SAVE')?>" />
