...
if( !empty($pid) && $client )
{
	...
	if(!empty($item_id))
	{
		...
		$addMediaLink   = $qtc_base_url.'index.php?option=com_quick2cart&view=attributes&layout=media_bs3&tmpl=component&item_id='.$item_id;
	}
	?>
...
?>
<button class="btn btn-sm btn-primary qtcAddMediaLink" type="button" data-toggle="modal" data-target="#addMediaListModal">
