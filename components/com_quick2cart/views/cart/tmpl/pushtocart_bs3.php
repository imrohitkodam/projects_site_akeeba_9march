...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> container-fluid" >
	<div class="form-horizontal qtc_buynow af-ml-15" id="<?php echo $this->product_id;?>_item" style="width:auto;">
		<?php 
		$discount_present = 0;
		...
		?>
			<div class="form-group row">
				<label class="col-md-4 col-xs-12 col-sm-4 control-label qtc-label-original_price">
					<strong><?php echo Text::_('QTC_ITEM_AMT')?></strong>
				</label>
				<div class="col-md-8 col-xs-12 col-sm-8 qtc_controls_text qtc-field-original_price">
		...
		<div class="center">
			<div style="<?php echo $showqty_style;?>" class="form-inline q2c-inline-block">
				...
				<div class="form-group q2c-table-cell-center q2c-item-to-cart-section-<?php echo $this->item_id;?>" <?php echo $showQtyToCartSecStyle;?>>
					<button class="btn btn-sm btn-success q2c-small-buy-button af-ml-15" type="button" <?php echo $disableBuyBtn; ?> onclick="qtc_addtocart('<?php echo $this->product_id; ?>');">
