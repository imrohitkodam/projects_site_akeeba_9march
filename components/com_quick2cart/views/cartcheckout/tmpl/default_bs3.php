					...
					<form method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class=" form-validate" onsubmit="return validateForm();">
						<div class="tab-pane step-pane active" id="step1">
							<div id="qtc_step1_cartdetail">
								<?php
								$comquick2cartHelper = new comquick2cartHelper;
								$cartpath            = $comquick2cartHelper->getViewpath('cartcheckout','default_cartdetail_bs3');
						...
						<div class="tab-pane step-pane" id="step2">
							<div class="qtcAddBorder">
								...
								ob_start();
								$path = $comquick2cartHelper->getViewpath('registration','default_bs3');
								include_once($path);
									...
									<div class="row">
										<div class="container-fluid">
											<div class="qtcadd_address_button center">
												<button type="button" onclick="addAddress('<?php echo JUri::root();?>' , 'addAddressModal')" class="btn btn-success" data-toggle="" data-target="#addAddressModal">
								...
								else
								{
									...
									$comquick2cartHelper = new comquick2cartHelper;
									$billpath            = $comquick2cartHelper->getViewpath('cartcheckout','default_billing_bs3');
									?>
									<div class="clearfix">&nbsp;</div>
									<div class="row">
