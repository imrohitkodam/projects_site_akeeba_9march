...
<div class="qtcAddBorderToWrapper"  id="qtcShippingMethTab">
										...
										foreach ($shippingMeths as $key=>$shipMeth)
										{
											...
											<div>
												...
												<label class="radio">
													<input
														type="radio"
														name="<?php echo $radioFieldName;?>"
														id=""
														value="<?php echo $shipMeth['methodId']; ?>"
														<?php echo $checked; ?> >
	...
	else
	{
		...
		<div class="alert alert-info">
			<?php echo Text::_('COM_QUICK2CART_NO_AVAIL_SHIP_METHODS_PRECEED')?>
		</div>
		<?php
	}
	?>
	<input
		type="hidden"
		name="<?php echo 'itemlLevelshppingrestricted'?>"
		id='itemlLevelshppingrestricted'
		value="<?php echo $itemlLevelshppingrestricted; ?>">
</div>
