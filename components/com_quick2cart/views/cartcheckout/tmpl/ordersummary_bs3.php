		...
		<div class="row">
			<div class="qtcPadding">
				...
				<div class="qtcPadding1111">
					...
					<div class="table-responsive" id="no-more-tables">
						<table width="100%" class="table table-condensed table-bordered qtc-table table-hover" cellspacing="0">
							<thead class="table-dark">
								<tr class="hidden-xs hidden-sm">
									<th class="cartitem_num" width="5%" align="left">
										<?php echo Text::_('QTC_NO');?>
									</th>
									<th class="cartitem_name" align="left">
									...
									{
										?>
										<th class="cartitem_opt" align="left">
			...
			if (isset($allowToScheduleDeliverySlot) && $allowToScheduleDeliverySlot == '1')
			{
				...
				<div class="qtcPadding">
					...
					<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#deliverySlotModal"
					...
					if ($showTermsAndConditions)
					{
						...
						<div class="checkbox checkout-addresses">
							<label>
								...
								?>
								<a data-target="#privacyPolicyModal" data-toggle="modal" class="qtc_modal" title="<?php echo Text::_('COM_QUICK2CART_TERMS_CONDITION'); ?>">
