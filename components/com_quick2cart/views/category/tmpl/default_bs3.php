 						...
 						<div id="q2c_pc_category" class="q2c_pin_container">
							...
							foreach ($target_data as $data)
							{
								...
								<div class="q2c_pin_item_<?php echo $random_container . $Fixed_pin_classes;?>">
									<?php
									$data       = (array)$data;
									$path       = $comquick2cartHelper->getViewpath('product','product_bs3');
			...
			?>
				...
				<!-- for category list-->
					...
					if ($this->params->get('multivendor'))
					{
						...
						$view        = $comquick2cartHelper->getViewpath('vendor', 'storelist_bs3');
						ob_start();
						include($view);
						$html = ob_get_contents();
						ob_end_clean();
...
<script>
	...
	// JUri::root() provides the base URL of the site and works in only fronted side
