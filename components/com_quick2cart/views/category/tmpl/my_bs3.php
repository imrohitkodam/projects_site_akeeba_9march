...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> my-products container-fluid">
	<form  method="post" name="adminForm" id="adminForm" class="form-validate">
		...
		<a href="#myModal" data-toggle="modal" data-target="#import_products" class='pull-right btn btn-sm btn-info'>
		...
		<div id="qtc-filter-bar" class="qtc-btn-toolbar">
			...
			<div class="pull-left">
				<button
					type="submit"
					class="btn btn-default qtc-hasTooltip"
			...
			<div class="qtc-btn-group pull-right hidden-xs q2c-btn-wrapper">
			<?php echo HTMLHelper::_('select.genericlist', $this->statuses, "filter_published", 'class="input-medium"  onchange="document.adminForm.submit();" name="filter_published"', "value", "text", $this->state->get('filter.published'));?>
			</div>
			<div class="qtc-btn-group pull-right hidden-xs q2c-btn-wrapper">
	...
	<div class="modal center fade" id="import_products" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content" style="width: 900px;height: 350px;">
				...
				<div class="modal-footer">
					<button type="button" id="productImportCloseModalbtn" class="btn btn-default" data-dismiss="modal">
