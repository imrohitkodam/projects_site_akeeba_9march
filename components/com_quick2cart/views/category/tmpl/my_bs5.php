...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> my-products container-fluid">
	<form  method="post" name="adminForm" id="adminForm" class="form-validate">
		...
		<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#import_products" class='float-end btn btn-sm btn-info'>
			<span class="fa fa-upload fa-white"></span>
		...
		<div id="filter-bar" class="js-stools">
			<div class="js-stools-container-selector btn-group mt-2 float-start filter-search">
				<input
					type="text"
					name="filter_search"
					id="filter_search"
				...
				<button type="button" class="btn  btn-primary hasTooltip" title="<?php echo Text::_('JSEARCH_FILTER_CLEAR'); ?>" onclick="document.getElementById('filter_search').value='';this.form.submit();">
					<i class="<?php echo QTC_ICON_REMOVE; ?>"></i>
				</button>
			</div>
			<div class="btn-group float-end">

				<div class="mt-2 float-end hidden-xs q2c-btn-wrapper">
					<select name="filter_category" class="form-select input-medium" onchange="this.form.submit()">
				...
				<div class="mt-2 float-end hidden-xs q2c-btn-wrapper">
				<?php echo HTMLHelper::_('select.genericlist', $this->statuses, "filter_published", 'class="form-select input-medium" onchange="document.adminForm.submit();" name="filter_published"', "value", "text", $this->state->get('filter.published'));?>
				</div>
				<div class="mt-2 float-end hidden-xs q2c-btn-wrapper">
				...
				<table class="table table-striped table-bordered table-responsive" id="productList">
					<thead>
						<tr>
							...
							<th class="q2c_width_10 nowrap center hidden-xs">
						...
						if (!empty($this->products))
						{
							...
							for ($i=0; $i < $n; $i++)
							{
								...
								<tr class="<?php echo 'row'.$k; ?>">
									...
									<td class="q2c_width_5 qtcWordWrap center">
										<?php echo $edit_link; ?>
									</td>
									...
									<td class="q2c_width_10 nowrap center hidden-xs small">
										<?php
									...
									<td class="q2c_width_1 nowrap center hidden-xs small">
		...
		<div class="modal-dialog modal-lg">
			...
			<div class="modal-content">
				<div class="modal-body height-400 overflow-y-auto af-m-10">
					<div id="import_products" class="row">
						<div class="col-sm-12">
							<?php $uploadUrl = Uri::base() . 'index.php?option=com_quick2cart&task=products.csvImport&tmpl=component&format=html'?>
							<form action="<?php echo $uploadUrl;?>" id="uploadForm" class="form-inline" name="uploadForm" method="post" enctype="multipart/form-data">
								<table>
									<tr>&nbsp;</tr>
										<div id="uploadform">
											<fieldset id="upload-noflash" class="actions">
												<div class="row">
													<div class="col-sm-6">
														<label for="upload-file" class="col-sm-3 col-xs-12 control-label">
												...
												<div class="row">
													<div class="col-sm-12">
														<div class="alert alert-warning af-mt-10" role="alert"><i class="icon-info"></i>
				...
				<div class="modal-footer">
					<button type="button" id="productImportCloseModalbtn" class="btn btn-default" data-bs-dismiss="modal">
						<?php echo Text::_('QTC_CLOSE');?></button>
				</div>
			</div>
		</div>
	</div>
			...
			<form action="<?php echo $uploadUrl;?>" id="uploadForm" class="form-inline center" name="uploadForm" method="post" enctype="multipart/form-data">
				<table>
					<tr>&nbsp;</tr>
						<div id="uploadform">
							<fieldset id="upload-noflash" class="actions">
								<label for="upload-file" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
									<?php echo Text::_('COM_QUICK2CART_UPLOADE_FILE');?>
								</label>
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<input type="file" id="upload-file" name="csvfile" id="csvfile" accept=".csv"/>
								</div>
								<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 float-start">
									<button class="btn btn-primary" id="upload-submit">
										<i class="icon-upload icon-white"></i>
										<?php echo Text::_('COM_QUICK2CART_PRODUCTS_IMPORT_CSV'); ?>
									</button>
