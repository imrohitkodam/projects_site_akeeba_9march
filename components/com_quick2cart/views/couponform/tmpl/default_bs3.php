...
<div class="<?php echo Q2C_WRAPPER_CLASS;?> coupon-form">
	<form name="adminForm" id="adminForm" class="form-horizontal form-validate" method="post" onSubmit="" >
		...
		<div>
			...
			<div class="form-group">
				<label for="value" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPAN_VALUE_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_VALUE'), '', Text::_('COM_QUICK2CART_COUPON_VALUE') . ' *');?></label>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
			...
			<div class="form-group">
				<label for="max_use" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_MAXUSES_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_MAXUSES'), '', Text::_('COM_QUICK2CART_COUPON_MAXUSES'));?></label>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
			...
			<div class="form-group">
				<label for="max_per_user" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_MAXUSES_PERUSER_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_MAXUSES_PERUSER'), '', Text::_('COM_QUICK2CART_COUPON_MAXUSES_PERUSER'));?></label>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
			...
			<div class="form-group">
				<label for="from_date" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_VALID_FROM_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_VALID_FROM'), '', Text::_('COM_QUICK2CART_COUPON_VALID_FROM'));?></label>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 ">
					<?php
					if ($this->item)
					{
			...
			<div class="form-group">
				<label for="exp_date" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_EXPIRES_ON_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_EXPIRES_ON'), '', Text::_('COM_QUICK2CART_COUPON_EXPIRES_ON'));?></label>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
					<?php
					if ($this->item)
					{
					...
					echo HTMLHelper::_('calendar', $date_exp, 'exp_date', 'exp_date', Text::_('COM_QUICK2CART_DATE_FORMAT_CALENDER'), array('class'=>'col-lg-5 col-md-5 col-sm-5 col-xs-4'));
					?>
				</div>
			</div>

			<div class="form-group">
				<label for="description" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_DESCRIPTION_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_DESCRIPTION'), '', Text::_('COM_QUICK2CART_COUPON_DESCRIPTION'));?></label>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
			...
			<div class="form-group">
				<label for="params" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_PARAMETERS_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_PARAMETERS'), '', Text::_('COM_QUICK2CART_COUPON_PARAMETERS'));?></label>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
