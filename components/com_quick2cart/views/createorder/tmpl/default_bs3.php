...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> container-fluid">
	<form name="createOrder" id="createOrder" class="form-validate form-horizontal" method="post">
		...
		<div class="row">
			<h1>
				<strong>
					<?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_VIEW_TITLE");?>
				</strong>
			</h1>
		</div>
		<div class="row">
			<div class="col-lg-12 alert alert-info">
				<?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_VIEW_INFO");?>
			</div>
		</div>
		<div class="row qtc-createorder-buttons">
			<a
				class="btn btn-primary pull-right qtcMarginLeft col-lg-3"
				onclick="addClient('<?php echo Uri::root();?>', 'addClientModal');jQuery('#addClientModal').removeClass('hide')">
				<i class="icon-user">&nbsp;</i><?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_ADD_CLIENT");?>
			</a>
			...
			<a
				class="btn btn-primary pull-right col-lg-3"
				target="_blank"
				href="<?php echo Route::_( 'index.php?option=com_quick2cart&view=product&Itemid=' . $itemid); ?>">
				<i class=" icon-plus-2 icon22-white22 ">&nbsp;</i><?php echo Text::_("COM_QUICK2CART_POINTS_ADD_PRODUCT_TITLE");?>
			</a>
		</div>
		<div class="clearfix"></div>
		<!-- CODE FOR TABS START-->
			<div>
				<ul class="nav nav-tabs">
					<li id="select-customer-tab" class="active">
						<a href="#qtctab_selectclient" data-toggle="tab"><?php echo Text::_( "COM_QUICK2CART_SELECT_CUSTOMER"); ?></a>
					</li>
					<li id="select-product-tab">
						<a href="#qtctab_addproduct" data-toggle="tab"><?php echo Text::_( "COM_QUICK2CART_SELECT_PRODUCT"); ?></a>
					</li>
				</ul>
				<div class="tab-content row">
					...
					<div class="tab-pane active" id="qtctab_selectclient">
						...
						<div class="control-group">
							...
							<div class="controls">
								<?php echo HTMLHelper::_('select.genericlist', $this->users, "qtcuser", 'class="ad-status input-medium required" size="1" required onchange="showAddresses();" name="qtcuser"', "id", "username");?>
							</div>
						</div>
						<div class="clearfix">&nbsp;</div>
						<div id="qtc_user_addresses" class="row">
							<div class="qtc_user_addresses_wrapper"></div>
						</div>
						<div class="qtcadd_address_button center">
							<a class="btn btn-success" onclick="addAddress('<?php echo JUri::root();?>', 'addAddressModal'); jQuery('#addAddressModal').removeClass('hide')">
						...
						<div class="qtc_next_button center">
							<a class="btn btn-success" onclick="nextstep()"><?php echo Text::_('QTC_NEXT_BUY');?></a>
						</div>
					</div>
					<!-- tab 1 end -->
								...
								<div id="qtc_product_div0" class="qtc_product_div">
									<div class="row">
										<div class="col-lg-3">
											...
											<div>
												<?php echo HTMLHelper::_('select.genericlist', $this->stores, "qtcorder_productdetails[0][store_id]", 'class="ad-status input-medium required qtcorder_select_chosen" required="required" size="1" onchange="qtcpopulateProducts(\'0\');"', "store_id", "title");?>
											</div>
										</div>
										...
										<div class="col-lg-1">
											...
											<input
												...
												class="input input-small qtc-small-input"
												type="number"
												value="">
										</div>
										<div class="col-lg-2 center qtc_prod_price_div">
											<label for="qtc_prod_price0"><?php echo Text::_("QTC_CART_PRICE");?></label>
											<div>
												<span id="qtc_prod_price0" class="">-</span>
											</div>
										</div>
										<div class="col-lg-2">
											<label for="qtc_prod_total0"><?php echo Text::_("QTC_TOTALPRICE");?></label>
											<div>
												<span id="qtc_prod_total_currency0"></span>
												<span id="qtc_prod_total0" class="">-</span>
											</div>
											<input type="hidden" name="qtc_product_total[0][ptotal]" value='0' />
										</div>
										<div id="qtc_remove_Product_button0" class="col-lg-1"></div>
										<div class="row">
											<div id="qtc_product_attributes0" class="col-lg-12"></div>
										</div>
...
-->
						...
						<h3>
							<div class="pull-right qtc-total-order-price">
								<span><?php echo Text::_('COM_QUICK2CART_CREATE_ORDER_TOTAL_ORDER_PRICE');?>&nbsp;</span>
								<span id="qtc_order_total_currency"></span>
								<span>&nbsp;</span>
								<span id="qtc_order_total_price" class="pull-right">-</span>
							</div>
						</h3>
						<div class="clearfix"></div>
						<div class="row">
						...
						<div class="qtc-create-order-buttons center">
							<a onclick="qtcaddMoreProduct();" class="btn btn-sm btn-primary" title="Add More">
								<i class=" icon-plus-2 icon22-white22 "></i><?php echo Text::_('COM_QUICK2CART_CREATE_ORDER_ADD_MORE_PRODUCTS');?>
							</a>
							<a onclick="qtc_place_order();" class="btn btn-sm btn-success">
