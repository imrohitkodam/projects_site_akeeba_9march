	...
	function saveaddress(id)
	{
		...
		techjoomla.jQuery.ajax({
			...
			success: function(data)
			{
				if (data.length == 0)
				{
					alert('<?php echo Text::_('COM_QUICK2CART_CUSTOMER_ADDRESS_WRONG_INPUT');?>');
				} else {
					if (id == '-1')
					{
					...
					window . parent . jQuery('#' + closeAddressModal).modal('hide');
					window . parent . jQuery('.modal-backdrop.fade.in').html('');
					window . parent . jQuery('.modal-backdrop.fade.in').attr('class', '');
				}
			}
		});
	}
...
<div class="container-fluid <?php echo Q2C_WRAPPER_CLASS; ?>">
	<div class="customer_address-edit front-end-edit">
		<h1>
			<?php echo (!empty($this->item->id)) ? Text::_('COM_QUICK2CART_EDIT_CUSTOMER_ADDRESS') : ''; ?>
		</h1>
		<br>
		<form name="formcustomeraddress" id="formcustomeraddress" method="post" class="form-validate form-horizontal" enctype="multipart/form-data" >
			...
			<div class="row">
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('firstname'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('firstname'); ?></div>
				</div>
				<?php
				...
				?>
					<div class="form-group col-md-6 row">
						<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('middlename'); ?></div>
						<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('middlename'); ?></div>
					</div>
				<?php
				}
				?>
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('lastname'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('lastname'); ?></div>
				</div>
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('user_email'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('user_email'); ?></div>
				</div>
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('vat_number'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('vat_number'); ?></div>
				</div>
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('address'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('address'); ?></div>
				</div>
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('land_mark'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('land_mark'); ?></div>
				</div>
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('city'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('city'); ?></div>
				</div>
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('zipcode'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('zipcode'); ?></div>
				</div>
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><?php echo $this->form->getLabel('phone'); ?></div>
					<div class="col-md-8 col-sm-8"><?php echo $this->form->getInput('phone'); ?></div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4">
					...
					<div class="col-md-8 col-sm-8">
						<?php
							...
							echo HTMLHelper::_('select.genericlist',$options,'country_code',' data-chosen="qtc" class="form-select" required="required" onchange=\'generateStoreState(id,"1")\' ','value','text', $default_country);
						?>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-6 row">
					<div class="form-label col-md-4 col-sm-4"><label for="state_code"><?php echo Text::_('QTC_BILLIN_STATE'); ?></label></div>
					<div class="col-md-8 col-sm-8">
							...
							<div class="checkbox">
								...
								<label for="address_terms_condition">
									...
									<?php  echo Text::_('COM_QUICK2CART_ACCEPT_ADDRESS_TERMS_CONDITIONS_FIRST');
										...
										?>
										<a data-target="#privacyPolicyModal" data-toggle="modal" class="">
			...
			<div class="form-group col-md-12">
				<div class="col-md-12">
					...
					if ($this->canSave)
					{ ?>
						<a onclick="saveaddress('<?php echo ($this->item->id)?$this->item->id:'-1';?>')" class="btn af-ml-10 pull-right btn-primary">
							<?php echo Text::_('JSUBMIT'); ?>
						</a>
					<?php
					} ?>
					
					<button type="button" onclick="closeAddressModalFun()" class="btn af-ml-10 pull-right btn-default" title="<?php echo Text::_('JCANCEL'); ?>" data-dismiss="modal" >
