...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>" >
	...
	if($layout=="customerdetails")
	{
		...
		echo $html;
		?>
		<legend><?php echo Text::_('QTC_STORE_CUSTOMER_DETAIL')?></legend>
	...
	*/
	...
	elseif(!$user->id && !$params->get( 'guest' ))
	{
...
if (in_array('billing', $order_blocks))
{
	...
	{ ?>
		<div id="qtc_custinfo">
			<h4 <?php echo $emailstyle;?> ><?php echo Text::_('QTC_CUST_INFO'); ?></h4>
		</div>
	...
	{ ?>
		<div class="well qtc_ordersite" >
			<h4><?php echo Text::_('QTC_BILLIN_INFO'); ?></h4>
	<?php 
	}
	else
	{ ?>
		<fieldset class="qtc_ordersite" >
			<legend><?php echo Text::_('QTC_BILLIN_INFO'); ?></legend>
	<?php 
	} ?>
			<table class="table table-condensed  " >
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_FNAM');?></td>
					<td><?php echo $billinfo->firstname;?></td>
				</tr>
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_LNAM');?></td>
					<td><?php echo $billinfo->lastname;?></td>
				</tr>
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_ADDR');?></td>
					<td><?php echo $billinfo->address;?></td>
				</tr>
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_ZIP');?></td>
					<td><?php echo $billinfo->zipcode;?></td>
				</tr>
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_COUNTRY');?></td>
					<td><?php echo $comquick2cartHelper->getCountryName($billinfo->country_code);?></td>
				</tr>
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_STATE');?></td>
					<td><?php echo $comquick2cartHelper->getStateName($billinfo->state_code);?></td>
				</tr>
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_CITY');?></td>
					<td><?php echo $billinfo->city;?></td>
				</tr>
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_PHON');?></td>
					<td><?php echo $billinfo->phone;?></td>
				</tr>
				<tr>
					<td><?php echo Text::_('QTC_BILLIN_EMAIL');?></td>
...
{
	if (in_array('shipping', $order_blocks))
	{
		if($orders_email)
		{ ?>
		...
		{ ?>
			...
			<h4><?php echo Text::_('QTC_SHIPIN_INFO'); ?></h4>
		<?php
		}
		else
		{ ?>
			<fieldset class="qtc_orderstateinfo" >
				<legend><?php echo Text::_('QTC_SHIPIN_INFO'); ?></legend>
			<?php 
		} ?>
					<table class="table table-condensed  " >
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_FNAM');?></td>
							<td><?php echo $shipinfo->firstname;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_LNAM');?></td>
							<td><?php echo $shipinfo->lastname;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_ADDR');?></td>
							<td><?php echo $shipinfo->address;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_ZIP');?></td>
							<td><?php echo $shipinfo->zipcode;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_COUNTRY');?></td>
							<td><?php echo $comquick2cartHelper->getCountryName($shipinfo->country_code);?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_STATE');?></td>
							<td><?php echo $comquick2cartHelper->getStateName($shipinfo->state_code);?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_CITY');?></td>
							<td><?php echo $shipinfo->city;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_PHON');?></td>
							<td><?php echo $shipinfo->phone;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('QTC_SHIPIN_EMAIL');?></td>
...
<?php
	$comquick2cartHelper = new comquick2cartHelper;
	$view=$comquick2cartHelper->getViewpath('orders', 'default_' . QUICK2CART_LOAD_BOOTSTRAP_VERSION);
	ob_start();
		include($view);
		$html = ob_get_contents();
	ob_end_clean();
