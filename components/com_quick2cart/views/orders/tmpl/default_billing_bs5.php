...
{ ?>
	<div class="mt-4">
		...
		{
		?>
			<h4 <?php echo ($orders_email) ? $emailstyle : '' ; ?>><?php echo Text::_('QTC_CUST_INFO'); ?></h4>
						...
						<tr style="width: 100%; ">
							...
							<td data-title="<?php echo Text::_('QTC_SHIPIN_INFO');?>"  style="<?php echo $emailTdStyle; ?>" class="qtcWordWrap">
								<address>
									<strong>
										<?php
										echo htmlspecialchars($shipinfo->firstname, ENT_COMPAT, 'UTF-8') . ' ';
									...
									<br/>
									<abbr title="<?php echo JText::_('QTC_BILLIN_PHON'); ?>"><?php echo Text::_('QTC_BILLIN_PHON'); ?>:</abbr> <?php echo htmlspecialchars($shipinfo->phone, ENT_COMPAT, 'UTF-8'); ?>
									<br />
									<?php
									...
									{
										echo JText::_('QTC_ORDER_DETAIL_DELIVERY_TIME') . ': ';
										if ($deliveryTimeFormat == 12)
										{
											echo HTMLHelper::date($this->orderinfo->deliveryfromdate, JText::_("COM_QUICK2CART_DATE_FORMAT_SHOW_AMPM")) . ' - ';

											echo HTMLHelper::date($this->orderinfo->deliverytodate, JText::_("COM_QUICK2CART_DATE_FORMAT_SHOW_AMPM"));
										}
										elseif ($deliveryTimeFormat == 24)
										{
											echo HTMLHelper::date($this->orderinfo->deliveryfromdate , 'Y-m-d H:i:s') . ' - ';
											echo HTMLHelper::date($this->orderinfo->deliverytodate , 'Y-m-d H:i:s');
										}
									}?>
								</address>
							</td>
