...
elseif(!$user->id && !$this->params->get( 'guest' ))
{
	...
	$app->redirect(Route::_('index.php?option=com_users&view=login&return=' . $url, false), Text::_('QTC_LOGIN'));
}
?>
				...
				<tr style="vertical-align:middle;border:0;">
					...
					<td style="vertical-align:middle; text-align:right;border:0;">
						<h4 style="margin:0; padding:0;">
							<span><strong><?php echo Text::_('QTC_INVOICE_DATE');?>:</strong></span>
		...
		?>
			...
			<div class="row qtcPadding">
				<div class="" style=" color: gray;">
					<div>
						<b><i><?php echo Text::_('QTC_INVOICE_CONT_INFO'); ?></i></b>
					</div>
					...
					?>
						<div>
							<b><?php echo Text::_('COM_QUICK2CART_INV_STIE_ADDRESS');?></b> :
