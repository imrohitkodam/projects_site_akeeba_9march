...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>" >
	<form action="" name="adminForm" id="adminForm" class="form-validate" method="post">
		...
		<div class="">
			...
			{?>
				<table class="table table-striped table-bordered table-responsive table-hover border" id="productList">
					<thead class="table-primary border table-bordered">
						<tr>
							...
							{
								?>
								<th width="2%" align="center" class="title fw-bold">
