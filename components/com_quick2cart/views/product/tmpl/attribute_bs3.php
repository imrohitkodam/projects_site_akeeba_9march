...
<script type="text/javascript">
	...
	*/
	...
	function addClone(rId,rClass)
	{
		...
		var removeButton="<div class='com_qtc_remove_button pull-left col-xs-12 col-md-1'>";
...
?>
	...
	<div class="" id='no-more-tables'>
		<div class="">
			...
			?>
			<div id=<?php echo $attribute_container_id ?> class="qtc_container qtc_att_hide row af-mt-5" >
				<div class="col-md-11">
					<div class="com_qtc_repeating_block well well-small col-xs-12 col-md-11  com_qtc_img_border">
						...
						$att_list_path = $comquick2cartHelper->getViewpath('product','attribute2_bs3',"SITE","SITE");
						ob_start();
			...
			<?php
				...
				for($i=1;$i<=$count;$i++) // for each attribute
				{
					...
					?>
					<div id=<?php echo $attribute_container_id ?> class="qtc_container row af-mt-5">
						<div class="col-md-11">
							<div class="com_qtc_repeating_block well well-small col-xs-12 col-md-11 com_qtc_img_border">
								<?php
						...
						<div class="col-md-1">
							<div class='com_qtc_remove_button  pull-left col-xs-12 col-md-1 '>
								<button class='btn btn-sm btn-default ' type='button' id='remove<?php echo $i;?>'
			...
			<div class="com_qtc_add_button pull-left  col-xs-12 col-md-offset-11 col-md-1">
