	...
	<div class="row">
		<div class="col-sm-6 col-xs-12 ">
			...
			<div class="form-group">
				<label class="col-xs-12 col-sm-3 control-label" for="qtcmedianame">
			...
			<!-- enable-->
			<div class="form-group">
				<label class="col-xs-12 col-sm-3 control-label" for="qtcmediaStatus">
				...
				<div class="col-xs-12 col-sm-9">
					<label class="checkbox-inline">
						...
						<input
							...
							autocomplete="off" <?php echo $mediastatus;?> ><?php echo Text::_('COM_QUICK2CART_PROD_PAGE_MEDIA_PUBLISHED')?>
					</label>
				</div>
				<div class="qtcClearBoth"></div>
			</div>
			...
			if ($fileUploadMode == 3)
			{
				...
				<div class="form-group qtcMedUploadModeWrapper <?php echo $uploadModeDisplay; ?>" >
					<label class="col-xs-12 col-sm-3 control-label" for="qtcmediaStatus">
			...
			<!-- file upload-->
			<div class="form-group qtcMedUploadWrapper <?php echo !empty($mediaDetail[$m]['file_id'])? 'af-d-none' : ''; ?>">
				<?php
				$qtcFieldType = 'af-d-none';
				...
				if ( $fileUploadMode == 1 || $fileUploadMode == 3 )
				{
					...
					<div class=""  style="margin-left:20px;">
						...
						<div class="progress" id="qtc_progress-barWrapper<?php echo $m ?>">
							<div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 0%" id="qtc_progress-bar<?php echo $m ?>"></div>
						</div>
					</div>
				<?php
				}
				...
				<label class="col-xs-12 col-sm-3 control-label <?php echo $qtcFieldType; ?>" for="qtcmediaStatus">
					<?php echo Text::_( "FILEPATH")?>
				</label>
				<div class="col-xs-12 col-sm-9">
					<input
					type="text"
					class="qtcMediaUpload input-medium <?php echo $qtcFieldType; ?>"
		...
		<div class="col-sm-6 col-xs-12">
			...
			<div class="form-group">
				<label class="col-xs-12 col-sm-5 control-label" for="qtcpurchaseRequire">
			...
			if ($eProdUExpiryMode == 'epMaxDownload' || $eProdUExpiryMode == 'epboth')
			{
				...
				?>
				<div class="form-group <?php echo $hideExpirationFields; ?>">
			...
			if ($eProdUExpiryMode == 'epDateExpiry' || $eProdUExpiryMode == 'epboth')
			{
				...
				<div class="form-group" style="<?php echo $hideExpirationFields; ?>">
					<label class="col-xs-12 col-sm-5 control-label" for="">
