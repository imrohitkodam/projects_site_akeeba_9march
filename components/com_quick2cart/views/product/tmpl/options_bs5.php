...
<script type="text/javascript">
	...
	function addmoreImg(rId,rClass)
	{
		...
		if (remaing_imgs > 0)
		{
			...
			removeButton+="<button class='btn btn-danger btn-sm' style='margin: 0px 3px;' type='button' id='remove"+num+"' onclick=\"removeClone('filediv"+num+"','jgive_container');\" title=\"<?php echo Text::_('COM_Q2C_REMOVE_TOOLTIP');?>\" >";
...
<div class ="form-horizontal">
	...
	<div class='qtc_title_textbox form-group row' >
		...
		<label for="item_name" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_TITLE_DES')?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_TITLE'), '', Text::_('QTC_PROD_TITLE'). ' *');?>
		</label>
		<?php
		...
		<div class="col-sm-9 col-xs-12">
			<input
				...
				name="item_name"
				id="item_name"
				value="<?php echo $this->escape($p_title);?>" />
		</div>
	</div>
	<div class='form-group row'>
		<label for="item_alias" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_ALIAS_DES')?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_ALIAS'), '', Text::_('QTC_PROD_ALIAS'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<input
				type="text"
				...
				name="item_alias"
				id="item_alias"
				value="<?php echo (!empty($this->itemDetail['alias']))?$this->escape($this->itemDetail['alias']):'';  ?>" >
		</div>
	</div>
	<?php
		...
		{
			$prodTypeStyle = ($isStockEnabled == 1) ? '' : "d-none;";
		}
	?>
	<div class="form-group row <?php echo $prodTypeStyle ?>">
		<label for="qtc_product_type" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_SEL_TYPE_TOOLTIP')?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_SEL_TYPE'), '', Text::_('QTC_PROD_SEL_TYPE'). ' *');?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<?php
			if ($productType != 2)
			{
				echo HTMLHelper::_('select.genericlist',$this->product_types,'qtc_product_type','class="form-select required"','value','text',$productType,'qtc_product_type');
			}
			else
			{
			?>
				...
				<span class="badge af-bg-success">
					<?php echo $this->product_types[$productType]->text; ?>
				</span>
				<?php
			}
	...
	<div class="form-group row">
		<label for="prod_cat" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_SEL_CAT_TOOLTIP')?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_SEL_CAT'), '', Text::_('QTC_PROD_SEL_CAT'). ' *');?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<?php
			if (!empty($this->isAllowedtoChangeProdCategory))
			{
				...
				<span class="badge af-bg-success"><?php echo $this->catName . " "; ?></span>
				<?php
			}
			else
			{
	...
	{
		?>
		<div class="form-group row <?php (count($this->store_role_list)) ? "" : "d-none;" ?>">
			<label for="qtc_store" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_SELECT_STORE_DES')?>">
				<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_SELECT_STORE'), '', Text::_('QTC_PROD_SELECT_STORE'));?>
			</label>
			<div class="col-sm-9 col-xs-12">
				<?php
				 $defaultStore = (!empty($this->itemDetail['store_id']))? $this->itemDetail['store_id']:$this->store_role_list[0]['store_id'];
					...
					echo $this->dropdown = HTMLHelper::_('select.genericlist',$options,'store_id','class="form-select qtc_putmargintop10px"   onchange="getTaxprofile();" ','value','text',$defaultStore,'current_store_id');
				?>
			</div>
		</div>
	<?php
	...
	<!-- sku -->
	<div class="form-group row">
		<label for="qtc_sku" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_SKU_TOOLTIP');?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_SKU'), '', Text::_('QTC_PROD_SKU'). ' *');?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<?php
	...
	<div class="form-group row">
		<label for="qtc_product_tag" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_TAG_TOOLTIP')?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_TAG'), '', Text::_('QTC_PROD_TAG'));?>
		</label>
		<div class="col-sm-9 col-xs-12 controls">
			...
			echo HTMLHelper::_('select.genericlist',$options,'jform[tags][]','multiple class="form-select chosen-select"','value','text',$defaultTags,'jform_tags');
		?>
		</div>
	</div>
	<?php
	...
	{?>
		...
		<div class='form-group row' >
			<label for="state" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_STATUS');?>">
				<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_STATUS_DES'), '', Text::_('QTC_PROD_STATUS'));?>
			</label>
			<div class="col-sm-9 col-xs-12">
				<label class="radio-inline">
					<?php
					$isPublished   = (!empty($this->itemDetail) && ($this->itemDetail['state'] == 0)) ? "" : " checked ";
					$isUnPublished = (!empty($this->itemDetail) && ($this->itemDetail['state'] == 0)) ? " checked " : "";
					?>
	...
	<div class='form-group row qtc_currencey_textbox'>
		<label for="price_<?php echo !empty($curr[0]) ? $curr[0] : '' ;?>" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('COM_QUICK2CART_ITEM_PRICE_DESC')?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_ITEM_PRICE'), '', '* ' . Text::_('QTC_ITEM_PRICE'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<?php
			$currdata         = array();
				...
				<?php if ($multiCurrencies) : ?>
					<div class="row">
						<div class="  curr_margin">
							<label for="price_<?php echo trim($value);?>" class="col-sm-2 col-xs-12" title="<?php echo Text::_('COM_QUICK2CART_ITEM_PRICE_DESC')?>">
								<?php echo HTMLHelper::tooltip('', Text::_('QTC_ITEM_PRICE'), '', Text::_('QTC_ITEM_PRICE') . ' ' . Text::_('COM_QUICK2CART_IN') . ' ' . trim($currtext));?> &nbsp;
							</label>
							<div class="col-sm-2 col-xs-12 input-group col-md-10">
	...
	<!-- DISCOUNT PRICE -->
	<div class='form-group row qtc_currencey_textbox <?php echo (($this->params->get('usedisc') == '0') ? 'd-none;' : ''); ?>' >
		<label for="disc_price_<?php echo !empty($curr[0]) ? $curr[0] : '' ;?>" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('COM_QUICK2CART_ITEM_DIS_PRICE_DESC');?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_ITEM_DIS_PRICE'), '', Text::_('QTC_ITEM_DIS_PRICE'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<?php
			$currdata = array();
			...
			foreach ($curr as $key=>$value)
			{
				...
				<?php if ($multiCurrencies) : ?>
					<div class="row">
						<div class="curr_margin">
							<label for="disc_price_<?php echo trim($value);?>" class="col-sm-2 col-xs-12" title="<?php echo Text::_('COM_QUICK2CART_ITEM_DIS_PRICE_DESC')?>">
								<?php echo HTMLHelper::tooltip('', Text::_('QTC_ITEM_DIS_PRICE'), '', Text::_('COM_QUICK2CARET_PRICE') . ' ' . Text::_('COM_QUICK2CART_IN') . ' ' . trim($currsymbol));?> &nbsp;
							</label>
	...
	<!--  PROD description -->
	<div class="form-group row">
		<label for="description" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_DES_TOOLTIP');?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_DES'), '',Text::_('QTC_PROD_DES'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<?php
	...
	<div class="form-group row imagediv" id="imagediv">
		<label for="avatar" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_PROD_IMG_TOOLTIP')?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_PROD_IMG'), '', Text::_('QTC_PROD_IMG'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<?php
			...
			<div class="form-inline">
				...
				<div class="filediv" id="filediv">
					<span>
						<input type="file" name="prod_img" id="avatar" class="form-control af-d-inline" placeholder="<?php echo Text::_('COM_QUICK2CART_IMAGE_MSG');?>" accept="image/*, video/*">
					</span>
				</div>
	...
	{
		$qtc_stock_style = ($this->params->get('usestock')==1) ? "" :"d-none";
	?>
		<div class="form-group row <?php echo $qtc_stock_style;?>">
			<label for="stock" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('COM_QUICK2CART_ITEM_STOCK_DESC');?>">
				<?php echo HTMLHelper::tooltip('', Text::_('PLG_QTC_ITEM_STOCK'), '', Text::_('PLG_QTC_ITEM_STOCK'));?>
			</label>
			<div class="col-sm-9 col-xs-12">
				...
				class="form-control input-mini validate-integer" />
				<?php
				if ($productType == 2)
				{ ?>
	...
	<div class="form-group row <?php echo $qtc_min_max_style;?>">
		<label class="col-sm-3 col-xs-12 form-label" for="item_slab" title="<?php echo Text::_('COM_QUICK2CART_ITEM_SLAB_DESC');?>">
			<?php echo HTMLHelper::tooltip('', Text::_('COM_QUICK2CART_ITEM_SLAB'), '', Text::_('COM_QUICK2CART_ITEM_SLAB'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<input Onkeyup="checkforalpha(this,'', '<?php echo addslashes($entered_numerics); ?>')"  Onchange="checkSlabValue();" type="text" name="item_slab" id="item_slab"  value="<?php echo isset($minmaxstock) ? $minmaxstock->slab: 1  ?>" class="form-control input-mini validate-integer"  >
		</div>
	</div>

	<div class="form-group row <?php echo $qtc_min_max_style;?>">
		<label for="min_item" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('COM_QUICK2CART_ITEM_MIN_QTY_DESC');?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_ITEM_MIN_QTY'), '', Text::_('QTC_ITEM_MIN_QTY'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
	...
	<div class="form-group row <?php echo $qtc_min_max_style;?>">
		<label for="max_item" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('COM_QUICK2CART_ITEM_MAX_QTY_DESC');?>">
			<?php echo HTMLHelper::tooltip('', Text::_('QTC_ITEM_MAX_QTY'), '', Text::_('QTC_ITEM_MAX_QTY'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<input 
	...
	<div class="form-group row">
		<label class="col-sm-3 col-xs-12 form-label" for="metadesc" title="<?php echo Text::_('COM_QUICK2CART_META_DESC_TOOLTIP');?>">
			<?php echo HTMLHelper::tooltip('', Text::_('COM_QUICK2CART_META_DESC'), '', Text::_('COM_QUICK2CART_META_DESC'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<div>
	...
	<div class="form-group row">
		<label class="col-sm-3 col-xs-12 form-label" for="metakey" title="<?php echo Text::_('COM_QUICK2CART_META_KEYWORDS_TOOLTIP')?>">
			<?php echo HTMLHelper::tooltip('', Text::_('COM_QUICK2CART_META_KEYWORDS'), '', Text::_('COM_QUICK2CART_META_KEYWORDS'));?>
		</label>
		<div class="col-sm-9 col-xs-12">
			<div class="">
