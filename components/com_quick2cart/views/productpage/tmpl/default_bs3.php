...
$prodViewPath   = $comquick2cartHelper->getViewpath('product', 'product_bs3');
$pepoleViewPath = $comquick2cartHelper->getViewpath('product', 'pepole_bs3');
	...
	?>
		...
		<div class="row" itemscope itemtype="http://schema.org/Product">
								...
								<div>
									...
									if ($this->itemdetail->featured=='1')
									{
										...
										<span class="pull-left">
											<img title="<?php echo Text::_('QTC_FEATURED_PROD')?>"
												src="<?php echo Uri::base().'components/com_quick2cart/assets/images/featured.png'; ?>"/> &nbsp;
										</span>
										<?php
									}
									?>
								...
								if (! empty($this->itemdetail->store_id) && ! empty($multivendor_enable))
								{
									...
									<div class="" itemprop="brand" itemscope itemtype="http://schema.org/Brand">
										...
										<a title="<?php echo Text::_('QTC_CONTACT_STORE_OWN')?>"
											...
											data-toggle="modal" data-target="#sendEnquiryModal"
											href="javascript:;">
										...
										<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
											...
											<div class="carousel-inner q2cProdImgWrapper" role="listbox">
												...
												foreach ($images as $image)
												{
													...
													$ogImg = $img_big;
													?>
													<div class="item <?php if ($i == 0) {echo 'active';} ?>"><?php
														if ($this->videoGallery && in_array($media_extension, $this->videoSupportedExtension))
														{
															?>
											...
											<a class="left carousel-control qtcCarouselControl"  href="#myCarousel" role="button" data-slide="prev">
												<span class="<?php echo Q2C_ICON_ARROW_CHEVRON_LEFT ; ?> qtcPreIcon" aria-hidden="true"></span>
												<span class="sr-only">Previous</span>
											</a>
											<a class="right carousel-control qtcCarouselControl" href="#myCarousel" role="button" data-slide="next">
												<span class="<?php echo Q2C_ICON_ARROW_CHEVRON_RIGH ; ?> qtcNextIcon" aria-hidden="true"></span>
					...
					<div class="<?php echo $prod_divSize;?> qtc_prod_blog_page-bs3">
						...
						<div class="form-horizontal" id="<?php echo $this->item_id;?>_item" style="width: auto;">
							...
							<div class="form-group">
								<label class="col-xs-6 col-sm-4 qtc-control-label">
									<strong><?php echo Text::_('QTC_ITEM_AMT')?></strong>
								</label>
								<div class="col-xs-6 col-sm-8  qtc_controls_text">
									<span id="<?php echo ( (isset($this->price['price'])) ? $this->product_id.'_price' :'' );?>">
										<?php echo ($discount_present == 1) ? '<del>' . $comquick2cartHelper->getFromattedPrice($this->price['price']) . '</del>' : $comquick2cartHelper->getFromattedPrice($this->price['price']);?>
									</span>
								</div>
							</div>
							...
							if ( $discount_present)
							{
								...
								<div class="form-group">
									...
									<div class="col-xs-6 col-sm-8 qtc_controls_text" itemprop="offers"
							...
							if ($this->showBuyNowBtn)
							{
								...
								?>
								<div style="<?php echo $qtyDivStyle;?>" class="form-inline q2c-inline-flex">
									...
									<div class="q2c-item-to-cart-section-<?php echo $data->product_id;?>" <?php echo $showQtyToCartSecStyle;?>>
										<button class="btn btn-success q2c-small-buy-button qtc_left_margin" type="button" <?php echo $disableBuyBtn; ?> onclick="qtc_addtocart('<?php echo $fun_param; ?>');">
										...
										<?php
											...
											$modalConfig = array('width' => '950px', 
											'height' => '800px', 
											'closeButton' => false, 
											'url'        => $cartlink,
											'modalWidth' => 80, 
											'bodyHeight' => 70);
											echo HTMLHelper::_('bootstrap.renderModal', 'cartModal', $modalConfig);
										?>
									</div>
									<div class="clearfix"></div>
								</div>
								...
								{
									?>
									<h4><?php echo Text::_("COM_QUICK2CART_AVAILABLE_OFFERS");?></h4>
										...
										foreach ($this->applicablePromotions as $promotion)
										{
											...
											<?php
												if ($promotion->coupon_required== '1' && $promotion->catlog_promotion== '1')
												{
													...
													{
														?>
															<h5><?php echo Text::_("QTC_CUPCODE") . " : ";?><span class="qtc-applicable-promotions"><?php echo $promotion->coupon_code;?></span></h5>
														<?php
													}
													...
													{
														?>
															<h5><?php echo Text::_("QTC_PROMO_EXP_DATE") . " : ";?><span class="qtc-applicable-promotions"><?php echo $promotion->exp_date;?></span></h5>
														<?php
													}
													?>
							...
							else
							{
								...
								<div class="alert alert-warning">
									...
									<strong><?php echo Text::_('QTC_WARNING'); ?></strong><?php echo Text::_('QTC_OUT_OF_STOCK_MSG'); ?>
								</div>
								<?php
							}
							?>
				...
				{?>
					...
					<div class="row">
						<div class="col-sm-12 col-lg-12 col-md-12 af-mt-20">
							<ul class="nav nav-tabs af-d-flex qtc__scrollTab">
			...
			if ($this->prodFromCat )
			{
				...
				<div>
					<div class="col-xs-12">
						<h4 class="sectionTitle"><?php echo Text::sprintf('QTC_SIMILAR_CAT_PRODUCTS', Text::_(trim($prodCatName))); ?></h4>
						...
						foreach ($this->peopleWhoBought as $data)
						{
							...
							if ($i == $who_bought_limit)
							{
								...
								$modalConfig = array('width' => '700px', 
									...
									'modalWidth' => 80, 
									'bodyHeight' => 70);
								$modalConfig['url'] = 'index.php?option=com_quick2cart&view=productpage&layout=users_bs3&itemid=' . $this->item_id . '&tmpl=component';
								echo HTMLHelper::_('bootstrap.renderModal', 'showMoreModal', $modalConfig);
								echo '<a data-target="#showMoreModal" data-toggle="modal" class="">' . 
