...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> my_promotions bs5Loaded">
	<form action="<?php echo Route::_('index.php?option=com_quick2cart&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm" class="form-validate">
						...
						<div class="col-md-12 col-lg-12 form-horizontal">
							<fieldset class="adminform">
								...
								<div class="form-group row mt-2">
									<label for="store_id" class="col-md-4 col-sm-3 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_STORE_ID');?>">
								...
								<div class="form-group row mt-2">
									<label for="jform_name" class="col-md-4 col-sm-3 col-xs-12 control-label">
									...
									<div class="col-md-8 col-sm-9 col-xs-12">
										<textarea class="form-control" type="text" name="jform[name]" id="jform_name"  aria-invalid="false"><?php echo $this->item->name;?></textarea>
									</div>
								</div>
								<div class="form-group row mt-2">
									<label for="jform_description" class="col-md-4 col-sm-3 col-xs-12 control-label">
										<span class="hasTooltip" title="" data-original-title="<strong>
									...
									<div class="col-md-8 col-sm-9 col-xs-12 ">
										<textarea class="form-control" type="text" name="jform[description]" id="jform_description" class="textarea" aria-invalid="false" rows="4" cols="50"><?php echo $this->item->description;?></textarea>
									</div>
								</div>
								<div class="form-group row mt-2">
									<label for="state" class="col-md-4 col-sm-3 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_PUBLISHED');?>">
										<?php echo HTMLHelper::tooltip(
											'',
								...
								<div class="form-group row mt-2">
									<label for="jform_from_date" class="col-md-4 col-sm-3 col-xs-12 control-label">
										<span class="hasTooltip" title="" data-original-title="<strong>
								...
								<div class="form-group row mt-2">
									<label for="jform_exp_date" class="col-md-4 col-sm-3 col-xs-12 control-label"><span class="hasTooltip"
								...
								<div class="form-group row mt-2">
									<label for="jform_allowspecificuserpromotion" class="col-md-4 col-sm-3 col-xs-12 control-label"><span class="hasTooltip"
										title="" data-original-title="<strong>
										<?php echo Text::_("COM_QUICK2CART_ALLOW_SPECIFIC_USER_PROMOTION");?></strong><br />
										<?php echo Text::_("COM_QUICK2CART_ALLOW_SPECIFIC_USER_PROMOTION");?>">
										<?php echo Text::_("COM_QUICK2CART_ALLOW_SPECIFIC_USER_PROMOTION");?></span></label>
									<div class="col-md-8 col-sm-9 col-xs-12">
										<?php echo $this->form->getInput('allowspecificuserpromotion'); ?>
									</div>
								</div>
								<div class="form-group row mt-2">
									<label for="jform_orderamount" class="col-md-4 col-sm-3 col-xs-12 control-label"><span class="hasTooltip"
										title="" data-original-title="<strong>
										<?php echo Text::_("COM_QUICK2CART_ENTER_ORDER_AMOUNT");?></strong><br />
										<?php echo Text::_("COM_QUICK2CART_ENTER_ORDER_AMOUNT");?>">
										<?php echo Text::_("COM_QUICK2CART_ENTER_ORDER_AMOUNT");?></span></label>
									<div class="col-md-8 col-sm-9 col-xs-12">
										<?php echo $this->form->getInput('orderamount'); ?>
									</div>
								</div>	
								<div class="form-group row mt-2">
									<label for="coupon_required" class="col-md-4 col-sm-3 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_COUPON_REQUIRED');?>">
										<?php echo HTMLHelper::tooltip(
											'', Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_COUPON_REQUIRED'),
								...
								<div class="form-group row mt-2">
									<label for="discount_type" class="col-md-4 col-sm-3 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_VAL_TYPE');?>">
										<?php echo HTMLHelper::tooltip(
											'', Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_VAL_TYPE'), '',
								...
								<div class="form-group row mt-2">
									<label for="discount<?php echo !empty($curr[0]) ? $curr[0] : '';?>" class="col-md-4 col-sm-3 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_VALUE');?>">
										<?php echo HTMLHelper::tooltip(
											'',
											Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_VALUE'), '', Text::_('COM_QUICK2CART_FORM_LBL_PROMOTION_VALUE')
										);?>
										<span class="star">&nbsp;*</span>
									</label>
									<div class="col-md-8 col-sm-9 col-xs-12">
													...
													<div class="row">
														<?php if (count($currency) > 1)
														{
															...
															<label for="qtc_discount<?php echo trim($value);?>"
															 class="col-lg-3 col-sm-4 col-xs-6 qtc_currency_price_discount_lbl1 " title="<?php echo Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_VALUE');?>">
																<?php echo HTMLHelper::tooltip(
																	'',
														...
														<div class="input-group curr_margin col-lg-12">
															...
															<div class="input-group-text"><?php echo $currsymbol;?></div>
														</div>
													</div>
											<?php
											}
										...
										<div class="qtc-promotion-percent-discount-div">
											<input type="text" class="form-control currtext" Onkeyup= "checkforalpha(this,46,<?php echo $entered_numerics; ?>);" name="qtc_discount[percent]" value="<?php echo $this->discount[0]['discount'];?>" class="form-control"/>
										</div>
									</div>
								</div>
								<div class="qtc-promotion-discount-type-dependent">
									<div class="form-group row qtc_currencey_textbox">
										<label for="discount<?php echo !empty($curr[0]) ? $curr[0] : '';?>" class="col-md-4 col-sm-3 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_MAX_DISCOUNTS');?>">
											<?php echo HTMLHelper::tooltip(
												'',
												Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_MAX_DISCOUNTS'), '', Text::_('COM_QUICK2CART_FORM_LBL_PROMOTION_MAX_DISCOUNTS')
											);?>
										</label>
										<div class="col-md-8 col-sm-9 col-xs-12">
											<?php
											foreach ($currency as $key => $value)
											{
												...
												?>
													<div class="input-group curr_margin">
														<label for="price_<?php echo trim($value);?>" class="col-md-4 col-sm-2 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_ITEM_PRICE_DESC');?>">
															<?php echo HTMLHelper::tooltip(
																'',
																Text::_('COM_QUICK2CART_ITEM_PRICE_DESC'), '', Text::_('QTC_ITEM_PRICE') . ' ' . Text::_('COM_QUICK2CART_IN') . ' ' . trim($currsymbol)
																);?> &nbsp;
														</label>
														<div class="col-md-4 col-sm-2 col-xs-12 input-group">
															<input
																...
																Onkeyup= "checkforalpha(this,46,<?php echo $entered_numerics; ?>);"
																placeholder="<?php echo trim($currsymbol);?>" />
															<span class="input-group-text"><?php echo $currsymbol;?></span>
														</div>
												...
												{
												?>
													<div class="col-md-4 col-sm-2 col-xs-12 input-group curr_margin">
														<input
								...
								<div class="qtc-promotion-coupon-dependent">
									<div class="form-group row mt-2">
										<label for="jform_coupon_code" class="col-md-4 col-sm-3 col-xs-12 control-label">
											<span class="hasTooltip" title="" data-original-title="<strong>
										...
										<div class="col-md-8 col-sm-9 col-xs-12 condition-req">
											<input type="text" name="jform[coupon_code]" id="jform_coupon_code"  value="<?php echo $this->item->coupon_code;?>" aria-invalid="false" class="form-control"/>
										</div>
									</div>
									<div class="form-group row mt-2">
										<label for="jform_max_use" class="col-md-4 col-sm-3 col-xs-12 control-label">
											<span class="hasTooltip" title="" data-original-title="<strong>
										...
										<div class="col-md-8 col-sm-9 col-xs-12">
											<input type="text" name="jform[max_use]" id="jform_max_use"  value="<?php echo !empty($this->item->max_use) ? $this->item->max_use : 0; ?>" aria-invalid="false" class="form-control"/>
										</div>
									</div>
									<div class="form-group row mt-2">
										<label for="jform_max_per_user" class="col-md-4 col-sm-3 col-xs-12 control-label">
										...
										<div class="col-md-8 col-sm-9 col-xs-12">
											<input type="text" name="jform[max_per_user]" id="jform_max_per_user"  value="<?php echo !empty($this->item->max_per_user) ? $this->item->max_per_user : 0; ?>" class="form-control"/>
										</div>
									</div>
									<div class="form-group row mt-2">
										<label for="jform_catlog_promotion" class="col-md-4 col-sm-3 col-xs-12 control-label" title="<?php echo Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_CATLOG_PROMOTION');?>">
											<?php echo HTMLHelper::tooltip(
												'', Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_CATLOG_PROMOTION'),
										...
										<div class="col-md-8 col-sm-9 col-xs-12">
											...
											<label class="radio-inline" for="catlog_promotion0">
												<input class="btn" type="radio" id="catlog_promotion0" name="jform[catlog_promotion]"<?php echo empty($this->item->catlog_promotion)?'checked="checked"':'';?> value="0"/>
												<?php echo Text::_("JNO");?>
											</label>
										</div>
									</div>
		...
		<?php   echo HTMLHelper::_('uitab.endTab'); ?>
						...
						<div id="qtc-promotion-condition-div-cloneprimary" class="qtc-promotion-condition-div-clone" style="display:none;">
							<div class="row mt-1">
								...
								<div class="col-md-2">
									...
									<select id="conditions_onprimary" name="rule[conditions][primary][condition_on_attribute]" class=" q2c-inline form-select" onchange="checkOperation('primary')">
										...
										<div class="row">
											...
											<div class="col-md-9">
												<span id="conditions_operation_divprimary">
													<select id="conditions_operationprimary" name="rule[conditions][primary][operation]" class=" q2c-inline form-select">
								...
								<div class="col-md-12 mb-2">
									...
									<div id="qtc-add-quantity-condition-divprimary">
										<div id="qtc-add-quantity-conditionprimary" class="qtc-add-quantity-condition-padding-left row">
					...
					<span id="qtc-condition-attribute-value-primary-div">
						<span id="qtc-condition-attribute-value-primary-divclone" class="input-group" style="display:none;">
							<input
								...
								class="qtc_condition_attribute_value q2c-inline form-control"
								readonly="true" />
							...
							<a
								class="qtcHandPointer input-group-text openSelectorWithModule"
						...
						<span id="qtc-cart-amount-currency-primary-div">
							...
							foreach ($currency as $key => $value)
							{
								...
								<span class="curr_margin   q2c-inlineblock">
									<div style="display: none;">
										<label for="conditions_primary_currency_value_<?php echo $value;?>">
											<?php echo Text::_("QTC_AMOUNT");?>
										</label>
									</div>
			...
			<?php 
				echo HTMLHelper::_('uitab.addTab', 'promotions', 'conditions', Text::_('COM_QUICK2CART_FORM_DESC_PROMOTION_CONDITION', true)); ?>
					<div class="row">
						<div class="col-md-12">
							...
							<span id="qtc-promotion-condition-compulsory" class="q2c-inlineselect">
								<?php echo HTMLHelper::_('select.genericlist', $condition_type,'conditions_compulsory','class="form-select"','value','text',(!empty($this->conditionList[0]->is_compulsary)?$this->conditionList[0]->is_compulsary:''),'conditions_compulsory');?>
							</span>
							<span class="h4">
										...
										<div id="qtc-promotion-condition-div-clone<?php echo $condition->id;?>" class="qtc-promotion-condition-div-clone">
											...
											<div class="row">
												...
												<div class="col-md-2">
													...
													<select id="conditions_on<?php echo $condition->id;?>" name="rule[conditions][<?php echo $condition->id;?>][condition_on_attribute]" class=" q2c-inline form-select" onchange="checkOperation('<?php echo $condition->id;?>')">
												...
												<div class="col-md-3">
													<span id="conditions_operation_wrapper<?php echo $condition->id;?>">
															...
															<div class="row">
																...
																<div class="col-md-9">
																	<span id="conditions_operation_div<?php echo $condition->id?>">
																		<select id="conditions_operation<?php echo $condition->id?>" class=" q2c-inline form-select" name="rule[conditions][<?php echo $condition->id?>][operation]">
														...
														?>
															<span>
																<?php echo Text::_("COM_QUICK2CART_PROMOTION_CONDITION_IN");?>
															</span>
														<?php
														}
														?>
													...
													?>
														<span id="currency_wrapper<?php echo $condition->id;?>">
															<span id="currency_div<?php echo $condition->id;?>" class="input-group">
																<input
																	type="text" <?php echo ($condition->condition_on_attribute == 'quantity_in_store_cart')?"":"readonly='true'";?>
																	name="rule[conditions][<?php echo $condition->id;?>][condition_attribute_value]" 
																	required="required"
																	id="rule_conditions_<?php echo $condition->id;?>_condition_attribute_value"
																	class="qtc_condition_attribute_value required q2c-inline form-control"
																	value="<?php echo ($condition->condition_on_attribute == 'cart_amount')?"":$conditionAttributeValue;?>" />
																...
																<a
																	class="qtcHandPointer input-group-text openSelectorWithModule <?php echo ($condition->condition_on_attribute == 'quantity_in_store_cart') ? "af-d-none" : "";?>"
												...
												<div class="col-md-12 mt-1 mb-1">
													<div id="qtc-add-quantity-condition-div<?php echo $condition->id;?>">
														<div id="qtc-add-quantity-condition<?php echo $condition->id;?>" class="qtc-add-quantity-condition-padding-left row">
															<?php
															if (($condition->condition_on_attribute == 'category' || $condition->condition_on_attribute == 'item_id'))
															{
																if (!empty($condition->quantity))
																{
																	...
																	<span id="conditions_operation_div<?php echo $condition->id?>" class="col-md-2">
																		<select id="conditions_operation<?php echo $condition->id;?>" name="rule[conditions][<?php echo $condition->id;?>][operation]" class=" q2c-inline form-select">
																			<option value="=" <?php echo ($condition->operation == '=')?'selected="true"':'';?>>
																				<?php echo Text::_("COM_QUICK2CART_PROMOTION_CONDITION_EQUAL_TO");?>
																			</option>
																			<option value="<" <?php echo ($condition->operation == '<')?'selected="true"':'';?>>
																	...
																	<div class="col-md-2">
																		...
																		<input type='number' Onkeyup= "checkforalpha(this,46,<?php echo $entered_numerics; ?>);" id='rule_conditions_<?php echo $condition->id;?>_quantity' name='rule[conditions][<?php echo $condition->id;?>][quantity]' class='required qtc_condition_quantity q2c-inline form-control ' required='required' value="<?php echo $condition->quantity;?>" />
																	</div>
																	<div class="col-md-2">
			...
			<div class="qtc-button-top-margin">
				<input
					type="button"
