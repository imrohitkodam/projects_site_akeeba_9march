...
<legend><?php echo Text::_( "COM_QUICK2CART_CREATE_NEW_USER");?></legend>
	<div class="container">
		<div class="form-horizontal">
			...
			<div class="form-group row mt-2">
				<label class="form-label col-md-4" for="username">
			...
			<div class="form-group row mt-2">
				<label class="form-label col-md-4" for="password1">
			...
			<div class="form-group row mt-2">
				<label class="form-label col-md-4" for="password2">
			...
			<div class="form-group row mt-2">
				<label class="form-label col-md-4" for="emailid">
			...
			<div class="row mt-2">
				<div class="col-sm-12">
					<button id="viewMoreRec" class="btn btn-primary validate float-end ms-2" type="button" onclick="adduser()">
						<?php echo Text::_('COM_QUICK2CART_REGISTRE');?>
					</button>
					<a
						class="btn btn-default float-end ms-2 "
						onclick="window.parent.document.getElementById('addClientModal').close();"
