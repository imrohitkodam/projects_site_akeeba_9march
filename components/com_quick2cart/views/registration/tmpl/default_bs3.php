...
if (!$user->id)
{
	...
	<div id="qtc_user-info" class="com_quick2cart-checkout-steps " style="<?php echo $registorStyle; ?>">
		<div class="checkout-heading">
			...
			<span id="" class="qtcHandPointer btn btn-xs btn-primary pull-right" onclick="qtc_hideShowLoginTab('qtc_user-info-content', 'qtc_ckout_billing-info')">
		...
		<div id="qtc_user-info-content" class="container-fluid">
			<div class="row" >
				...
				<div id="login" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<br />
					<br />
					<input type="button" value="<?php echo Text::_('COM_QUICK2CART_CHECKOUT_LOGIN'); ?>" id="button-login" class="button btn btn-default " onclick="qtc_ckpg_login(this)"/><br />
					<br />
				</div>
			</div>
			<hr/>
			<div class="row">
				<div class="col-xs-12">
					<input type="button" class=" btn  btn-primary" id="button-user-info" value="<?php echo Text::_('COM_QUICK2CART_CONTINUE');?>" onclick="qtc_guestContinue('qtc_user-info-content')">
				</div>
				<div class="clearfix"></div>
				<br />
			</div>
