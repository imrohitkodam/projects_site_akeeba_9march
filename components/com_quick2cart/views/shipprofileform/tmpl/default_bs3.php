...
<script type="text/javascript">
	...
	{
		jQuery('#setShipProfileMethodRuleModal_'+id).attr('style' , 'display:flex !important; flex-direction: column; align-items: center;');
					...
					<tbody id="qtcShipMethTableBody">
						...
						foreach ($this->shipMethods as $meths)
						{
							...
							<tr>
								...
								<td>
									<button class="btn btn-sm btn-primary" type="button" onclick="toggleSetShipProfileMethodRuleModal('<?php echo $meths->id ?>');" data-toggle="modal" data-target="setShipProfileMethodRuleModal_"<?php echo $meths->id; ?>>
										<?php echo Text::_('COM_QUICK2CART_SHIPPROFIL_METH_EDIT'); ?>
									</button>
									<?php
										$setShipProfileMethodRulelink = Route::_("index.php?option=com_quick2cart&view=shipprofileform&layout=setrule_bs3&id=" . $meths->shipprofile_id. "&shipmethId=" . $meths->id . "&tmpl=component");
