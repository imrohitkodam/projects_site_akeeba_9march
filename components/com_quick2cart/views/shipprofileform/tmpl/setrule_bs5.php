...
function qtc_updateShipMethod()
{
	...
	techjoomla.jQuery.ajax({
		type : "POST",
		url : Joomla.getOptions('system.paths').base + "/index.php?option=com_quick2cart&view=shipprofileform&task=shipprofileform.updateShipMethod&tmpl=component",
		data : data,
		dataType: "json",
		beforeSend: function()
		{
...
<div class=" <?php echo Q2C_WRAPPER_CLASS; ?> container-fluid">
	<div class="" id="no-more-tables">
		...
		<input
			type="hidden"
			name="qtcShipProfileId"
			id="qtcShipProfileId"
			value="<?php echo $this->qtcShipProfileId; ?>" />

		<!-- Map the tax rule aginst tax profile -->
		<table class="table table-striped table-bordered">
			<tr>
				<td data-title="<?php echo Text::_('COM_QUICK2CART_SHIPPROFILE_PROVIDER');?>">
					<?php echo $this->shipPluglist; ?>
				</td>
				<td data-title="<?php echo Text::_('COM_QUICK2CART_SHIPPROFILE_METHOD');?>">
