...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> container-fluid">
	<form action="" method="post" name="adminForm" id="adminForm">
		...
		<div class="row">
			<h1>
				<strong>
					<?php echo Text::_('COM_QUICK2CART_SHIPPROFILE_S_MANAGE_LIST_LEGEND'); ?>
				</strong>
			</h1>
		...
		<div id="qtc-filter-bar" class="qtc-btn-toolbar">
			...
			<div class="qtc-btn-group pull-right hidden-xs q2c-btn-wrapper">
				<?php echo HTMLHelper::_('select.genericlist', $this->publish_states, "filter_published", 'class=""  onchange="document.adminForm.submit();" name="filter_published"', "value", "text", $this->state->get('filter.state'));?>
			</div>
			<div class="qtc-btn-group pull-right hidden-xs q2c-btn-wrapper">
				<?php echo HTMLHelper::_('select.genericlist', $this->stores, "filter_store", 'class=""  onchange="document.adminForm.submit();" name="filter_store"', "id", "title", $this->state->get('filter.stores'));?>
			</div>
		</div>
		<div class="clearfix"></div>
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td>
								<?php if (isset($item->checked_out) && $item->checked_out) : ?>
									<?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'shipprofiles.', $canCheckin); ?>
								<?php endif; ?>
								<?php if ($canEdit) : ?>
