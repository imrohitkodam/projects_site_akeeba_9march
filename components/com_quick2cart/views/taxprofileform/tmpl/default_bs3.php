...
<script type="text/javascript">
	...
	{
		jQuery('#setTaxProfileRuleModal_'+id).attr('style' , 'display:flex !important; flex-direction: column; align-items: center;');
...
<div class=" <?php echo Q2C_WRAPPER_CLASS; ?>">
	...
	echo $html;
	?>
	<form id="taxprofileform" name="taxrateForm" method="post" class="form-validate  container-fluid" enctype="multipart/form-data">
		<div class="row">
									...
									<tr>
										...
										<td>
											<button
												...
												type="button"
												onclick="toggleSetTaxProfileRuleModal('<?php echo $trule->taxrule_id;?>');">
												<?php echo Text::_('COM_QUICK2CART_TAXPROFILEERULE_EDIT'); ?>
											</button>
											<?php
												$setTaxProfileRulelink = 'index.php?option=com_quick2cart&view=taxprofileform&layout=setrule_bs3&id=' . $trule->taxrule_id . '&tmpl=component';
