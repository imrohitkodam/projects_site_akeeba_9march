...
<div class="quick2cart-wrapper <?php echo Q2C_WRAPPER_CLASS; ?>">
	<form action="" method="post" name="adminForm" id="adminForm">
		...
		<div class="row">
			<h1><strong><?php echo Text::_('COM_QUICK2CART_TAXPROFILES_LIST_LEGEND'); ?></strong></h1>
			<!-- Help msg -->
		...
		{?>
			<table class="table table-striped table-hover border table-bordered mt-3" id="taxProfilesList">
				<thead class="table-primary border table-bordered">
					<tr>
						...
						<th class="hidden-xs nowrap center q2c_width_20 fw-bold">
