...
/**
 * View class for a list of Taxprofiles.
 *
 * @package     Quick2cart
 * @subpackage  com_quick2cart
 * @since       2.2
...
class Quick2cartViewTaxprofiles extends HtmlView
{
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', Text::_('COM_QUICK2CART_TAXPROFILES_PAGE_TITLE'));
		}

		$title = $this->params->get('page_title', Text::_('COM_QUICK2CART_TAXPROFILES_PAGE_TITLE'));

		// @TODO - hack * remove line below -when correct itemid is passed for this view
		$title = Text::_('COM_QUICK2CART_TAXPROFILES_PAGE_TITLE');
	...
	protected function addTJtoolbar ()
	{
		...
		{
			$tjbar->appendButton('taxprofileform.add', 'TJTOOLBAR_NEW', QTC_ICON_PLUS, 'class="btn btn-sm btn-success"');
		}

		/*if ($canDo->get('core.edit') && isset($this->items[0]))
		{
			$tjbar->appendButton('taxprofileform.edit', 'TJTOOLBAR_EDIT', '', 'btn btn-sm btn-success');
		}*/
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('taxprofiles.publish', 'TJTOOLBAR_PUBLISH', QTC_ICON_PUBLISH, 'class="btn btn-sm btn-success"');
				$tjbar->appendButton('taxprofiles.unpublish', 'TJTOOLBAR_UNPUBLISH', QTC_ICON_UNPUBLISH, 'class="btn btn-sm btn-warning"');
			}
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('taxprofiles.delete', 'TJTOOLBAR_DELETE', Q2C_ICON_TRASH, 'class="btn btn-sm btn-danger"');
			}
		}
