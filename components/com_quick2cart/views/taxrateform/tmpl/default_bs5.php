...
function qtcsubmitAction(action)
{
	...
	// Check percentage field for zero value
	var percentageValue = document.getElementById('jform_percentage').value;
	if(percentageValue == 0 || percentageValue === '0')
	{
		alert("<?php echo $this->escape(Text::_('QTC_ENTER_POSITIVE_PERCENTAGE')); ?>");
		return false;
	}
...
<div class="qtc_site_taxrate <?php echo Q2C_WRAPPER_CLASS; ?> container-fluid">
	...
	<h1>
		<strong>
			<?php echo (!empty($this->item->id)) ? Text::_('COM_QUICK2CART_S_EDIT_TAX_RATE') : Text::_('COM_QUICK2CART_S_ADD_TAX_RATE');?>
		</strong>
	</h1>
			...
			<div class="form-horizontal">
				...
				<div class="form-group">
					<div class="col-sm-3 col-xs-12 form-label">
						<?php echo $this->form->getLabel('percentage'); ?>
					</div>
				...
				<div class="form-group">
					<div class="col-sm-3 col-xs-12 form-label"><?php echo $this->form->getLabel('zone_id'); ?></div>
					<div class="col-sm-9 col-xs-12"><?php echo $this->form->getInput('zone_id'); ?></div>
				</div>
				<div class="form-group">
