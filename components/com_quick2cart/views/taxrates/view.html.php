...
class Quick2cartViewTaxrates extends HtmlView
{
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', Text::_('COM_QUICK2CART_SETUP_TAXRATES'));
		}

		$title = $this->params->get('page_title', Text::_('COM_QUICK2CART_SETUP_TAXRATES'));

		// @TODO - hack * remove line below -when correct itemid is passed for this view
		$title = Text::_('COM_QUICK2CART_SETUP_TAXRATES');
	...
	protected function addTJtoolbar ()
	{
		...
		{
			$tjbar->appendButton('taxrates.add', 'TJTOOLBAR_NEW', QTC_ICON_PLUS, 'class="btn btn-sm btn-success"');
		}

		/*if ($canDo->get('core.edit') && isset($this->items[0]))
		{
			$tjbar->appendButton('taxrateform.edit', 'TJTOOLBAR_EDIT', '', 'btn btn-sm btn-success');
		}*/
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('taxrates.publish', 'TJTOOLBAR_PUBLISH', QTC_ICON_PUBLISH, 'class="btn btn-sm btn-success"');
				$tjbar->appendButton('taxrates.unpublish', 'TJTOOLBAR_UNPUBLISH', QTC_ICON_UNPUBLISH, 'class="btn btn-sm btn-warning"');
			}
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('taxrates.delete', 'TJTOOLBAR_DELETE', Q2C_ICON_TRASH, 'class="btn btn-sm btn-danger"');
			}
		}
