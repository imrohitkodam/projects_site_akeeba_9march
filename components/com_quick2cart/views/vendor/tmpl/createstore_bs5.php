		...
		<div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<input
							...
							name="storeVanityUrl"
							id="storeVanityUrl"
							class="form-control validate-qtc_alphanum "
			...
			<div class="form-group row">
				...
				<div class="col-sm-9 col-xs-12">
					...
					{
						?>
						<textarea size="28" rows="3" name="description" id="description" class="form-control inputbox" ><?php if (!empty($this->storeinfo)){ echo trim($this->storeinfo[0]->description);}?></textarea>
						<?php
					}
					else
					{
			...
			<div class="form-group row">
				...
				<div class="col-sm-9 col-xs-12">
					<textarea maxlength="200" rows="3" name="address" id="address" class="required form-control inputbox" ><?php if (!empty($this->storeinfo)){ echo stripslashes($this->storeinfo[0]->address);}?></textarea>
				</div>
			...
			<!--Country-->
			<div class="form-group row">
				<label for="storecountry" class="col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('QTC_BILLIN_COUNTRY')?>">
			...
			if ($showStoreTersmAndCond)
			{
				...
				<div class="form-group row af-text-center">
					<div class="checkbox">
						...
						?>
						<label for="privacy_terms_condition" class="form-label af-d-table">
							<input
								class=""
								type="checkbox"
