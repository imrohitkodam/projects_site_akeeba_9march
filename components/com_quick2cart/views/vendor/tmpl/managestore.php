...
<form  method="post" name="adminForm" id="adminForm" class="form-validate">
	...
	<table class="  table table-striped table-condensed">
		...
		<tr>
			...
			<button type="button" class="btn btn-info  btn_margin" onclick="window.open('<?php echo Route::_('index.php?option=com_quick2cart&view=orders&layout=mycustomer');?>','_self')" > <i class="<?php echo QTC_ICON_USER;?>"></i> <?php echo Text::_( 'QTC_MANAGE_STORE_CUSTOMER' ); ?></button>
