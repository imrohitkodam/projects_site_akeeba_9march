	...
	<div class="<?php echo Q2C_WRAPPER_CLASS; ?>">
		<div>
			<div class="alert alert-danger">
				<span><?php echo Text::_('QTC_ILLEGAL_PARAMETARS'); ?></span>
				<button type="button"  title="<?php echo Text::_( 'QTC_DEL' ); ?>" class="btn btn-sm btn-primary float-end" onclick="javascript:history.back();" >
					<i class="<?php echo Q2C_ICON_ARROW_RIGHT;?><?php echo Q2C_ICON_WHITECOLOR; ?>"></i>&nbsp;
					<?php echo Text::_( 'QTC_BACK_BTN');?>
				</button>
			</div>
		</div>
	</div>
					...
					if (!empty($target_data))
					{
						...
						<div class="">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
								...
								<div id="q2c_pc_top_seller" class="<?php echo $layout_to_load == "fixed_layout" ? 'row' : ''; ?>">
									<?php
									$Fixed_pin_classes = "";
				...
				if (!empty($this->allStoreProd))
				{
					...
					<div class="">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
							...
							<div id="q2c_pc_store_products" class="<?php echo $layout_to_load == "fixed_layout" ? 'row' : ''; ?>">
								<?php
								$Fixed_pin_classes = "";
