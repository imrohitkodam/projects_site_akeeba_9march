	...
	if (!$user->guest)
	{
		...
		<div class="row shadow-sm mb-3">
			<div class="col-sm-12 col-xs-12 qtc_toolbar">
								<ul class="nav nav-tabs border-bottom-0 me-auto mb-2 mb-lg-0 d-flex align-items-center">
									<?php
									...
									<li class="nav-item dropdown <?php echo ($active == 'create_store' || $active == 'my_stores') ? 'active': '' ?> dropdown">
										<a
											href="#"
											class="nav-link dropdown-toggle"
											data-toggle="dropdown"
									...
									<li class="nav-item dropdown <?php echo ($active == 'add_product' || $active == 'my_products') ? 'active': '' ?> dropdown">
										<a
											href="#"
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-horizontal">
				...
				<div class="float-end">
					<?php echo HTMLHelper::_('select.genericlist', $options, 'current_store', 'class="form-select" autocomplete="off"  onchange=\'submitAction_store("change_store");\' title="' . Text::_('COM_QUICK2CART_CURRENT_STORE') . '"', 'value', 'text', $default, 'current_store_id');?>
