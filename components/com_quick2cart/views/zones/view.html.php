...
/**
 * View class for a list of zones.
 *
 * @package     Quick2cart
 * @subpackage  com_quick2cart
 * @since       2.2
...
class Quick2cartViewzones extends HtmlView
{
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', Text::_('COM_QUICK2CART_ZONES_PAGE_TITLE'));
		}

		$title = $this->params->get('page_title', Text::_('COM_QUICK2CART_ZONES_PAGE_TITLE'));

		// @TODO - hack * remove line below -when correct itemid is passed for this view
		$title = Text::_('COM_QUICK2CART_ZONES_PAGE_TITLE');
	...
	protected function addTJtoolbar ()
	{
		...
		{
			$tjbar->appendButton('zoneform.add', 'TJTOOLBAR_NEW', QTC_ICON_PLUS, 'class="btn btn-sm btn-success"');
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('zones.publish', 'TJTOOLBAR_PUBLISH', QTC_ICON_PUBLISH, 'class="btn btn-sm btn-success"');
				$tjbar->appendButton('zones.unpublish', 'TJTOOLBAR_UNPUBLISH', QTC_ICON_UNPUBLISH, 'class="btn btn-sm btn-warning"');
			}
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('zones.delete', 'TJTOOLBAR_DELETE', Q2C_ICON_TRASH, 'class="btn btn-sm btn-danger"');
			}
		}
