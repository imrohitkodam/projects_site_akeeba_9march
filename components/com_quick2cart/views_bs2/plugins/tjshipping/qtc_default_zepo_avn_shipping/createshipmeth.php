...
<form name="qtcshipform" id="adminForm" class="form-validate form-horizontal" method="post" onSubmit="return myValidate(this);" >
	...
	<div class="row-fluid">
		...
		<h1 id="qtc_shipmethodInfo" ><strong><?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_SEL_CREATE_SHIPMETHO')?>&nbsp;</strong></h1>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				echo HTMLHelper::_('select.genericlist',  $options, "shipForm[store_id]", 'class="inputbox required"  size="1" required="required" ', 'value', 'text', $defaultSstore_id, 'qtcShipMethStoreId');
				?>
				<!--
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php echo  $this->dropdown = HTMLHelper::_('select.genericlist',$options,"shipForm[taxprofileId]",'class=""   aria-invalid="false" size="1" required="required" ','value','text',$default,'taxprofileId');
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php echo  $this->dropdown = HTMLHelper::_('select.genericlist',$options,"shipForm[state]",'class=""  required="required" aria-invalid="false" size="1" ','value','text',$default,'shipstate');
				?>
			</div>
		</div>
		...
		<?php
			...
			//$shipping_typeoptions[] = JHtml::_('select.option', "4", Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_UNPUBLISH'));
		?>
		<div class="control-group" >
		...
		<div class="control-group">
			...
			<div class="controls" id="qtcCreateMethMaxField">
				...
				<p class="text-info"><?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_MAXIMUM_AMT_HELP"); ?></p>
				-->
				<?php
		...
		<div class="form-actions ">
			<div class="qtc_action_button filter-search ">
				...
				<button type="button" class="btn btn-inverse " title="<?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_CANCEL"); ?>" onclick="qtcShipSubmitAction('cancel');">
