...
<legend id="" ><?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_UPDATE_SHIP_RATE") ?>&nbsp; <?php echo !empty($shipMethDetail['name']) ? ucfirst($shipMethDetail['name']) : ''; ?><small><?php //echo JText::_('QTC_BILLIN_DESC')?></small></legend>
	<div class="">
		<table class=" table table-striped">
			...
			<tbody>
				<tr>
					...
					<td>
						<?php
							$fn_para =  $extension_id . "," . $rateId . ",'".  Uri::base() . "'" ;
