...
// $addpre_select[] = HTMLHelper::_('select.option','=', Text::_('QTC_ADDATTRI_PRESAM'));
...
<form method='POST' name='adminForm' class="form-validate" action='index.php'>
	...
	<!---s ATTRIBURE NAME -->
			<div class="span4">
				<input id="atrri_name_id" class="input-medium bill inputbox required" type="text" value="<?php echo (isset($this->itemattribute_name)) ? htmlentities($this->itemattribute_name) :''; ?>" maxlength="250"  name="att_detail[attri_name]" title="<?php echo Text::_('QTC_ADDATTRI_NAME_DESC')?>">
			...
			<div class="span4">
				<?php
					...
					echo HTMLHelper::_('select.genericlist', $fields, "att_detail[fieldType]", 'class="no_chzn span6 qtcfieldType" onChange="qtc_fieldTypeChange('.$fnparam.')"', "value", "text",$default);
				?>
			</div>
			<!--- IS COMPULSORY  -->
			<div class="span3">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="atrri_name_id" class="input-medium bill inputbox required" type="text" value="<?php echo (isset($this->itemattribute_name))?$this->itemattribute_name:''; ?>" maxlength="250"  name="attri_name" title="<?php echo Text::_('QTC_ADDATTRI_NAME_DESC')?>">
	</div>
	</div>
	<div class="control-group">
...
<table class="table table-condensed item_attris_opt qtc_attributeOpTable"><!-- the table width is fixed to 450px -->
	...
	for($k = 0; $k <= count($this->attribute_opt); $k++)
	{
			...
			<tr class="control-group form-inline clonedInput" id="attri_opts<?php echo $k; ?>" >
				...
				<?php
					...
					echo HTMLHelper::_('select.genericlist', $addpre_select, "att_detail[attri_opt][$k][prefix]", 'class="span1"   ', "value", "text", $addpre_val);
				?>
					</td>
					<td>
				<?php
	...
	<div class="form-actions">
		...
		<input class="btn btn-default validate" type="button" onclick="qtc_closePopUp();" value="<?php echo Text::_('QTC_ADDATTRI_CANCEL')?>" >		<?php echo HTMLHelper::_( 'form.token' ); ?>
	</div>
