...
{
	?>
	<a rel="{handler: 'iframe', size: {x : window.innerWidth-450, y : window.innerHeight-150}, onClose: function(){AddNewAttribute('<?php echo $item_id; ?>','<?php echo $count_tr;?>');}}" class="btn btn-primary btn-sm <?php echo ($button_dis == ""?'modal':$button_dis)?> qtcAddAttributeLink" href="<?php echo ($button_dis == ""?$add_link:"javascript:void(0);")?>" style="display: inline;">
	<?php echo Text::_('QTC_ADD_ATTRIB'); ?></a>
