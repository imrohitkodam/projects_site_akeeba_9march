	...
	<div class="form-horizontal qtc_buynow" id="<?php echo $this->product_id;?>_item" style="width:auto;">
		...
		?>
			<div class="control-group">
				<label class="control-label qtc-label-original_price"><strong><?php echo Text::_('QTC_ITEM_AMT')?></strong></label>
		...
		{ ?>
			<div class="control-group">
				...
				<label class="control-label qtc-label-discount_price"><strong><?php echo Text::_('QTC_ITEM_DIS_AMT')?></strong></label>
		...
		?>
			<div class="control-group <?php echo $hideAtt ?>" >
				<div class="control-label qtc-label-free_download"><strong><?php echo Text::_("COM_QUICK2CART_PROD_FREE_DOWNLOAD"); ?>		</strong></div>
		...
		<div class="control-group" style="<?php echo $showqty_style; ?>">
			<label class="control-label qtc-label-itemcount"><strong><?php echo Text::_('QTC_ITEM_QTY'); ?></strong></label>
			...
			<button class="btn btn-sm btn-success qtc_buyBtn_style" type="button" onclick="qtc_addtocart('<?php echo $this->product_id; ?>');"><i class="<?php echo QTC_ICON_CART;?>"></i> <?php echo Text::_('QTC_ITEM_BUY');?></button>
		</div>
		</div>
		...
		{  ?>
			<div class="controls">
				<button class="btn btn-sm btn-primary qtc_buyBtn_style" type="button" onclick="qtc_addtocart('<?php echo $this->product_id; ?>');"><i class="<?php echo QTC_ICON_CART;?>"></i> <?php echo Text::_('QTC_ITEM_BUY') ;?></button>
			</div>
		<?php
		}
		...
		if ($popup_buynow == 2)
		{
			...
			<div class="cart-popup" id="<?php echo $this->product_id; ?>_popup" style="display: none;">
				...
				<div class="cart_link"><a class="btn btn-success" href="<?php echo $action_link; ?>"><?php echo Text::_('COM_QUICK2CART_VIEW_CART')?></a></div>
