...
$showCheckoutTermsConditions = $params->get('termsConditons', 0);
...
if (!empty($showCheckoutTermsConditions) && !empty($checkoutTermsCondArtId))
{
	$showTersmAndCond = 1;
}
...
<?php
if ($this->onBeforeQ2cCheckoutViewDisplay)
{
	echo $this->onBeforeQ2cCheckoutViewDisplay;
}
	...
	techjoomla.jQuery.ajax({
		...
		success: function(data)
		{
			if (data)
			{
				...
				//var prev_button_html='<button id="btnWizardPrev1" onclick="jQuery(\'#MyWizard\').wizard(\'previous\');"	type="button" class="btn btn-default btn-primary pull-left float-start" > <i class="icon-circle-arrow-left <?php echo Q2C_ICON_WHITECOLOR; ?>" ></i>Prev</button>';
			...
			<div class="sa_steps_parent row-fluid">
				...
				<form method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="form-horizontal form-validate" onsubmit="return validateForm();">
					...
					<div class="tab-pane step-pane active" id="step1">
						...
						$currentBSViews = $params->get("bootstrap_version","bs2","STRING");
						$data = new stdclass;
						$data->cart = $this->cart;
					...
					<div class="tab-pane step-pane" id="step2">
						...
						if (!empty($user->id))
						{
							...
							<div class="row-fluid">
									...
									?>
									<div class="span12">
										<h3 class="checkout-addresses"><?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_SELECT_ADDRESS");?></h3>
									</div>
									<?php
									}
									?>
									<div id="qtc_user_addresses" class="checkout-addresses col-xs-12">
										<div class="row-fluid qtc_user_addresses_wrapper">
				...
				<div class="prev_next_wizard_actions">
					<div class="form-actions">
						<button id="btnWizardPrev" type="button" style="display:none" class="btn pull-left float-start" > <i class="<?php echo Q2C_ICON_ARROW_CHEVRON_LEFT; ?> <?php //echo Q2C_ICON_WHITECOLOR; ?>" ></i>&nbsp;<?php echo Text::_('COM_QUICK2CART_PREV');?></button>
