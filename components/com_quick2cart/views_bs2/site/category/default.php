					...
					<div class="span12">
						<legend>
							...
							if (!empty($this->store_role_list))
							{
								...
								echo Text::sprintf($lagend_title, $store_name);
							}
							else
							{
								echo Text::_($lagend_title);
							}*/
							echo Text::_($this->productPageTitle);
							?>
						</legend>
					</div>
				</div>

				<div id="filter-bar" class="qtc-btn-toolbar row-fluid">
					<div class="input-append span8">
						<input class="span10" title="<?php echo Text::_('COM_QUICK2CART_FILTER_SEARCH_DESC_PRODUCTS'); ?>" name="filter_search" id="filter_search" id="appendedInputButton" placeholder="<?php echo Text::_('COM_QUICK2CART_FILTER_SEARCH_DESC_PRODUCTS'); ?>"
						value="<?php echo $this->escape($this->state->get('filter.search')); ?>" type="text">
						<button class="btn qtc-hasTooltip" type="submit"title="<?php echo Text::_('JSEARCH_FILTER_SUBMIT'); ?>">
					...
					<div class="span4">
					<?php
						echo HTMLHelper::_('select.genericlist', $this->product_sorting, "sort_products", 'class="inputbox input-medium pull-right" onchange="document.adminForm.submit();" name="sort_products"', "value", "text", $this->state->get('sort_products'));
					?>
					</div>
