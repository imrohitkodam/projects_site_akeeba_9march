...
<script type="text/javascript">
	...
	function checkcode()
	{
		...
		if(parseInt(cid)==0)
		{
			var url = "index.php?option=com_quick2cart&task=couponform.getcode&tmpl=component&selectedcode="+selectedcode;
		}
		else
		{
			var url = "index.php?option=com_quick2cart&task=couponform.getselectcode&tmpl=component&couponid="+cid+"&selectedcode="+selectedcode;
		}
	...
	<form name="adminForm" id="adminForm" class="form-horizontal form-validate"
		...
		<div>
			...
			<div class="control-group">
				...
				<?php echo HTMLHelper::_('select.booleanlist',  'published', 'class="inputbox"', (isset($this->item->id)) ? $this->item->published : 0);?>
			</div>
			...
			//sanjivani end
			//$options[] = HTMLHelper::_('select.option', "", "Select Country");
			...
			if ($multivendor_enable == '1')
			{
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						$options = array();
						$options[] = HTMLHelper::_('select.option', '0', Text::_('COM_QUICK2CART_COUPONFORM_STORE_SELECT'));//submitAction('deletecoupon');
						...
						echo $this->dropdown = HTMLHelper::_('select.genericlist',$options,'store_ID','class=" qtc_putmargintop10px required"  ','value','text',$default,'store_ID');
						?>
					</div>
				</div>
				<?php
			...
			<div class="control-group">
				<label for="value" class="control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPAN_VALUE_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_VALUE'), '', Text::_('COM_QUICK2CART_COUPON_VALUE') . ' *');?></label>
				<div class="controls">
			...
			<div class="control-group">
				...
				$val_type1[] = HTMLHelper::_('select.option', '0', Text::_("COM_QUICK2CART_COUPON_FLAT"));
				$val_type1[] = HTMLHelper::_('select.option', '1', Text::_("COM_QUICK2CART_COUPON_PER")); // first parameter is value, second is text
			...
			<div class="control-group">
				<label for="max_use" class="control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_MAXUSES_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_MAXUSES'), '', Text::_('COM_QUICK2CART_COUPON_MAXUSES'));?></label>
				<div class="controls">
			...
			<div class="control-group">
				<label for="max_per_user" class="control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_MAXUSES_PERUSER_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_MAXUSES_PERUSER'), '', Text::_('COM_QUICK2CART_COUPON_MAXUSES_PERUSER'));?></label>
				<div class="controls">
			...
			<div class="control-group">
				<label for="from_date" class="control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_VALID_FROM_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_VALID_FROM'), '', Text::_('COM_QUICK2CART_COUPON_VALID_FROM'));?></label>
				<div class="controls">
					<?php
					if ($this->item)
					{
					...
					echo HTMLHelper::_('calendar', $date_from, 'from_date', 'from_date', Text::_('COM_QUICK2CART_DATE_FORMAT_CALENDER'));
					?>
				</div>
			</div>

			<div class="control-group">
				<label for="exp_date" class="control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_EXPIRES_ON_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_EXPIRES_ON'), '', Text::_('COM_QUICK2CART_COUPON_EXPIRES_ON'));?></label>
				<div class="controls">
					<?php
					if ($this->item)
					{
					...
					echo HTMLHelper::_('calendar', $date_exp, 'exp_date', 'exp_date', Text::_('COM_QUICK2CART_DATE_FORMAT_CALENDER'));
					?>
				</div>
			</div>

			<div class="control-group">
				<label for="description" class="control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_DESCRIPTION_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_DESCRIPTION'), '', Text::_('COM_QUICK2CART_COUPON_DESCRIPTION'));?></label>
				<div class="controls">
			...
			<div class="control-group">
				<label for="params" class="control-label"><?php echo HTMLHelper::tooltip(Text::_('COM_QUICK2CART_COUPON_PARAMETERS_TOOLTIP'), Text::_('COM_QUICK2CART_COUPON_PARAMETERS'), '', Text::_('COM_QUICK2CART_COUPON_PARAMETERS'));?></label>
				<div class="controls">
		...
		<div class="form-actions">
			...
			<input type="button" class="btn " value="<?php echo Text::_('QTC_COUPON_CANCEL');?>" onclick="Joomla.submitbutton('couponform.cancel');"/>
		</div>
