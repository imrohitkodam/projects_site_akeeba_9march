...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> my-coupons">
	<form method="post" name="adminForm" id="adminForm" class="form-validate">
		...
		<div id="qtc-filter-bar" class="qtc-btn-toolbar">
			...
			<div class="qtc-btn-group pull-left float-start q2c-btn-wrapper">
			...
			<div class="btn-group pull-right float-end q2c-btn-wrapper">
					...
					foreach ($this->items as $i => $item)
					{
						...
						<tr class="row<?php echo $i % 2;?>">
							...
							<td class="">
								...
								title="<?php echo Text::_('COM_QUICK2CART_COUPON_EDIT_TOOLTIP');?>">
									<?php echo $item->name;
								?>
								</a>
							</td>
