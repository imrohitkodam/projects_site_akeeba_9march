				...
				techjoomla.jQuery.each(shipping_info, function(i, item)
				{
					...
					techjoomla.jQuery.each(shipping_info[i].shippingMeths, function(j, itemz)
					{
						...
						if (itemz.hasOwnProperty('totalShipCost'))
						{
							...
							techjoomla.jQuery("#qtc_product_shipping_details"+prod_container_num).append('<div class="col-md-3"><label class="radio"><input type="radio" name="itemshipMeth['+prod_container_num+']['+item.item_id+']" value="'+itemz.methodId+'" aria-invalid="false" '+check+'><span>'+currency+'&nbsp;'+itemz.totalShipCost+'</span>&nbsp;&nbsp;&nbsp;'+itemz.name+'</label></div>');
						}
					});
				});
			}
...
$itemid = $comquick2cartHelper->getitemid('index.php?option=com_quick2cart&view=product');
?>
...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> container-fluid">
	<form name="createOrder" id="createOrder" class="form-validate form-horizontal" method="post">
		...
		<div class="row-fluid">
			<h1 class="col-md-12"><?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_VIEW_TITLE");?></h1>
		</div>
		<div class="row-fluid">
			<div class="col-md-12 alert alert-info"><?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_VIEW_INFO");?></div>
		</div>
		<div class="row-fluid qtc-createorder-buttons">
			<a class="btn btn-primary pull-right float-end qtcMarginLeft col-md-3" onclick="addClient('<?php echo Uri::root();?>')"><i class="icon-user">&nbsp;</i><?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_ADD_CLIENT");?></a>
			<a class="btn btn-primary pull-right float-end col-md-3" target="_blank" href="<?php echo Uri::root() . 'index.php?option=com_quick2cart&view=product';?>"><i class=" icon-plus-2 icon22-white22 ">&nbsp;</i><?php echo Text::_("COM_QUICK2CART_POINTS_ADD_PRODUCT_TITLE");?></a>
		</div>
		<div class="clearfix"></div>
		<!-- CODE FOR TABS START-->
			<div>
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="qtctab_selectclient">
						...
						<div class="control-group">
							<div class="control-label"><?php echo Text::_("COM_QUICK2CART_SELECT_CUSTOMER"); ?></div>
							<div class="controls">
							<?php
								echo HTMLHelper::_('select.genericlist', $this->users, "qtcuser", 'class="ad-status inputbox input-medium required" size="1" required onchange="showAddresses();" name="qtcuser"', "id", "username");
							?>
							</div>
						</div>
						<div class="clearfix">&nbsp;</div>
						<div class="qtcadd_address_button center">
							<a class="btn btn-success" onclick="addAddress('<?php echo Uri::root();?>')"><?php echo Text::_('COM_QUICK2CART_ADD_CUSTOMER_ADDRESS');?></a>
						</div>
					...
					<div class="tab-pane" id="qtctab_addproduct">
						<div id="qtc_add_product_wrapper">
							<div id="qtc_product_clone">
								<div id="qtc_product_div0" class="qtc_product_div">
									<div class="row-fluid">
										<div class="col-md-3">
											<label id="qtcorder_productdetails_label0" for="qtcorder_productdetails0store_id"><?php echo Text::_("COM_QUICK2CART_SELET_STORE"); ?></label>
											<div>
											<?php
												echo HTMLHelper::_('select.genericlist', $this->stores, "qtcorder_productdetails[0][store_id]", 'class="ad-status inputbox input-medium required qtcorder_select_chosen" required="required" size="1" onchange="qtcpopulateProducts(\'0\');"', "store_id", "title");
											?>
											</div>
										</div>
										<div class="col-md-3 qtc_select_product_select_div0">
											<label id="qtc_select_product_select0" for="qtcorder_productdetails0" class=""><?php echo Text::_("COM_QUICK2CART_SELECT_PRODUCT"); ?></label>
										...
										<div class="col-md-2 center qtc_prod_price_div">
										...
										<div id="qtc_product_shipping_details_div0" class="hidden row-fluid qtc_product_shipping_title_div">
											<h4 class="col-md-12"><?php echo Text::_("COM_QUICK2CART_CHOOSE_YOUR_DELIVARY_OPTION");?></h4>
										</div>
						...
						<h3>
							<div class="pull-right float-end qtc-total-order-price">
								<span><?php echo Text::_('COM_QUICK2CART_CREATE_ORDER_TOTAL_ORDER_PRICE');?>&nbsp;</span>
								<span id="qtc_order_total_currency"></span>
								<span>&nbsp;</span>
								<span id="qtc_order_total_price" class="pull-right float-end">-</span>
							</div>
						</h3>
						<div class="clearfix"></div>
						<div class="row-fluid">
							<div class="col-md-12 alert alert-info"><?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_VIEW_ORDER_INFO");?></div>
						</div>
						<div class="qtc-create-order-buttons center">
							<a onclick="qtcaddMoreProduct();" class="btn btn-primary" title="Add More"><i class=" icon-plus-2 icon22-white22 "></i><?php echo Text::_('COM_QUICK2CART_CREATE_ORDER_ADD_MORE_PRODUCTS');?>
							</a>
							<a onclick="qtc_place_order();" class="btn btn-success"><?php echo Text::_('QTC_CHKOUT');?>
							</a>
						</div>
					</div>
					<!-- tab 2 end -->
