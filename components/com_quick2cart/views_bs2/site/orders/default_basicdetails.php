						...
						<tr>
							...
							<td>
								<span>
									...
									$store_id = Factory::getApplication()->input->get('store_id');
...
-->
						...
						<tr>
							...
							<td><?php echo htmlspecialchars($this->orderinfo->customer_note, ENT_COMPAT, 'UTF-8') ? $this->orderinfo->customer_note : Text::_('QTC_USER_COMMENT_NO');?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('COM_QUICK2CART_PAYMENT_NOTE');?></td>
							<td class="q2c-max-width-150"><?php echo htmlspecialchars($this->orderinfo->payment_note, ENT_COMPAT, 'UTF-8') ? $this->orderinfo->payment_note : Text::_('QTC_USER_COMMENT_NO');?></td>
						</tr>
					</table>
		</div>
	</div>
			...
			<div id="qtc_paymentmethods" style="<?php echo $getways_display;?>;">
				<div class="control-group">
					...
					<div class="controls">
						...
						{
							$pg_list = HTMLHelper::_('select.radiolist', $gateways, 'gateways', 'class="inputbox" autocomplete="off" ', 'id', 'name', '', false);
							echo $pg_list;
						}?>
					</div>
				</div>
