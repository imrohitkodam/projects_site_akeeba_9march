...
?>
	...
	<script src="<?php echo Uri::root().'components/com_quick2cart/assets/js/bootstrap-tooltip.js'?>"></script>
	<script src="<?php echo Uri::root().'components/com_quick2cart/assets/js/bootstrap-popover.js'?>"></script>
