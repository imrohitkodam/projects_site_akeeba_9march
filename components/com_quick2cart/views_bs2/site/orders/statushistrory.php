						...
						<table class="table table-condensed " id="complete-order" name="complete-order">
							...
							<tr>
								...
								<td data-title="<?php echo Text::_('QTC_ORDER_STATUS');?>">
									...
									//if ($orders_site)
									{
										echo HTMLHelper::_('select.genericlist', $this->vendorstatus, "status",  'class="pad_status"  ', "value", "text", $this->orderinfo->status);
									}
							...
							<tr>
								...
								<td class="textAlignCenter" data-title="<?php echo Text::_('QTC_NOTIFY');?>">
									<div>
							...
							<tr>
								...
								<td data-title="<?php echo Text::_('COM_QUICK2CART_UPDAE_ORDER_STATUS');?>">
									...
									<button  class="btn btn-default btn-success " title="<?php echo Text::_('COM_QUICK2CART_UPDAE_ORDER_STATUS');?>" ><?php echo Text::_('COM_QUICK2CART_UPDAE_ORDER_STATUS'); ?></button>
								</td>
							</tr>
					</table>
					<hr/>
