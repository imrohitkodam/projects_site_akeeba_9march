...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>">
	<form action="" method="post" name="adminForm" id="adminForm">
		...
		<legend><?php echo Text::_('COM_QUICK2CART_MY_CASHBACK')?></legend>
		...
		<div id="qtc-filter-bar" class="qtc-btn-toolbar">
			...
			<div class="filter-select fltrt pull-right float-end q2c-btn-wrapper">
				<div class="qtc-btn-group pull-right float-end">
						...
						?>
							<tr class="row<?php echo $i % 2;?>">
								...
								<td class="q2c_width_30 center small" data-title="<?php echo Text::_('COM_QUICK2CART_PAYMENT_STATUS');?>">
									...
									if ($payout->status == 1)
									{
										$status_text = Text::_('COM_QUICK2CART_PAID');
										$badge_class = "success";
									}
									else
									{
										$status_text = Text::_('COM_QUICK2CART_NOT_PAID');
										$badge_class = "warning";
									}
									?>
