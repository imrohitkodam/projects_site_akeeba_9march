...
<script type="text/javascript">
	...
	*/
	...
	function addClone(rId,rClass)
	{
		...
		var removeButton="<div class='com_qtc_remove_button pull-left float-start col-md-1'>";
		removeButton+="<button class='btn btn-sm' type='button' id='remove"+num+"'";
		...
		<div class="col-md-12">
			...
			$i=0;
				...
				<div id=<?php echo $attribute_container_id ?> class="qtc_container">
					...
					<?php //if ($i != 0)
					{?>
					<div class='com_qtc_remove_button pull-left float-start'>
						<button class='btn btn-sm' type='button' id='remove<?php echo $i;?>'
			...
			<div class="com_qtc_add_button pull-left float-start  col-md-1">
				<button class="btn btn-sm " type="button" id='add'
