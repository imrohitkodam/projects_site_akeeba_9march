...
HTMLHelper::_('script', Uri::root() . 'administrator/components/com_tjfields/assets/js/tjfields.js');
	...
	<form name="qtcAddProdForm" id="qtcAddProdForm" class="form-validate "
		...
		else
		{
			...
			<legend>
				...
				{
					echo Text::_( "QTC_EDIT_PRODUCT");
				}
				else
				{
					echo Text::_( "QTC_ADD_PRODUCT");
				}
				?>
			</legend>
			...
			<div class="tabbable">
				<ul class="nav nav-pills">
					...
					if ($eProdSupport)
					{
						?>
						<li id="tab3id" class="">
							<a href="#qtcMediatab" data-toggle="tab"><?php echo Text::_( "QTC_PROD_MEDIA_DETAILS"); ?></a>
						</li>
						<?php
					}
					...
					if ($isTaxationEnabled  || $qtc_shipping_opt_status)
					{
						...
						<li id="taxshipTabId" class="">
							<a href="#taxshipTab" data-toggle="tab"><?php echo Text::_( "COM_QUICK2CART_TAX_ND_SHIPPING_TAB"); ?></a>
						</li>
						<?php
					}
					?>
			...
			<div class="">
				...
				<button type="button" class="btn btn-danger" title="<?php echo Text::_('QTC_COUPON_CANCEL')?>" onclick="submitTask('cancel')">
					<?php echo Text::_('QTC_COUPON_CANCEL')?>
				</button>

				<!--
				<button type="button" class="btn btn-success" title="<?php echo Text::_('QTC_PROD_SVCNEW')?>" onclick="submitTask('saveAndNew')">
					<?php echo Text::_('QTC_PROD_SVCNEW')?>
				</button>
				-->
			</div>
			<!-- End of form actions-->
