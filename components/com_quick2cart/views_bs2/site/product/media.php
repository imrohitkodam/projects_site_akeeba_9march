		...
		<div class="span6">
			<div class=' row-fluid'>
				...
				<div class="control-group qtcMedUploadWrapper" style="<?php echo !empty($mediaDetail[$m]['file_id'])?'display:none;':'display:block;'; ?>">
						...
						<div class="controls">
							<input type="text" class="qtcMediaUpload input-medium" name="prodMedia[<?php echo $m ?>][mediaFilePath]" id="ajax_upload_hidden<?php echo $m ?>" value="<?php echo !empty($mediaDetail[$m]['filePath']) ? $mediaDetail[$m]['filePath'] :'' ?>" style="<?php echo $qtcFieldType; ?>" placeholder="<?php echo Text::_( "QTC_FILEPATH")?>">
						</div>
				</div>
				<!-- file upload END -->
				<?php
