...
<div class ="row-fluid form-horizontal">
	...
	<div class='qtc_title_textbox control-group' >
		...
		<input type="hidden" class="inputbox"  name="pid"  id="pid" value="<?php echo $this->item_id; ?>" />
		</div>
	</div>
	...
	{
		?>
		<div class="control-group" style="<?php (count($this->store_role_list)) ? "display:block;" : "display:none;" ?>">
			...
			<div class="controls">
				<?php
				 $defaultStore = (!empty($this->itemDetail['store_id']))? $this->itemDetail['store_id']:$this->store_role_list[0]['store_id'];
					...
					{
						$options[] = HTMLHelper::_('select.option', $value["store_id"],$value['title']);//submitAction('deletecoupon');
					}
	...
	{
		?>
		<input type="hidden" class="inputbox" name="store_id" value="<?php echo $this->store_role_list[0]['store_id']; ?>" />
		<?php
	}
	?>
		...
		<div class="controls">
			...
			<div class="row-fluid">
				...
				<div class="filediv span12" id="filediv">
					<span>
						<input type="file" name="prod_img" id="avatar" placeholder="<?php echo Text::_('COM_QUICK2CART_IMAGE_MSG');?>" accept="image/*">
					</span>
				</div>
	...
	<div class="alert">
		...
		<?php echo Text::_('QTC_NOTE'); ?><?php echo Text::_('QTC_OPTIONS_REQUIRED_MSG'); ?>
	</div>
	<div class="alert alert-error">
		<button type="button" class="close" data-dismiss="alert"></button>
		<?php echo Text::_('QTC_NOTE'); ?> <?php echo Text::_('QTC_SAVE_ITEM_PARAM_DESC'); ?>
	</div>
...
<?php
$js_key = 'var qtc_base_url = Joomla.getOptions("system.paths").base';
$js_key .="
