	...
	<script type="text/javascript">
		...
		techjoomla.jQuery(document).ready(function()
		{
			...
			*/
			...
			setTimeout(function() { QttPinArrange(random_containerId, columnWidth, random_container, pin_padding); }, 13000);
			setTimeout(function() { QttPinArrange(random_containerId, columnWidth, random_container, pin_padding); }, 15000);
			setTimeout(function() { QttPinArrange(random_containerId, columnWidth, random_container, pin_padding); }, 17000);
		});
	</script>
<?php
}
