...
<div class="">
	...
	<div class='control-group ' style="<?php echo $qtc_shipping_opt_style;?>">
		...
		<div class="controls">
			<input type="text" class=" input-mini" Onkeyup='checkforalpha(this,46,"<?php echo Text::_("QTC_ENTER_NUMERICS"); ?>");' name='qtc_item_length' id='qtc_item_length' value='<?php echo (!empty($minmaxstock->item_length)) ?  number_format($minmaxstock->item_length, 2, '.', '') : '' ?>' placeholder="<?php echo Text::_('COM_QUICK2CART_LENGTH_HINT') ?>" />
			x
			<input type="text" class=" input-mini" Onkeyup='checkforalpha(this,46,"<?php echo Text::_("QTC_ENTER_NUMERICS"); ?>");' name='qtc_item_width' id='qtc_item_width' value='<?php  echo (!empty($minmaxstock->item_width)) ?  number_format($minmaxstock->item_width, 2, '.', '') : '' ?>' placeholder="<?php echo Text::_('COM_QUICK2CART_WIDTH_HINT') ?>" />
			x
			<div class="input-append ">
				<input type="text" class=" input-mini" Onkeyup='checkforalpha(this,46,"<?php echo Text::_("QTC_ENTER_NUMERICS"); ?>");' name='qtc_item_height' id='qtc_item_height' value='<?php echo (!empty($minmaxstock->item_height)) ?  number_format($minmaxstock->item_height, 2, '.', '') : '' ?>' placeholder="<?php echo Text::_('COM_QUICK2CART_HEIGHT_HINT') ?>" />
	...
	<div class='control-group qtc_item_weight' style="<?php echo $qtc_shipping_opt_style;?>">
		...
		<div class="controls">
			<div class="input-append ">
				<input type="text" class=" input-mini" Onkeyup='checkforalpha(this,46,"<?php echo Text::_("QTC_ENTER_NUMERICS"); ?>");' name='qtc_item_weight' id="qtc_item_weight" value='<?php if (isset($minmaxstock)) echo number_format($minmaxstock->item_weight, 2, '.', '');?>' />
				<?php
					// Get store configued length id.
					// The get default value
