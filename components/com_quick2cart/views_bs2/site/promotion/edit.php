		...
		<div class="form-horizontal">
			...
			<div class="row-fluid">
				<span id="qtc-condition-attribute-value-primary-div">
					<span id="qtc-condition-attribute-value-primary-divclone" style="display:none;">
						...
						<a class="qtcHandPointer" id="rule_conditions_attribute_selectprimary" title="<?php echo Text::_('COM_QUICK2CART_PROMOTION_CONDITION_SELECT')?>" onclick="openSelector('primary')">
					...
					if ($this->item->id && (!empty($this->conditionList)))
					{
						...
						<div id="qtc-promotion-condition-div-clone<?php echo $condition->id;?>" class="qtc-promotion-condition-div-clone">
							...
							<span id="currency_wrapper<?php echo $condition->id;?>">
								...
								<a class="qtcHandPointer" <?php echo ($condition->condition_on_attribute == 'quantity_in_store_cart')?"class='qtc-product-attribute-selector-hide'":"";?> id="rule_conditions_attribute_select<?php echo $condition->id;?>" title="<?php echo Text::_('COM_QUICK2CART_PROMOTION_CONDITION_SELECT')?>" onclick="openSelector('<?php echo $condition->id;?>')"><img src="<?php echo Uri::root();?>components/com_quick2cart/assets/images/magnifier.png"></a>
								</span>
							</span>
							<?php
							}
			...
			<div>
				...
				<a class="qtcHandPointer" onclick="qtcAddPromotionCondition();" >
					<img
						title="<?php echo Text::_('COM_QUICK2CART_ADD_CONDITION');?>"
						src="<?php echo Uri::root();?>components/com_quick2cart/assets/images/add_rule_condition.png"/>
				</a>
			</div>
			<br><br><br>
			<?php
