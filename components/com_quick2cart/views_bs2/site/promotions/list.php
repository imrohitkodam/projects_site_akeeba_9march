...
<?php
	...
	{
	?>
		<div class="alert alert-error"><?php echo Text::_("COM_QUICK2CART_CREATE_ORDER_AUTHORIZATION_ERROR");?></div>
	<?php
		return false;
	}
...
<div id="filter-bar" class="btn-toolbar">
	...
	<div class="btn-group pull-right float-end hidden-phone">
		<?php echo HTMLHelper::_('select.genericlist', $this->storeList, "filter_store", 'class="input-medium" size="1" onchange="document.adminForm.submit();" name="filter_store"', "id", "title", $this->state->get('filter.store'));?>
	</div>
</div>
