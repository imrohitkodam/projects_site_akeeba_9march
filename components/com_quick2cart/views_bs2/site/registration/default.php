...
if (!$user->id)
{
	...
	<div id="qtc_user-info" class="com_quick2cart-checkout-steps " style="<?php echo $registorStyle; ?>">
		<div class="checkout-heading">
			...
			<span id="" class="qtcHandPointer badge badge-success pull-right float-end" onclick="qtc_hideShowLoginTab('qtc_user-info-content', 'qtc_ckout_billing-info')"><?php echo Text::_('COM_QUICK2CART_MODIFY');?></span>
		</div>
		...
		<div id="qtc_user-info-content">
			<div class="row-fluid" >
				<div class="left span6">
					...
					<!-- registration -->
					  <?php if(1): ?>
					  <label for="register" title="<?php echo Text::_('COM_QUICK2CART_CHECKOUT_REGISTER_DESC'); ?>">
						...
						<b><?php echo Text::_('COM_QUICK2CART_CHECKOUT_REGISTER'); ?></b></label>
					  <br />
					  <?php endif; ?>
					  ...
					  <label for="guest">
						...
						<b><?php echo Text::_('COM_QUICK2CART_CHECKOUT_GUEST'); ?></b></label>
					  <br />
					  <?php endif; ?>
					  <br />
				...
				<div id="login" class="right span6">
					  ...
					  <br />
					  <br />
					  <input type="button" value="<?php echo Text::_('COM_QUICK2CART_CHECKOUT_LOGIN'); ?>" id="button-login" class="button btn " onclick="qtc_ckpg_login(this)"/><br />
					  <br />
				</div>
			</div>
			<hr/>
			<div class="row-fluid">
				<input type="button" class="button btn btn-primary" id="button-user-info" value="<?php echo Text::_('COM_QUICK2CART_CONTINUE');?>" onclick="qtc_guestContinue('qtc_user-info-content')">
			</div>
		</div>


		<!--Added by Sneha, to display message to login on checkout-->
		<div class="control-group" id="qtc_loginmail_msg_div" style="display:none">
