...
<script type="text/javascript">
	...
	function deleteShipProfileMethod(methodId,delBtn)
	{
		...
		techjoomla.jQuery.ajax({
			type : "POST",
			url :"<?php echo Uri::base();?>index.php?option=com_quick2cart&view=<?php echo $actionViewName; ?> &task=<?php echo $actionControllerName; ?>.deleteShipProfileMethod&tmpl=component",
			data : data,
	...
	function qtcLoadPlgMethods()
	{
		...
		techjoomla.jQuery.ajax({
				type : "POST",
				url :"<?php echo Uri::base();?>index.php?option=com_quick2cart&view=<?php echo $actionViewName; ?>&task=<?php echo $actionControllerName; ?>.qtcLoadPlgMethods&tmpl=component",
				data : data,
				dataType: "json",
				beforeSend: function()
				{
    ...
    function qtc_addShipMethod()
    {
		...
		techjoomla.jQuery.ajax({
					type : "POST",
					url :"<?php echo Uri::base();?>index.php?option=com_quick2cart&view=<?php echo $actionViewName; ?>&task=<?php echo $actionControllerName; ?>.addShipMethod&tmpl=component",
					data : data,
					dataType: "json",
					beforeSend: function()
					{
	...
	<div class="row-fluid">
		...
		<div class="form-horizontal">
			<div class="form-actions">
				...
				<?php endif; ?>
				<a href="<?php echo Route::_('index.php?option=com_quick2cart&task=' . $formName. '.cancel&id='.$this->item->id); ?>&Itemid=<?php echo $store_cp_itemid; ?>" class="btn " title="<?php echo Text::_('COM_QUICK2CART_CANCEL_ITEM'); ?>">
