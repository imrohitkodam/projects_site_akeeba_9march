...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?>">
	<form action="" method="post" name="adminForm" id="adminForm">
		...
		<div id="filter-bar" class="qtc-btn-toolbar">
			...
			<div class="btn-group pull-right hidden-phone q2c-btn-wrapper">
				<?php
				echo HTMLHelper::_('select.genericlist', $this->stores, "filter_store", 'class="input-medium"  onchange="document.adminForm.submit();" name="filter_store"', "id", "title", $this->state->get('filter.stores'));
				?>
			</div>
		</div>
