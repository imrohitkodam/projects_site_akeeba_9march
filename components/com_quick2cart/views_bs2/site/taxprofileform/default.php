...
<script type="text/javascript">
	...
	function qtcDeleteProfileRule(ruleId,delBtn)
	{
		...
		techjoomla.jQuery.ajax({
			type : "POST",
			url :"<?php echo Uri::base();?>index.php?option=com_quick2cart&view=taxprofileform&task=taxprofileform.deleteProfileRule&tmpl=component",
			data : data,
    ...
    function qtc_addTaxRule()
    {
		...
		{
			techjoomla.jQuery('#qtcErrorContentDiv').html("<?php echo Text::_('COM_QUICK2CART_S_INVALID_SELECTION'); ?>");
			techjoomla.jQuery('.error').fadeIn();
			return false;
		}
		...
		techjoomla.jQuery.ajax({
					type : "POST",
					url :"<?php echo Uri::base();?>index.php?option=com_quick2cart&view=taxprofileform&task=taxprofileform.addTaxRule&tmpl=component",
					data : data,
					dataType: "json",
					success : function(response)
					{
	...
	<div class="row-fluid">
		<div class="form-horizontal">
			...
			<fieldset>
				...
				?>
					...
					<div class="error alert alert-danger qtcError" style="display: none;">
						<i class="<?php echo QTC_ICON_REMOVE; ?> pull-right" style="align: right;" onclick="techjoomla.jQuery(this).parent().fadeOut();"> </i>
							...
							<tr>
								...
								<td>
									...
									href="index.php?option=com_quick2cart&view=taxprofileform&layout=setrule&id=<?php echo $trule->taxrule_id;?>&tmpl=component" class="modal qtc_modal">
										<input type="button" value="<?php echo Text::_('COM_QUICK2CART_TAXPROFILEERULE_EDIT'); ?>" 	class=" btn btn-primary">
									</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="form-actions ">
					...
					<a href="<?php echo Route::_('index.php?option=com_quick2cart&task=taxprofileform.cancel&id='.$this->item->id); ?>" class="btn " title="<?php echo Text::_('COM_QUICK2CART_CANCEL_ITEM'); ?>">
