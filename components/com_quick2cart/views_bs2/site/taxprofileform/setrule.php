...
function qtcUpdateZoneRule()
{
	...
	{
		techjoomla.jQuery('#qtcErrorContentDiv').html("<?php echo Text::_('COM_QUICK2CART_TAXPROFILE_INVALID_SELECTION'); ?>");
	...
	var data = {
		...
		techjoomla.jQuery.ajax({
					type : "POST",
					url :"<?php echo Uri::base();?>index.php?option=com_quick2cart&view=taxprofileform&task=taxprofileform.updateTaxRule&tmpl=component",
					data : data,
					dataType: "json",
    ...
    <div class="form-horizontal">
		...
		<div class="row-fluid">
			...
			<div class="span10 form-horizontal">
				...
				<table>
					<tr>
						<td><?php echo $this->taxrate; ?>
						</td>
						<td><?php echo $this->address; ?>
