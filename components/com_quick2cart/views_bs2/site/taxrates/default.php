		...
		<div id="qtc-filter-bar" class="qtc-btn-toolbar">
			<div class="filter-search btn-group pull-left float-start q2c-btn-wrapper">
				<input type="text" name="filter_search" id="filter_search"
					placeholder="<?php echo Text::_('COM_QUICK2CART_TAXRATES_SEARCH_FILTER'); ?>"
					value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
					class="qtc-hasTooltip"
					title="<?php echo Text::_('COM_QUICK2CART_TAXRATES_SEARCH_FILTER'); ?>" />
			</div>
			...
			<div class="btn-group pull-left float-start q2c-btn-wrapper">
				...
				<button type="button" class="btn  qtc-hasTooltip" title="<?php echo Text::_('JSEARCH_FILTER_CLEAR'); ?>"    onclick="document.getElementById('filter_search').value='';this.form.submit();">
				...
				<thead>
					<tr>
						...
						<th class="q2c_width_20">
							<?php echo HTMLHelper::_('grid.sort',  'COM_QUICK2CART_TAXTRATES_S_ZONE_NAME', 'a.zid', $listDirn, $listOrder); ?>
						</th>
