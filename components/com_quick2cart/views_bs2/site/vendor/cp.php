...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> tj-dashboard">
	<form name="adminForm" id="adminForm" class="form-validate" method="post">
		...
		if (empty($this->prodcountprodCount))
		{
			...
			Factory::getApplication()->enqueueMessage(Text::sprintf('NO_PROD_AGAINST_STORE', $clickhere), 'Notice');
		}
		?>
					...
					<div class="col-sm-12 col-lg-12 col-md-12">
						<div class="pull-right">
							...
							<div class="form-inline">
								...
								<?php echo HTMLHelper::_('calendar', $backdate, 'from', 'from', '%Y-%m-%d', array('class'=>'inputbox input-small form-control', 'readonly'=>'true')); ?>

								<label class="checkbox">
									<?php echo Text::_('QTC_TO_DATE') . "&nbsp;"; ?>
								</label>

								<?php echo HTMLHelper::_('calendar', $currentdate, 'to', 'to', '%Y-%m-%d', array('class'=>'inputbox input-small form-control', 'readonly'=>'true')); ?>

								<input id="btnRefresh" class="btn btn-default btn-sm btn-sm btn-primary" type="button" value="<?php echo Text::_('COM_QUICK2CART_FILTER_GO');?>" style="font-weight: bold;" onclick="refreshViews();" title="<?php echo Text::_('COM_QUICK2CART_DASHB_GO_TOOLTIP');?>"/>
							</div>
						</div>
									...
									<div class="row">
										<div class="col-sm-12 col-lg-12 col-md-12">
											<ul class="nav nav-tabs">
												<li class="active">
													<a href="#overview_1" data-toggle="tab"><?php echo Text::_('COM_QUICK2CART_STORE_SALES_AMOUNT'); ?></a>
												</li>
												...
												<?php else: ?>
													<li class="">
												<?php endif;?>
													<a href="#overview_3" data-toggle="tab"><?php echo Text::_('COM_QUICK2CART_STORE_ORDERS_PLACED'); ?></a>
												</li>
											</ul>
														...
														<table class="table table-striped table-hover table-bordered">
															<thead>
																<tr>
																	...
																	<th class="hidden-phone"><?php echo Text::_('COM_QUICK2CART_DASHB_DATE'); ?></th>
