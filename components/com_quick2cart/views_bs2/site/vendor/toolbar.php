							...
							<div class="">
								<ul class="nav">
										...
										<ul class="dropdown-menu">
											<li>
												<a href="<?php echo $comquick2cartHelper->quick2CartRoute('index.php?option=com_quick2cart&view=zones');?>">
													...
													<?php echo Text::_('COM_QUICK2CART_SETUP_ZONES'); ?></a>
											</li>
										...
										<ul class="dropdown-menu">
											...
											<li>
												<a href="<?php echo $comquick2cartHelper->quick2CartRoute('index.php?option=com_quick2cart&view=vendor&layout=createstore');?>">
													...
													<?php echo Text::_('QTC_NEW_STORE'); ?></a>
											</li>
											<?php
											}
											?>
									...
									<li class="<?php echo ($active == 'add_product' || $active == 'my_products') ? 'active': '' ?> dropdown">
										...
										<ul class="dropdown-menu">
											<li>
												<a href="<?php echo Route::_('index.php?option=com_quick2cart&view=product&layout=default' . '&Itemid=' . $this->add_product_itemid);?>">
													<i class="<?php echo Q2C_TOOLBAR_ICON_PLUS;?>"></i>
													<?php echo Text::_('QTC_MANAGE_STORE_ADD_PROD'); ?>
												</a>
											</li>
											<li>
												<a href="<?php echo Route::_('index.php?option=com_quick2cart&view=category&qtcStoreOwner=1&layout=my&Itemid=' . $this->my_products_itemid);?>">
													<i class="<?php echo Q2C_TOOLBAR_ICON_LIST;?>"></i>
													<?php echo Text::_('COM_QUICK2CART_MY_PRODUCTS'); ?>
												</a>
											</li>
											<li>
												<a href="<?php echo Route::_('index.php?option=com_quick2cart&view=category&qtcStoreOwner=1&layout=default&Itemid=' . $this->view_products_itemid . '&current_store=' . $this->store_id);?>">
													<i class="<?php echo Q2C_TOOLBAR_ICON_LIST;?>"></i>
...
if (is_array($this->store_role_list) && !in_array($active, $skip_array))
{
			...
			<div class="span12">
				...
				<div class="">
					<span class="pull-left qtc_left_top qtc_right_margin">
						<strong><?php echo Text::_('QTC_STORE'); ?>&nbsp;:</strong>
					</span>
				</div>
				-->
					...
					<div class="pull-right float-end">
						<div class="control-group">
							<div class="control-label">
								<label id="current_store-lbl" for="current_store"
									class="qtc-hasTooltip required"
									title="<?php echo Text::_('QTC_STORE'); ?>"
									data-original-title="<?php echo Text::_('QTC_STORE'); ?>">
										<strong><?php echo Text::_('QTC_STORE'); ?> : </strong>
								</label>
							</div>
							<div class="controls">
								<?php
								echo $this->dropdown = HTMLHelper::_('select.genericlist', $options, 'current_store', 'class="" autocomplete="off"  onchange=\'submitAction_store("change_store");\' title="' . Text::_('COM_QUICK2CART_CURRENT_STORE') . '"', 'value', 'text', $default, 'current_store_id');
								?>
