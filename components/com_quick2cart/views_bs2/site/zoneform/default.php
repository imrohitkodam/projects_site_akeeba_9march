...
<script type="text/javascript">
	...
	*/
	...
	function qtcAddZoneRule(zone_id)
	{
		...
		if (qtc_ZoneCountry == '')
		{
			techjoomla.jQuery('#qtczoneruleError').html("<?php echo Text::_('COM_QUICK2CART_ZONE_INVALID_COUNTRY_SEL', true); ?>");
		...
		techjoomla.jQuery.ajax({
			type : "POST",
			url :"<?php echo Uri::base();?>index.php?option=com_quick2cart&task=zoneform.addZoneRule&tmpl=component",
			data : data,
			dataType: "json",
			success : function(response)
			{
				...
				if (response.error != 1)
				{
					...
					var q = "'";
					var url = Joomla.getOptions('system.paths').base+"/index.php?option=com_quick2cart&view=zoneform&layout=setrule&id="+zone_id+"&zonerule_id="+zoneRuleId+"&tmpl=component";
					...
					var delLink = '<input onclick="qtcDeleteZoneRule('+
								zoneRuleId+',this);" class="btn btn-danger" type="button" value="<?php echo Text::_('COM_QUICK2CART_ZONERULE_DELETE'); ?>">';
...
<div class="qyc_admin_zones <?php echo Q2C_WRAPPER_CLASS; ?>">
		...
		<div class="form-horizontal">
			...
			<div style="clear:both;"></div>
				<fieldset class="adminform">
					<legend>
						<?php echo Text::_('COM_QUICK2CART_ZONE_LEGEND'); ?>
					</legend>
					<!--
					...
					<div class=" form-horizontal">
						...
						<div class="row-fluid">
							<div class="span4">
								...
								echo $this->dropdown = HTMLHelper::_('select.genericlist',$options,'qtc_ZoneCountry','class=""  aria-invalid="false"   autocomplete="off" onchange=\'qtc_generateState("jform[qtc_state_id]","jform_qtc_state_id")\' ','value','text',$default,'qtc_ZoneCountry');
										...
										<tr>
											...
											<td>
												...
												href="index.php?option=com_quick2cart&view=zoneform&layout=setrule&id=<?php echo $this->item->id; ?>&zonerule_id=<?php echo $rule->id;?>&tmpl=component" class="modal qtc_modal">
													<input type="button" value="<?php echo Text::_('COM_QUICK2CART_ZONERULE_EDIT'); ?>" 	class=" btn btn-primary">
												</a> &nbsp;&nbsp;&nbsp;
			...
			<div class="form-actions ">
				...
				<?php endif;?>
				 ...
				 <a href="<?php echo Route::_('index.php?option=com_quick2cart&task=zoneform.cancel&id='.$this->item->id); ?>" class="btn " title="<?php echo Text::_('COM_QUICK2CART_CANCEL_ITEM'); ?>">
