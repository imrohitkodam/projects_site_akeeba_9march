	...
	*/
	...
	function qtcUpdateZoneRule()
	{
		var data = {
			...
			techjoomla.jQuery.ajax({
				type : "POST",
				url :"<?php echo Uri::base();?>index.php?option=com_quick2cart&task=zoneform.updateZoneRule&tmpl=component",
				data : data,
				dataType: "json",
				success : function(response)
				{
...
<div class = "<?php echo Q2C_WRAPPER_CLASS; ?>">
	<form action="<?php echo Route::_('index.php?option=com_quick2cart&layout=edit&id=' . (int) $previousId ); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="zone-form" class="form-validate">
		...
		<div class="row-fluid">
			<legend>
				<?php echo Text::_('COM_QUICK2CART_ZONE_COUNTRIES_AND_ZONES'); ?>
			</legend>
			...
			<div class="span12">
				<div class="span4">
					...
					echo $this->dropdown = HTMLHelper::_('select.genericlist',$options,'qtc_ZoneCountry','class=""  required="" aria-invalid="false"   autocomplete="off" onchange=\'qtc_generateState("jform[qtc_state_id]","jform_qtc_state_id")\' ','value','text',$default,'qtc_ZoneCountry');
					?>
				</div>
				<div class="span4">
			...
			<div class="control-group">
				<div class="error alert alert-error qtcError" style="display: none;">
					...
					<i class="icon-cancel pull-right float-end" style="align: right;"
