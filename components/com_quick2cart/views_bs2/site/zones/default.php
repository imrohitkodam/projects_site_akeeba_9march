...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> q2c_zones">
	<form action="" method="post" name="adminForm" id="adminForm">
		...
		<div class="row-fluid">
			<legend><?php echo Text::_('COM_QUICK2CART_SETUP_ZONE'); ?></legend>
		...
		<div id="filter-bar" class="qtc-btn-toolbar">
			<div class="filter-search btn-group float-start q2c-btn-wrapper">
				<input type="text" name="filter_search" id="filter_search"
				placeholder="<?php echo Text::_('COM_QUICK2CART_FILTER_ZONES_SEARCH'); ?>"
				value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
				class="qtc-hasTooltip"
				title="<?php echo Text::_('COM_QUICK2CART_FILTER_ZONES_SEARCH'); ?>" />
			</div>

			<div class="btn-group float-start q2c-btn-wrapper">
			...
			<div class="btn-group pull-right float-end hidden-phone q2c-btn-wrapper">
				<?php
				...
				<thead>
					<tr>
						...
						<?php if (isset($this->items[0]->state)): ?>
							<th class="hidden-phone nowrap center q2c_width_10">
				...
				<tbody>
					...
					foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td class="">
								<a href="<?php echo Route::_('index.php?option=com_quick2cart&view=zone&task=zone.edit&id=' . (int)$item->id); ?>"><?php echo htmlspecialchars($item->name, ENT_COMPAT, 'UTF-8'); ?></a>
							</td>
							...
							<td class="q2c_width_30"><?php echo htmlspecialchars($item->title, ENT_COMPAT, 'UTF-8');?></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
