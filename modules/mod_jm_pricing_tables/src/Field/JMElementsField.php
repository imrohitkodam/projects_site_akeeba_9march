...
namespace Joomla\Module\JMPricingTables\Site\Field;
...
class JMElementsField extends FormField
{
	/**
	 * The form field type.
	 *
	...
	public function setup(\SimpleXMLElement $element, $value, $group = null)
	{
		...
		if (empty(self::$js_initialised)) {
			...
			$wa->useScript('mod_jm_pricing_tables.jmelements');
		}
	...
	protected function getInput()
	{
		...
		$html[] = '<button id="' . $this->id . '_btn_add" class="btn btn-primary">'.Text::_('MOD_JM_UI_ADD_NEW_BTN').'</button>';
		$html[] = '<button style="display: none;" id="' . $this->id . '_btn_cancel" class="btn">'.Text::_('MOD_JM_UI_CANCEL_BTN').'</button>';

		$html[] = '<button style="display: none;" id="' . $this->id . '_btn_save" class="btn btn-success" >'.Text::_('MOD_JM_UI_SAVE_BTN').'</button>';
