...
<?php
	...
	?>
		<?php
			...
			<br>
				<div class="center">
					<a class="btn btn-small btn-info qtc-mobile-filter-apply" onclick='qtcfiltersubmitmobile()'><?php echo Text::_('MOD_Q2CFILTERS_APPLY_FILTERS');?></a>
					<a class="btn btn-small btn-info" onclick='q2c_clearfilters()'><?php echo Text::_('MOD_Q2CFILTERS_CLEAR_FILTERS');?></a>
				</div>
			<?php
			}
		?>
...
<?php
	...
	{
		$filterStylings = 'height:'.$params->get("module_size").'px;' . 'overflow-x:hidden ; overflow-y=scroll;';
	}
?>
