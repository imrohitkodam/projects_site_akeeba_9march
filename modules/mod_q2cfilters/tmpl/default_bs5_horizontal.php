...
$selectedFilters = explode(',',Factory::getApplication()->input->get('attributeoption', '', 'string'));
...
<?php
	...
	?>
		<?php
			...
			<br>
				<div class="center">
					<a class="btn btn-sm btn-info qtc-mobile-filter-apply" onclick='qtcfiltersubmitmobile()'><?php echo Text::_('MOD_Q2CFILTERS_APPLY_FILTERS');?></a>
					<a class="btn btn-sm btn-info" onclick='q2c_clearfilters()'><?php echo Text::_('MOD_Q2CFILTERS_CLEAR_FILTERS');?></a>
				</div>
			<?php
			}
		?>
...
<?php
	...
	{
		$filterStylings = 'max-height:'.$params->get("module_size").'px;';
	}
?>
	...
	<div id="qtcFilterWrapperDiv " style="<?php echo $filterStylings?>">
		...
		if (isset($filters))
		{
			...
			?>
					...
					?>
					<div class="filterhrizontal float-start">
						<?php echo $fieldHtml;?>
					</div>
					<?php
				}
