...
?>
	<?php
	$clearBtnPosition = $params->get('apply_clear_buttons_position', '', 'string');

	if($clearBtnPosition == "above" || $clearBtnPosition == "both")
	{ ?>
		<br>
		<div class="center">
			<a class="btn btn-sm btn-info qtc-mobile-filter-apply" onclick='qtcfiltersubmitmobile()'>
				<?php echo Text::_('MOD_Q2CFILTERS_APPLY_FILTERS');?>
			</a>
			<a class="btn btn-sm btn-info" onclick='q2c_clearfilters()'>
...
?>
<b class="q2c-price-slider"><?php echo Text::_('MOD_Q2CFILTERS_PRICE_FILTER_RANGE');?></b>
<br>
<input
