...
?>
<div class="<?php echo Q2C_WRAPPER_CLASS . ' ' . $moduleclass_sfx; ?>" >
	<div class=''>
		...
		<div id="q2c_pc_mod_products_display<?php echo  $mod_mode?>" class="<?php echo $layout_to_load == 'fixed_layout' ? 'row' : ''; ?>">
			<?php
			...
			?>
				...
				<?php
				$path = JPATH_SITE . '/components/com_quick2cart/views/product/tmpl/product_' . $bsVersion .'.php';
				ob_start();
				include($path);
