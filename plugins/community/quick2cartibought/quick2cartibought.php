...
$lang->load('plg_community_quick2cartibought', JPATH_ADMINISTRATOR);

/**
 * Sidebar app for quick2cart I bought products
 *
 * @since  1.0
 * @access  public
 */
class PlgCommunityQuick2cartibought extends CApplications
{
	public $name = "Quick2cartibought";

	/**
	 * This function html of layout.
	 *
	 * @since   1.0
	 * @access  public
	...
	Public function onProfileDisplay()
	{
		...
		$cache = Factory::getCache('PlgCommunityQuick2cartibought');
		$cache->setCaching($caching);
		$callback = array($this, '_getquick2cartiboughtHTML');
	...
	Public function _getquick2cartiboughtHTML()
	{
		if (File::exists(JPATH_SITE . '/components/com_quick2cart/quick2cart.php'))
		{
			...
			if (!empty($target_data))
			{
				...
				$currentBSViews = $comParams->get('bootstrap_version','bs2','string');
				...
				foreach ($target_data as $data)
				{
					...
					{
						$path = JPATH_SITE . '/components/com_quick2cart/views/product/tmpl/product_bs5.php';
					}
	...
	?>
						<?php
					// Get pin width
					$pin_width = $params->get('pin_width','120'.'int');
	...
	?>
						...
						<script type="text/javascript">
							var pin_container_<?php echo $random_container; ?> = 'q2c_pc_js_products_ibought';
							...
							techjoomla.jQuery(document).ready(function()
							{
								techjoomla.jQuery(".joms-tab__bar a").bind("click", function(){
									...
									{
										QttPinArrange(pin_container_<?php
															echo $random_container;
											?>, columnWidth_<?php
															echo $random_container;
											?>, random_container_<?php
															echo $random_container;
											?>, pin_padding_<?php
															echo $random_container;
											?>);

										setTimeout(function() { QttPinArrange(pin_container_<?php
															echo $random_container;
											?>, columnWidth_<?php
															echo $random_container;
											?>, random_container_<?php
