 ...
 * @package INSTANTPAYPAL::administrator::components::com_instantpaypal  
 */
class InstantpaypalBaseInstallerScript {
	/*
...
if(version_compare(JVERSION, '4.3', '>=') && interface_exists('\\Joomla\\CMS\\Installer\\InstallerScriptInterface')) {
	return new class () extends InstantpaypalBaseInstallerScript implements InstallerScriptInterface {
	};
} else {
	class PlgcontentinstantpaypalInstallerScript extends InstantpaypalBaseInstallerScript {
	}
}