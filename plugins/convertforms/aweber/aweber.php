...
class plgConvertFormsAWeber extends \ConvertForms\Plugin
{
	...
	public function subscribe()
	{
		...
		$ad_tracking = 'convertforms_' . ApplicationHelper::stringURLSafe($lead->campaign->name);
	...
	public function onContentBeforeSave($context, $article, $isNew)
	{
		...
		{
			Factory::getApplication()->enqueueMessage(Text::_('PLG_CONVERTFORMS_AWEBER_WRONG_AUTH_CODE'), 'error');
			return;
		}
		...
		if (isset($params->authcode) && !NR_AWeber::checkCredentials($params, $oldCampaign))
		{
			try {
				...
				Factory::getApplication()->enqueueMessage(Text::_('PLG_CONVERTFORMS_AWEBER_CONNECTION_ESTABLISHED'));
			}
			catch (Exception $e)
			{
