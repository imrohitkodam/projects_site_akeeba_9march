...
class ACFMigrator
{
    ...
    public function do()
    {
        ...
        if (version_compare($this->installedVersion, '3.1.1', '<='))
        {
            $this->removeLegacyVideoHelper();
        }
    }
    ...
    /**
     * Remove legacy ACF Video helper file that may still exist on some installations.
     */
    public function removeLegacyVideoHelper()
    {
        $path = Path::clean(JPATH_ROOT . '/plugins/system/acf/ACF/Helpers/Fields/Video.php');
