...
class PlgSystemConvertForms extends CMSPlugin
{
    ...
    private function ajaxTaskLists()
    {
        ...
        $lists = Factory::getApplication()->triggerEvent('onConvertFormsServiceLists', array($campaignData));
    ...
    private function ajaxTaskAPI()
    {
        ...
        // Factory::getDocument()->setMimeEncoding('application/json'); doesn't work here
