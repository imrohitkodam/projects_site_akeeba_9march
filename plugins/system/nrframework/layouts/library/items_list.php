...
$info_item_class = ' tf-library-template-item-info-popup-trigger';
...
foreach ($templates as $template_key => $template)
{
    ...
    if (is_array($external_extensions) && count($external_extensions))
    {
        foreach ($external_extensions as $key => $external_extension)
        {
            ...
            if (!\Tassos\Framework\Extension::isInstalled($external_extension->slug))
            {
                $icon = 'install';
            ...
            else if (!\Tassos\Framework\Extension::isEnabled($external_extension->slug))
            {
                $icon = 'activate';
            ...
            {
                $third_party_extension_installed_version = \Tassos\Framework\Extension::getVersion($external_extension->slug);
        ...
        <div class="tf-library-item-wrap">
                    ...
                    <div class="tf-library-item-hover">
                        ...
                        <div class="dependencies-wrapper">
                            ...
                            <div class="dependencies">
                                ...
                                {
                                    ?><span class="error<?php echo $info_item_class; ?>"><?php echo Text::_('NR_JOOMLA') . ' ' . ($required_j_version ? $required_j_version : $j_version); ?></span><?php
                                }
                                if (array_key_exists('project', $errors))
                                {
                                    ?><span class="error<?php echo $info_item_class; ?>"><?php echo $project_name . ' ' . ($required_item_version ? $required_item_version : $project_version); ?></span><?php
                                }
                                if (is_array($external_extensions) && count($external_extensions))
                                {
                                    foreach ($external_extensions as $external_extension_key => $external_extension)
                                    {
                                        ...
                                        ?><span class="error<?php echo $info_item_class; ?>"><?php echo $external_extension->name . ' ' . $external_extension->version; ?></span><?php
                                    }
                                }
                                ?>
                            </div>
            ...
            <div class="tf-library-item-bottom">
                ...
                <div class="tf-library-item-bottom-buttons">
                    <a data-template-id="<?php echo $template->id; ?>" class="info tf-library-template-item-info<?php echo $info_item_class; ?>" title="<?php echo Text::_('NR_TEMPLATE_INFORMATION'); ?>" href="#tf-library-item-info-popup">
                ...
                <div class="tf-library-item-actions">
                    ...
                    if (!empty($errors))
                    {
                        ...
                        {
                            ?>
                            <a class="<?php echo $info_item_class; ?>" href="#tf-library-item-info-popup" data-template-id="<?php echo $template->id; ?>">
                                <?php
                                echo $error_svg_icon;
