 ...
 * @since       1.0
 */
class PlgSystemQtc_Sample_Development extends CMSPlugin
{
	/**
					...
					if ($affiliate_status == "basedOnAffiliateId")
					{
						if (!empty($_COOKIE['qtcIdev_affiliate_id']))
						{
							...
							if (!empty($aff_id) && $order_id)
							{
								...
								try
								{
									$db->$action('#__kart_affiliate', $row, 'order_id');
								}
				...
				if ($baseurl)
				{
					...
					switch ($affiliate)
					{
						case 'iDevAffi':
							...
							\"http://durgesh.tekdi.net/idevaffiliate/sale.php?profile=90&idev_saleamt=$idev_saleamount
							&idev_ordernum=$idev_ordernum&coupon_code=$idev_coupon_code\" width=\"1\" height=\"1\">";
							----------------------------
	...
	/**
	 *  Function used as a trigger before sending the order data to
	 * respective payment gateway's onTP_GetHTML() trigger  which is used to build payment form which is displayed on checkout form
	 *
	...
	*/
	 ...
	 */
	/*public function onBeforeQ2cCartModule()
	{
		return '';
	}*/
	 ...
	 * @return  [type]  [description]
	 */
	/*public function onAfterQ2cCartModule()
	{
		return '';
	}*/
	 ...
	 * @return  ''
	 */
	/*public function onBeforeQ2cEditStore($store_id)
	{
	}*/
	 ...
	 * @return  ''
	 */
	/*public function onBeforeQ2cSaveStore($post)
	{
	}*/
	 ...
	 * @return  [type]            [description]
	 */
	/*public function onAfterQ2cSaveStore($post, $storeid)
	{
	}*/
	 ...
	 * @return  [type]             [description]
	 */
	/*public function onQ2cAddTabOnCheckoutPage($cartData)
	{
		return '';
	}*/
	 ...
	 * @return  [type]            [return]
	 */
	/*public function onAddHtmlOrderDetailPage($orderid = 0, $orderInfo = array(), $orderitems = array())
	{
	}*/
	 ...
	 * @since   2.2.2
	 */
	/*public function onBeforeQ2cSavingProductBasicDetail($itempost, $action)
	{
	}*/
