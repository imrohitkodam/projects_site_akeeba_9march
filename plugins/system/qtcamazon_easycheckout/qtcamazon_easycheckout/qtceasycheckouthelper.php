...
class Qtceasycheckouthelper
{
	...
	public function __construct()
	{
		...
		$plugin = PluginHelper::getPlugin('system', 'qtcamazon_easycheckout');
	...
	public function getAmazonCheckoutButton($order_id)
	{
		if (empty($order_id))
		{
			...
			Text::_('PLUG_AMAZON_SOMTHING_WRONG_WHILE_PLACING_THE_ORDER') .
			Text::_('PLUG_AMAZON_ERROR_INVALID_ORDER_ID') .
			"</div>";
