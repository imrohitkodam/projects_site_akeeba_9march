...
<form name="qtcshipform" id="adminForm" class="form-validate form-horizontal container-fluid" method="post" onSubmit="return myValidate(this);" >
	...
	<div class="row">
		...
		<div class="form-group">
			<label for="name" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_METH_NAME_TITLE'); ?>">
		...
		?>
		<div class="form-group">
			<label for="qtcShipMethStoreId" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_STORE_NAME_DESC'); ?>">
				<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_STORE_NAME'). ' *'; ?>
			</label>
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<?php echo HTMLHelper::_('select.genericlist',  $options, "shipForm[store_id]", 'class="form-select required"  required="required" ', 'value', 'text', $defaultSstore_id, 'qtcShipMethStoreId');?>
			</div>
		</div>
		...
		?>
		<div class="form-group">
			<label  for="taxprofileId" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIPTAXPROFILE_HELP_TITLE'); ?>">
				<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_TAX_PROFILE'); ?>
			</label>
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<?php echo HTMLHelper::_('select.genericlist',$options,"shipForm[taxprofileId]",'class="form-select"   aria-invalid="false" required="required" ','value','text',$default,'taxprofileId');?>
		...
		?>
		<div class="form-group">
			<label  for="shipstate" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_STATE_TITLE'); ?>">
				<?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_STATE"). ' *'; ?>
			</label>
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<?php echo HTMLHelper::_('select.genericlist',$options,"shipForm[state]",'class="form-select"  required="required" aria-invalid="false" ','value','text',$default,'shipstate');?>
			</div>
		</div>
		...
		?>
		<div class="form-group" >
			<label  for="shipping_type" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIPTYPE_TITLE'); ?>">
		...
		?>
		<div class="form-group">
			<label  for="qtcMinAmount" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 form-label" title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_MINIMUM_AMT_TITLE'); ?>" id="qtcCreateMethMinFieldLable">
		...
		<div class="form-group">
			<label  for="qtcMaxAmount" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 form-label"  title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_MAXIMUM_AMT_TITLE'); ?>" id="qtcCreateMethMaxFieldLable">
		...
		<div class="form-actions ">
			<div class="qtc_action_button filter-search ">
				...
				<button type="button" class="btn btn-default" title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_S_SAVE_CLOSE'); ?>" onclick="qtcShipSubmitAction('shipMethodSaveAndClose');">
					<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_S_SAVE_CLOSE'); ?>
				</button>
				<button type="button" class="btn btn-default " title="<?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_CANCEL"); ?>" onclick="qtcShipSubmitAction('cancel');">
