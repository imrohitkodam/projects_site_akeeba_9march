...
<form name="qtcshipform" method="post" id="adminForm" enctype="multipart/form-data">
	...
	<div class="qtc_action_button pull-right">
		<button type="button" class="btn btn-success btn-small" title="<?php echo Text::_('COM_QUICK2CART_GENERAL_S_NEW'); ?>" onclick="qtcShipSubmitAction('add');">
			<i class="<?php echo QTC_ICON_PLUS; ?> <?php echo Q2C_ICON_WHITECOLOR; ?> "></i>
			<span class="hidden-xs">
				<?php echo Text::_('COM_QUICK2CART_GENERAL_S_NEW'); ?>
			</span>
		</button>
		<button type="button" class="btn btn-success btn-small hidden-xs" title="<?php echo Text::_('COM_QUICK2CART_S_PUBLISHED'); ?>" onclick="qtcShipSubmitAction('publish');">
			<i class="<?php echo QTC_ICON_CHECKMARK;?> <?php echo Q2C_ICON_WHITECOLOR; ?>"> </i>
			<?php echo " " . Text::_('COM_QUICK2CART_S_PUBLISHED'); ?>
		</button>
		<button type="button" class="btn btn-warning btn-small hidden-xs" title="<?php echo Text::_('COM_QUICK2CART_S_JUNPUBLISHED'); ?>" onclick="qtcShipSubmitAction('unpublish');">
			<i class="<?php echo QTC_ICON_PUBLISH;?> <?php echo Q2C_ICON_WHITECOLOR; ?>"></i>
			<?php echo " " . Text::_('COM_QUICK2CART_S_JUNPUBLISHED'); ?>
		</button>
		<button type="button" class="btn btn-danger btn-small" title="<?php echo Text::_('COM_QUICK2CART_GENERAL_S_DELETE'); ?> " onclick="return qtcShipSubmitAction('delete');">
		...
		<?php
			...
			<tr class='row<?php echo $k; ?>'>
				...
				<td>
					...
					?>
					<a class="btn btn-primary btn-small" href="<?php echo Route::_($setRateLink); ?>" title="<?php  echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_CLICK_TO_SETRATE_TITLE'); ?>" >
						<span class="">
