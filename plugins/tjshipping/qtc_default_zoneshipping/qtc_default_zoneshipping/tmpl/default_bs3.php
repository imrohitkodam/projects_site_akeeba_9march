...
<form name="qtcshipform" method="post" id="adminForm" enctype="multipart/form-data">
	...
	<div class="qtc_action_button filter-search pull-right">
		...
		{?>
			<button
				...
				title="<?php echo Text::_('COM_QUICK2CART_GENERAL_S_NEW'); ?>"
				onclick="qtcShipSubmitAction('add');">
				<i class="<?php echo QTC_ICON_PLUS; ?> <?php echo Q2C_ICON_WHITECOLOR; ?> "></i>
				<span class="hidden-xs"><?php echo Text::_('COM_QUICK2CART_GENERAL_S_NEW'); ?></span>
			</button>
		<?php
		}
		...
		{?>
			<button
				...
				title="<?php echo Text::_('COM_QUICK2CART_S_PUBLISHED'); ?>"
				onclick="qtcShipSubmitAction('publish');">
			...
			<button
				...
				title="<?php echo Text::_('COM_QUICK2CART_S_JUNPUBLISHED'); ?>"
				onclick="qtcShipSubmitAction('unpublish');">
		...
		{?>
			<button
				...
				title="<?php echo Text::_('COM_QUICK2CART_GENERAL_S_DELETE'); ?>"
				onclick="return qtcShipSubmitAction('delete');">
				<i class="<?php echo Q2C_ICON_TRASH; ?> <?php echo Q2C_ICON_WHITECOLOR; ?>"></i>
				<span class="hidden-xs"><?php echo Text::_('COM_QUICK2CART_GENERAL_DELETE'); ?></span>
			</button>
		<?php
		}?>
	</div>
	...
	<table class="table table-striped table-bordered af-mt-10" id="taxProfilesList">
		<thead>
			<tr >
				<th width="1%">
				...
				<th width="30%" class="hidden-xs "><?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_TAX_PROFILE_NAME'); ?></th>
