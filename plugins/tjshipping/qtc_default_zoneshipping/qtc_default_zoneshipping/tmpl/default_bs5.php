...
<form name="qtcshipform" method="post" id="adminForm" enctype="multipart/form-data">
	<h1 id="qtc_shipmethodInfo">
		<strong>
			<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_SEL_SHIPMETHOLIST')?>&nbsp;
		</strong>
	</h1>
	...
	?>
	<!-- Add action buttons-->
	<div class="qtc_action_button filter-search float-end">
		<?php
		...
		<button
			...
			title="<?php echo Text::_('COM_QUICK2CART_GENERAL_S_NEW'); ?>" onclick="qtcShipSubmitAction('add');">
		...
		?>
			<button
				...
				title="<?php echo Text::_('COM_QUICK2CART_S_PUBLISHED'); ?>" onclick="qtcShipSubmitAction('publish');">
				<i class="<?php echo QTC_ICON_CHECKMARK;?> <?php echo Q2C_ICON_WHITECOLOR; ?>"> </i><?php echo " " . Text::_('COM_QUICK2CART_S_PUBLISHED'); ?>
			</button>
			<button
				type="button"
				class="btn btn-warning btn-sm hidden-xs"
				title="<?php echo Text::_('COM_QUICK2CART_S_JUNPUBLISHED'); ?>" onclick="qtcShipSubmitAction('unpublish');">
				<i class="<?php echo QTC_ICON_PUBLISH;?> <?php echo Q2C_ICON_WHITECOLOR; ?>"></i><?php echo " " . Text::_('COM_QUICK2CART_S_JUNPUBLISHED'); ?>
			</button>
		<?php
		}
	...
	<table class="table table-striped table-bordered table-hover border mt-3" id="taxProfilesList">
		<thead class="table-primary border table-bordered">
			<tr >
				...
				<th width="40%" class="title fw-bold"><?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIPM_NAME'); ?></th>
				<th class="center fw-bold" width="10%"><?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIPM_STATE'); ?></th>
				<th width="30%" class="hidden-xs fw-bold"><?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_TAX_PROFILE_NAME'); ?></th>
				<th width="18%" class="title fw-bold"></th>
			</tr>
		</thead>
		<tfoot>
			...
			?>
				<tr class='row<?php echo $k; ?>'>
					...
					<td style="text-align: left;">
						<?php $methlink = "index.php?option=com_quick2cart&view=shipping&layout=list&plugview=createshipmeth&extension_id=" . $extension_id . "&Itemid=" . $itemid . "&methodId=" . $item['methodId'];?>
						...
						<div class="shipping_rates">
							<b><?php  echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIPM_TYPE'); ?></b>: <?php echo $qtczoneShipHelper->getShipTypeName($item['shipping_type']); ?>
							<br>
							<b><?php  echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_MIN_SUBTOATL_REQ'); ?></b>: <?php echo number_format($item['min_value'],2); ?>
							<br/>
							<b><?php  echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_MAX_SUBTOATL_REQ'); ?></b>: <?php echo number_format($item['max_value'],2); ?>
						</div>
					</td>
					<td class="center" >
						<?php
					...
					<td>
						<?php $setRateLink = "index.php?option=com_quick2cart&view=shipping&layout=list&plugview=setrates&extension_id=" . $extension_id . "&Itemid=" . $itemid . "&methodId=" . $item['methodId'] . '';?>
