				...
				<tr>
					...
					?>
						<td>
							<input
								...
								class="input-mini"
								name="rangeFrom"
								value="<?php echo isset($shipFormData['rateDetail']['rangeFrom']) ? $shipFormData['rateDetail']['rangeFrom'] : '';?>"
								size="8" />
							<br/>
							...
							<input
								...
								class="input-mini"
								name="rangeTo"
								value="<?php echo isset($shipFormData['rateDetail']['rangeTo']) ? $shipFormData['rateDetail']['rangeTo'] : '';?>"
								size="8" />
						</td>
					<?php
					}
					...
					<td>
						...
						<input
							...
							type="button"
							onclick="qtcUpdateShipMethRates()"
							value="<?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_UPDATE_RATE"); ?>"
							class="button" />
					</td>
				</tr>
			</tbody>
