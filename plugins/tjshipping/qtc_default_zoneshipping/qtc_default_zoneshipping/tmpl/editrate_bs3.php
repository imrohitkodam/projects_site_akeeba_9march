...
function qtcUpdateShipMethRates()
{
	...
	techjoomla.jQuery.ajax({
		...
		success: function(response)
		{
			...
			alert("<?php echo Text::_('PLG_QTC_DEFAULT_ITEM_DATA_SAVED_SUCCESSFULLY'); ?>");
...
<div class='row'>
	<div class="error alert alert-danger qtcError" style="display: none;">
		...
		<i class="icon-cancel pull-right" style="align: right;" onclick="techjoomla.jQuery(this).parent().fadeOut();"> </i> <br />
		<hr />
