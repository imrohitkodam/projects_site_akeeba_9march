...
{
	jQuery('#setShippingZoneRateModal_' + rateId).attr('style' , 'display:flex !important; flex-direction: column; align-items: center;');
...
<form name='qtcSetRateform' id="qtcSetRateform"  method="post" class="container-fluid">
	<legend id="" ><?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_SET_RATEFOR_") ?>&nbsp; <?php echo !empty($shipMethDetail['name']) ? ucfirst($shipMethDetail['name']) : ''; ?>
		<span class="pull-right" >
			...
			<button type="button" onClick="location.href='<?php echo $backlink; ?>'" title="<?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_SHIPTAXPROFILE_SETRATE_BACK_TITLE"); ?>" class="btn  btn-primary  btn-xs" >
	...
	<div class="no-more-tables" id="qtc_shipping_list">
		<table class=" table table-striped">
			...
			<tbody>
				<tr>
					<td data-title="<?php echo Text::_('PLG_QTC_DEFAULT_ZONESHIPPING_ZONES');?>">
						<?php
						$default   = 0;
						$options   = array();
				...
				?>
					<tr id="qtcRateId_<?php echo $rate['rateId'];?>">
						...
						<td id="qtcActionTd_<?php echo $qtcRateId;?>" >
							...
							?>
							<input onclick="qtcDeleteShipRate(<?php echo $rate['rateId']; ?>, this);" class="btn btn-danger btn-sm" type="button" value="<?php echo Text::_("PLG_QTC_DEFAULT_ZONESHIPPING_DELETE"); ?>">
						</td>
					</tr>
				<?php
				}
